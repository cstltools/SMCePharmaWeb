...
{
    public class OrderInfoBLL_daaw
    {
        OrderInfoDAL_daaw aOrderInfoDal=new OrderInfoDAL_daaw();
        ...
        {
            return aOrderInfoDal.LoadOrderListForOrderRouteDayWise(comunitId, routeDate, routeId);
        }

        public DataTable GetInvoiceCreationRouteWiseSalesAssistantList(int dcId, DateTime inputDate)
        {
            return aOrderInfoDal.GetInvoiceCreationRouteWiseSalesAssistantList(dcId, inputDate);
        }

        public DataTable GetInvoiceCreationRouteWiseSalesAssistantListForSick(int dcId)
        {
            return aOrderInfoDal.GetInvoiceCreationRouteWiseSalesAssistantListForSick(dcId);
        }

        public DataTable GetInvoiceCreationRouteWiseRouteTerritoryList(int dcId, DateTime inputDate, int daId)
        {
            return aOrderInfoDal.GetInvoiceCreationRouteWiseRouteTerritoryList(dcId, inputDate, daId);
        }
        ...
        {
            return aOrderInfoDal.LoadSalesConfirmationAppLogDetail(invoiceId);
        }
