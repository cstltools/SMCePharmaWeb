...
namespace Library.BLL.SInventory_BLL
{
    public class InvoiceBLL_daaw
    {
        ...
        {
            return aInvoiceDal.RejectInvoiceDASalesConfirmStatus(invoiceId);
        }

        public bool UpdateDICApprovalStatus(string salesConfirmationAppLogId, string dicApprovalStatus, string approvedBy)
        {
            return aInvoiceDal.UpdateDICApprovalStatus(salesConfirmationAppLogId, dicApprovalStatus, approvedBy);
        }
        ...
        {
            return aInvoiceDal.UpdateDICApprovalStatus(salesConfirmationAppLogId, dicApprovalStatus, approvedBy, transaction);
        }
        ...
        {
            return aInvoiceDal.UpdateDICApprovalStatus_SalesReturn(salesReturnAppLogId, dicApprovalStatus, approvedBy);
        }
        ...
        {
            return aInvoiceDal.UpdateDICApprovalStatus_SalesReturn(salesReturnAppLogId, dicApprovalStatus, approvedBy, transaction);
        }

        public string GetSalesReturnAppLogIdByInvoiceId(int invoiceId)
        {
            return aInvoiceDal.GetSalesReturnAppLogIdByInvoiceId(invoiceId);
        }

        public DataTable LoadSalesReturnAppLogHeader(string invoiceId, string appLogId = "")
        {
            return aInvoiceDal.LoadSalesReturnAppLogHeader(invoiceId, appLogId);
        }

        public DataTable LoadSalesReturnAppLogDetails(string invoiceId, string appLogId = "")
        {
            return aInvoiceDal.LoadSalesReturnAppLogDetails(invoiceId, appLogId);
        }

        public bool RejectInvoiceDASalesReturn(int invoiceId, string salesReturnAppLogId = "")
        {
            return aInvoiceDal.RejectInvoiceDASalesReturn(invoiceId, salesReturnAppLogId);
        }
        ...
        public bool SaveInvoice(Invoice aInvoice, out int invoiceId, out string invoiceNo)
        {
            ...
            string batchn = "";
            //ClsPrimaryKeyFind aClsPrimaryKeyFind = new ClsPrimaryKeyFind();
            OrderInfoBLL_daaw orderInfoBLL = new OrderInfoBLL_daaw();
       ...
       public DataTable LoadProductQty(string orderid, string productCode)
       {
        ...
        {
            return aInvoiceDal.GetTopSheetByBatchNo_daaw(batchNo);
        }

        public DataTable GetMarketwisePickingslipByBatchNo_daaw(string batchNo)
        {
            return aInvoiceDal.GetMarketwisePickingslipByBatchNo_daaw(batchNo);
        }
    }
}
