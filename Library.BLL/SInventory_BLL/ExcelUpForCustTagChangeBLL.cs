...
{
    public class ExcelUpForCustTagChangeBLL
    {
        ExcelUpForCustTagChangeDAL aExcelUpForMIGODAL = new ExcelUpForCustTagChangeDAL();
            ...
            {
                {
                    ClsPrimaryKeyFind aClsPrimaryKeyFind = new ClsPrimaryKeyFind();
                    //int MigoMasterID = 0;
                    aMigoMasterDAO.MigoMasterID = aClsPrimaryKeyFind.PrimaryKeyMax("CustomerTagChangeExcelFileMasterID", "tblCustomerMasterTagChangeExcelFileMaster");
        ...
        {
            return aExcelUpForMIGODAL.LoadOrderDetail(fromdate, todate);
        }
