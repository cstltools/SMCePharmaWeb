...
{
    public class dadtlsOrderInfoBLL
    {
        dadtlsOrderInfoDAL aOrderInfoDal=new dadtlsOrderInfoDAL();
        ...
        public DataTable LoadOrderListForOrderRouteDayWise(int comunitId, DateTime routeDate)
        {
            return aOrderInfoDal.LoadOrderListForOrderRouteDayWise(comunitId, routeDate);
        }
