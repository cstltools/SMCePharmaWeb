...
{
  public class dadtlsRequisitionBLL
    {
      ClsPrimaryKeyFind aClsPrimaryKeyFind = new ClsPrimaryKeyFind();
      dadtlsRequisitionDAL aRequisitionDal = new dadtlsRequisitionDAL();
      ProductBLL aProductBll = new ProductBLL();

      public bool SaveRequsition(dadtlsRequesition aRequesition, out int maxReqId)
      {
          maxReqId = ReqId();
      ...
      public bool UpdateManufacturerInfo(dadtlsRequesition aManufacturer)
      {
          return aRequisitionDal.UpdateManufacturerInfo(aManufacturer);

      }
      public string SaveRequsitionChild(List<dadtlsRequsitionChild> aRequsitionChildrenList)
      {
         
          string msg = "Save Data Successfully!!";
          foreach (dadtlsRequsitionChild aChild in aRequsitionChildrenList)
          {
      ...
      public bool UpdateIssueInformationOnRequisition(dadtlsRequesition aRequesition)
      {
          return aRequisitionDal.UpdateIssueInformationOnRequisitionDAL(aRequesition);
      }
      public bool UpdatePickingInformationOnRequisition(dadtlsRequesition aRequesition)
      {
      ...
      public string UpdateIssueInformationOnRequisitionChild(bool IsFromBatch , List<dadtlsRequsitionChild> aRequsitionChildrenList)
      {
          string msg = "Data Save Successfully!!";
          
          DataTable aTable;
          foreach (dadtlsRequsitionChild aRequsitionChild in aRequsitionChildrenList)
          {
              UpdateCentralStockAndStockInTransfar(IsFromBatch,aRequsitionChild);
      ...
      public bool UpdateCentralStockAndStockInTransfar(bool IsFromBatch, dadtlsRequsitionChild aRequsitionChild)
      {
          ...
          DataTable aTablePriceCase = new DataTable();
            ...
            if (IsFromBatch == true)
            {
                aDataTableCurrentStockofCentralStock = aRequisitionDal.GetCurrentStockofCentralStockByBatch(aRequsitionChild.ProductCode, aRequsitionChild.BatchNo);
      ...
      private void RequsitionChildToStockInTransfar(out StockInTransfar aStockInTransfar, dadtlsRequsitionChild aRequsitionChild)
      {
