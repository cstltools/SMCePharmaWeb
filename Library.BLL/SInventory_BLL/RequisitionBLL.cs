  ...
  public class RequisitionBLL
    {
      ...
      public string UpdateIssueInformationOnRequisitionChild(bool IsFromBatch , List<RequsitionChild> aRequsitionChildrenList)
      {
      ...
      public bool UpdateCentralStockAndStockInTransfar(bool IsFromBatch, RequsitionChild aRequsitionChild)
      {
