...
{
    public class SubDepotChalanBLL
    {
        ChalanInfo aChalanInfo = new ChalanInfo();
        SubDepotChalanDAL aChalanDal = new SubDepotChalanDAL();
        ClsPrimaryKeyFind aClsPrimaryKeyFind = new ClsPrimaryKeyFind();
        public bool SaveDataForChalanInfo(ChalanInfo aChalanInfo, out int ChalanId)
        {
            ChalanId = aClsPrimaryKeyFind.PrimaryKeyMax("SChalanId", "tblSubDepotChalanInfo");
