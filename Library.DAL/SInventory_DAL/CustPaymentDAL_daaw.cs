...
{
    public class CustPaymentDAL_daaw
    {
        ...
        public bool RejectInvoiceDAPaymentCollection(int invoiceId, int appLogId)
        {
            ...
            try
            {
                ...
                aSqlParameters.Add(new SqlParameter("@PaymentCollectionAppLogId", appLogId));
                status = accessManager.UpdateData("sp_RejectInvoiceDAPaymentCollection", aSqlParameters);
                return status;
            }
            catch (Exception e)
            {
        ...
        public bool SaveCustPayment(CustPayment_daaw aCustPayment)
        {
        ...
        public bool SaveCustPaymentWithRollback(CustPayment_daaw aCustPayment, List<CustPaymentDetail_daaw> paymentDetailList)
        {
            try
            {
                accessManager.SqlConnectionOpen(DataBase.SalesDB);
                ...
                foreach (CustPaymentDetail_daaw detail in paymentDetailList)
                {
                    ...
                    if (detail.PaymentCollectionAppLogId.HasValue && detail.PaymentCollectionAppLogId.Value > 0)
                    {
                        updateParameters.Add(new SqlParameter("@PaymentCollectionAppLogId", detail.PaymentCollectionAppLogId.Value));
                    }
        ...
        private string BuildSaveCustPaymentQuery(CustPayment_daaw aCustPayment)
        {
...
INSERT INTO dbo.tblCustomerPay
        ...
        private string BuildSaveCustDetailQuery(CustPaymentDetail_daaw aCustPaymentDetail)
        {
            ...
            string daNameId = aCustPaymentDetail.DANameId.HasValue
                ...
                : "NULL";
            string entryFromTag = aCustPaymentDetail.FromDACollection ? "'From DA'" : "NULL";
...
INSERT INTO dbo.tblCustPayDetail
        ( CustPayDetailId ,
          InvoiceId ,
          PaymentAmount ,
          CustPayId,TPAmount,VATAmount,CollectionBy ,DANameId,custPaymentDate,ReferenceNo,EntryFromTag
        )
