...
{
  public  class dadtlsBonusCampaignNewDAL
    {
        ...
        public ResultInfo SaveBonusCampaign(dadtlsBonusCampaignNewMasterDAO master, List<dadtlsBonusCampaignNewDetailDAO> _Dtls, List<BonusCampaignMarketDetailDAO> _MarketDtls, List<CampaignCustomerDetailDAO> _CamCustomerDtls, string sessionUser)
        {
            int pk = 0;  
             ResultInfo aInformation = new ResultInfo();
            try
      ...
      public ResultInfo SaveTargetEdit(TargetEditDAO master , string sessionUser)
        ...
        /// caller's connection/transaction so the re-check under the submit lock sees a consistent,
        /// isolated view instead of racing a concurrent submit through a separate auto-committing
        /// connection.
