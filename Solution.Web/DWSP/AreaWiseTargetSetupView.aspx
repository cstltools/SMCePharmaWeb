<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/NewMasterPage.master" AutoEventWireup="true" CodeFile="AreaWiseTargetSetupView.aspx.cs" Inherits="DWSP_AreaWiseTargetSetupView" %>
      ...
      .chkChoice label {
        ...
        <div class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3"><i class="bx bx-customize"></i> Area Wise Target List </div>

                <div class="ms-auto">
                    <div class="btn-group">

                        <a href="../DWSP/AreaWiseTargetSetup.aspx"  class="btn btn-sm btn-outline-info " ><i class="fa fa-plus" aria-hidden="true"></i> New Entry</a>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-8">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-7">
                                                <div class="input-group">
                                                    <asp:DropDownList  runat="server" id="ddlZone" CssClass="form-select form-select-sm mb-3 mySelect2"></asp:DropDownList>
                                ...
                                <div class="col-12">
                                    <div class="table-responsive" id="MainGradeDiv">
                                        ...
                                        <asp:GridView ID="gv_List" runat="server" AutoGenerateColumns="False" ShowFooter="True"
                                                      ...
                                                      DataKeyNames="AreaWTSetupId,IsActive"  OnRowCommand="loadGridView_RowCommand"
