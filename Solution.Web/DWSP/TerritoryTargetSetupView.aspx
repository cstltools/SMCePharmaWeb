<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/NewMasterPage.master" AutoEventWireup="true" CodeFile="TerritoryTargetSetupView.aspx.cs" Inherits="DWSP_TerritoryTargetSetupView" %>
      ...
      .chkChoice label {
        ...
        <div class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3"><i class="bx bx-customize"></i> Territory Wise Target List </div>

                <div class="ms-auto">
                    <div class="btn-group">

                        <a href="../DWSP/TerritoryWiseTargetSetup.aspx"  class="btn btn-sm btn-outline-info " ><i class="fa fa-plus" aria-hidden="true"></i> New Entry</a>
                            ...
                            <div class="row">
                                ...
                                <div class="col-8">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-7">
                                            <div class="input-group">
                                               <asp:DropDownList  runat="server"  id="groupname" AutoPostBack="True" OnSelectedIndexChanged="groupname_SelectedIndexChanged" CssClass="form-select form-select-sm mb-3 mySelect2"></asp:DropDownList>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-8">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-7">
                                                <div class="input-group">
                                                    <asp:DropDownList  runat="server" id="ddlZone" AutoPostBack="true" OnSelectedIndexChanged="ddlZone_SelectedIndexChanged" CssClass="form-select form-select-sm mb-3 mySelect2"></asp:DropDownList><asp:HiddenField ID="hfAreaId" runat="server" /> 
                                ...
                                <div class="col-12">
                                    <div class="table-responsive" id="MainGradeDiv">
                                        ...
                                        <asp:GridView ID="gv_List" runat="server" AutoGenerateColumns="False" ShowFooter="True"
                                                      ...
                                                      DataKeyNames="TerritoryWTSetupId,IsActive"  OnRowCommand="loadGridView_RowCommand"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Amount">
                                                    <ItemTemplate>
                                                        ...
                                                        <div class="form-group row">
                                                            <div class="col-md-10">
                                                                <asp:TextBox ID="txtAmount" runat="server" ReadOnly="true" Text='<%#Eval("Amount") %>' Height="65%" AutoPostBack="True" OnTextChanged="txtAmount_OnTextChanged" CssClass="form-control form-control-sm mb-3"></asp:TextBox>
