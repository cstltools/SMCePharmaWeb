<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/NewMasterPage.master" AutoEventWireup="true" CodeFile="ZoneWiseTargetSetup.aspx.cs" Inherits="DWSP_ZoneWiseTargetSetup" %>
      ...
      .chkChoice label {
        ...
        <div class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3"><i class="bx bx-customize"></i> Zone Wise Target Setup  </div>

                <div class="ms-auto">
                    <div class="btn-group">


                        <a href="../DWSP/ZoneWiseTargetSetupView.aspx" class="btn btn-sm btn-sm btn-outline-info"><i class="fa fa-backward"></i>&nbsp;Back to List</a>
                        ...
                        <div class="row">&nbsp;</div>
                            ...
                            <div class="row">
                               ...
                               <div class="row">
                                ...
                                <div class="col-8">
                                    <div class="form-group row">
                                        <label for="mainName" class="col-sm-3 col-form-label">National Target Amount:  </label>

                                        <div class="col-sm-7">
                                            <div class="input-group">
                                               <asp:Label  runat="server"   id="lblNationalTargetAmount" class="form-control form-control-sm mb-3 "></asp:Label>
