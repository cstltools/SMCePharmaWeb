...
public partial class DWSP_AreaWiseTargetSetup : System.Web.UI.Page
{
    ...
    private void NewMethod()
    {
        try
        {
            DataTable dtTargetAmount = aTargetSetupDal.Get_AreaTargetAmount_All_ByZone(ddlmonth.SelectedItem.Text, ddlYear.SelectedValue, ddlZone.SelectedValue);
    ...
    protected void ddlZone_OnSelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        if (ddlZone.SelectedValue != "")
        {
            ...
            DataTable ds = new DataTable();
                 ...
                 ds = aDal.GetArea_ByZoneId_All(ddlZone.SelectedValue);
