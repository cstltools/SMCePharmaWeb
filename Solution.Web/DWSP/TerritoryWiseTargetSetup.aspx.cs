...
public partial class DWSP_TerritoryWiseTargetSetup : System.Web.UI.Page
{
...
groupname.SelectedIndex = 0;
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        if (Validation())
        {
            ...
            ResultInfo Res = areaWise.SaveTerritoryWiseTarget(MarketList, Session["UserId"].ToString());
            if (Res.isSuccess == true)
            {
                ScriptManager.RegisterStartupScript(this, GetType(), "Popup", "successalert('" + "Operation successful!" + "','Success','TerritoryTargetSetupView.aspx');", true);
            }
            else
            {
