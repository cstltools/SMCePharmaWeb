<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/NewMasterPage.master" AutoEventWireup="true" CodeFile="AreaWiseTargetSetup.aspx.cs" Inherits="DWSP_AreaWiseTargetSetup" %>
      ...
      .chkChoice label {
        ...
        <div class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3"><i class="bx bx-customize"></i> Area Wise Target Setup  </div>

                <div class="ms-auto">
                    <div class="btn-group">


                        <a href="../DWSP/AreaWiseTargetSetupView.aspx" class="btn btn-sm btn-sm btn-outline-info"><i class="fa fa-backward"></i>&nbsp;Back to List</a>
                            ...
                            <div class="row">
                                ...
                                <div class="col-8">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-7">
                                            <div class="input-group">
                                               <asp:DropDownList  runat="server" AutoPostBack="true" OnSelectedIndexChanged="groupname_SelectedIndexChanged" id="groupname"  CssClass="form-select form-select-sm mb-3 mySelect2"></asp:DropDownList>
