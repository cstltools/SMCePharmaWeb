                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <asp:LinkButton  runat="server"  OnClick="Unnamed_Click"  class="btn btnMyDesignReset   btn-sm"  ><i class="fa fa-retweet" aria-hidden="true"></i>&nbsp; Reset </asp:LinkButton>
                                         ...
                                         <asp:LinkButton Visible="false"  runat="server" ID="btnAdd"  OnClick="btnAdd_Click"  class="btn btnMyDesignAddtoList  btn-sm"  ><i class="fa fa-plus-circle" aria-hidden="true"></i>&nbsp; Back to  Main Page </asp:LinkButton>
