<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/NewMasterPage.master" AutoEventWireup="true" CodeFile="NationalTargetSetup.aspx.cs" Inherits="DWSP_NationalTargetSetup" %>
      ...
      .chkChoice label {
        ...
        <div class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3"><i class="bx bx-customize"></i> National Target Setup </div>

                <div class="ms-auto">
                    <div class="btn-group">


                        <a href="../DWSP/NationalTargetSetupView.aspx" class="btn btn-sm btn-sm btn-outline-info"><i class="fa fa-backward"></i>&nbsp;Back to List</a>
