<%@ Control Language="C#" AutoEventWireup="true" CodeFile="IVMasterStructureForDCR.ascx.cs" Inherits="DoctorVisit_UI_IVMasterStructureForDCR" %>
                                ...
                                <div class="form-group row" runat="server" visible="false">
                                    <label for="GroupSelect" class="col-sm-4 col-form-label">  Group:  </label>
                                ...
                                <asp:Panel class="form-group row" id="divZone" runat="server" >

                                    <label for="ZoneSelect" class="col-sm-4 col-form-label"> Zone:  </label>
                                ...
                                <asp:Panel class="form-group row"   id="divArea" runat="server"   >
                                ...
                                <asp:Panel class="form-group row" id="divTerritory" runat="server">
                                   

                                    <label for="AreaSelect" class="col-sm-4 col-form-label">Territory:  </label>
                                ...
                                <div class="form-group row" style="margin-top:3px;" runat="server" Visible="False">
