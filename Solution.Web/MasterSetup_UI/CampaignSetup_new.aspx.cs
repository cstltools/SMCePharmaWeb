...
public partial class MasterSetup_UI_CampaignSetup_new : System.Web.UI.Page
{
    ...
    public void Gv_MultipleProductAdd_Initial()
    {
        DataTable aDataTableCus = new DataTable();
        aDataTableCus.Columns.Add("ProductId");
        aDataTableCus.Columns.Add("ProQty_MultipleProductAdd");
        gv_MultipleProductAdd.DataSource = aDataTableCus;
