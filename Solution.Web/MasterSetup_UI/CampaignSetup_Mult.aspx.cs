...
public partial class MasterSetup_UI_CampaignSetup_Mult : System.Web.UI.Page
{
    ...
    private void LoadInitialInfo()
    {
        ...
        try
        {
            using (DataTable dt = _BonusCampaignNewDAL.GetProductForDDL())
            {
                ...
                ddlProduct.DataSource = dt;
                ddlProduct.DataValueField = "ComUnitId";
                ddlProduct.DataTextField = "ComUnitName";
                ddlProduct.DataBind();
                try
                {
                    ddlProduct.Items.Insert(-1, "");
