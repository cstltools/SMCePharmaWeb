<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/NewMasterPage.master" AutoEventWireup="true" CodeFile="SMCTypeView.aspx.cs" Inherits="MasterSetup_UI_SMCTypeView" %>
    ...
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3"><i class="bx bx-customize"></i>  Pharma Platform  List</div>
                
                <div class="ms-auto">
                    <div class="btn-group">

                          <a href="../MasterSetup_UI/SMCType.aspx"  class="btn btn-sm btn-outline-info " ><i class="fa fa-plus" aria-hidden="true"></i> New Entry</a>
                        ...
                        <div class="card-body">
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th>Pharma Platform Code</th>
                                        <th>Pharma Platform Name</th>
                                       <th>For Customer </th>
                                        <th>For Doctor </th>
                                        <th>Is Default </th>
                                        <th>Entry By</th>
      ...
      <script type="text/javascript">
        ...
        function GetDegree() {
            ...
            $.ajax({
                url: 'ProgramTypeView.aspx/GetSMCTypeList',
                type: 'post',
                ...
                success: function(data) {
                    ...
                    for (var i = 0; i < result.length; i++) {
                        ...
                        row += "<td>" + un(result[i].SMCTypeCode) + "</td>";

                        row += "<td>" + un(result[i].SMCType) + "</td>";

                        if (result[i].forCustomer) {
                            row += "<td><span class='badge bg-success'>Yes</span></td>";
                        } else {
                            row += "<td><span class='badge bg-danger'>No</span></td>";
                        }

                        if (result[i].forDotor) {
                            row += "<td><span class='badge bg-success'>Yes</span></td>";
                        } else {
                            row += "<td><span class='badge bg-danger'>No</span></td>";
                        }
                        ...
                        row += "<td><button  class='btn-outline-warning  btn-xs mb-1 mb-md-0' type='button'   onclick='editClick(" + result[i].SMCTypeId + ")'><i class='bx bxs-edit' aria-hidden='true'></i></button> </td>";
        ...
        function editClick(id) {
            ...
            location.href = 'SMCType.aspx?id=' + id + '';
