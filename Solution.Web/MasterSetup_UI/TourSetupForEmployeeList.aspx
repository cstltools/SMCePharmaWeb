<%@ Page Title="Tour Type Setup List" Language="C#" MasterPageFile="~/MasterPages/NewMasterPage.master" AutoEventWireup="true" CodeFile="TourSetupForEmployeeList.aspx.cs" Inherits="MasterSetup_UI_TourSetupForEmployeeList" %>
    ...
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3"><i class="bx bx-customize"></i> Tour Type Setup List</div>
                
                <div class="ms-auto">
                    <div class="btn-group">

                      <a href="TourSetupForEmployee.aspx"  class="btn btn-sm btn-outline-info " ><i class="fa fa-plus" aria-hidden="true"></i> New Entry</a>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4" style="align-content:center">
                               ...
                               <asp:LinkButton  runat="server" class="btn btnMyDesignReset   btn-sm"   id="resetBtn" onclick="resetBtn_Click" ><i class="fa fa-retweet" aria-hidden="true"></i>&nbsp; Reset </asp:LinkButton>
                                ...
                                DataKeyNames="TourSetupEmployeeId"  onrowcommand="loadGridView_RowCommand" 
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="RoleType" HeaderText="Role Type" />
                                                 ...
                                                 <asp:TemplateField HeaderText="Count">
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="txtCountNo" runat="server"  ReadOnly="true"  Text='<%#Eval("CountNo") %>' CssClass="form-control form-control-sm mb-3 clsDecimal"></asp:TextBox>

                                                            <asp:FilteredTextBoxExtender ID="FilteredTssextBoxExtender1" runat="server"
                                                                                        Enabled="True" TargetControlID="txtCountNo" FilterType="Custom" ValidChars="0123456789"></asp:FilteredTextBoxExtender>
