<%@ Control Language="C#" AutoEventWireup="true" CodeFile="IVMarketStforAll.ascx.cs" Inherits="MasterSetup_UI_IVMarketStforAll" %>
...
<div class="form-group row" style="margin-top: 6px;" runat="server" >
