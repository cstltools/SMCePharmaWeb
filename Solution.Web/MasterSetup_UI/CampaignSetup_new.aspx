<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/NewMasterPage.master" AutoEventWireup="true" CodeFile="CampaignSetup_new.aspx.cs" Inherits="MasterSetup_UI_CampaignSetup_new" %>
                                            ...
                                            <div class="col-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-5">
                                                         ...
                                                         <div class="input-group">
                                                        <asp:DropDownList  runat="server"  class="form-select form-select-sm mb-3 mySelect2 "   ID="ddlProduct" AutoPostBack="true" OnSelectedIndexChanged="ddlProduct_SelectedIndexChanged"></asp:DropDownList>
...
<span class="input-group-text text-c-red">*</span>
                                            ...
                                            <div class="col-6" runat="server" id="DivPrdQty" visible="false">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-5">
                                                         <div class="input-group">
                                                     <asp:TextBox   runat="server"  AutoPostBack="true" OnTextChanged="txtProductQty_TextChanged" class="form-control form-control-sm mb-3 "   id="txtProductQty" placeholder=""></asp:TextBox>
...
<span class="input-group-text text-c-red">*</span>
                                    ...
                                    <div class="row">
                                           <div class="col-12" runat="server" visible="false" id="divrbType">
                                                <div class="form-group row">
                                        ...
                                        <ItemTemplate>
                                            <%#Container.DataItemIndex+1 %>
                                             <asp:HiddenField runat="server" ID="hfProductId_MultipleProductAdd" Value='<%#Eval("ProductId")%>' />
                                                    ...
                                                    <ItemTemplate>
                                                          <asp:DropDownList  runat="server"  class="form-select form-select-sm mb-3 mySelect2 "   ID="ddlProduct_MultipleProductAdd"></asp:DropDownList>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                    ...
                                                    <ItemTemplate>
                                                                ...
                                                                <asp:FilteredTextBoxExtender ID="FilteredTextBoxExtender4" runat="server"
                                                                                        Enabled="True" TargetControlID="txtProQty" FilterType="Custom" ValidChars="0123456789."></asp:FilteredTextBoxExtender>
                                                          </ItemTemplate>
                                                </asp:TemplateField>
                                                                        <asp:TemplateField HeaderText="Remove">
                                                                            <ItemTemplate>
