<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/NewMasterPage.master" AutoEventWireup="true" CodeFile="CampaignSetup_Mult.aspx.cs" Inherits="MasterSetup_UI_CampaignSetup_Mult" %>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-5">
                                                     ...
                                                     <%--   <asp:DropDownList  runat="server"  class="form-select form-select-sm mb-3 mySelect2 "   ID="ddlProduct"></asp:DropDownList>--%>
                                                              <asp:ListBox runat="server" ID="ddlProduct" SelectionMode="Multiple" class="form-select form-select-sm mb-3 multiple-select" name="ddlProduct"></asp:ListBox>
