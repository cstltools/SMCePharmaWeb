<%@ Page Title="Doctor's Chamber Type list" Language="C#" MasterPageFile="~/MasterPages/NewMasterPage.master" AutoEventWireup="true" CodeFile="ChamberTypeView.aspx.cs" Inherits="DoctorMaster_UI_ChamberTypeView" %>
     ...
     <div class="page-wrapper">
        ...
        <div class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3"><i class="bx bx-customize"></i> Doctor's Chamber Type list </div>
                
                <div class="ms-auto">
                    <div class="btn-group">
                        <a href="../DoctorMaster_UI/ChamberType.aspx"  class="btn btn-sm btn-outline-info " ><i class="fa fa-plus" aria-hidden="true"></i> New Entry</a>
...
<%--       <script type="text/javascript" src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>--%>
  ...
  <script type="text/javascript">
      ...
      function GetChamberType() {
          $.ajax({
              url: 'ChamberTypeView.aspx/Get_Doctor_Chamber',
              type: 'post',
              ...
              success: function (data) {
                  ...
                  for (var i = 0; i < result.length; i++) {
                      row += "<tr>";
                      row += "<td>" + (i + 1) + "</td>";
                      row += "<td>" + un(result[i].ChamberName) + "</td>";
                      ...
                      //}
                          ...
                          row += "<td><button class='btn-outline-warning    btn-xs mb-1 mb-md-0 ' onclick='editClick(" + result[i].ChamberId + ")'><i class='bx bxs-edit' aria-hidden='true'></i></button> </td>";
      ...
      function editClick(id) {
          location.href = "../DoctorMaster_UI/ChamberType.aspx?id=" + id;
      }

      function Final_DeleteClick(id) {
          var Id = id;
          $.ajax({
              url: 'ChamberTypeView.aspx/Delete_Doctorchamber',
              type: 'post',
              contentType: 'application/json;charset=utf-8',
              dataType: 'json',
              data: "{Id : '" + Id + "'}",
