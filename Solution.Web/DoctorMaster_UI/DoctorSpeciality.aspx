<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/NewMasterPage.master" AutoEventWireup="true" CodeFile="DoctorSpeciality.aspx.cs" Inherits="DoctorMaster_UI_DoctorSpeciality" %>
    ...
    .form-check {
        ...
        <div class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3"><i class="bx bx-customize"></i> Doctor's Speciality Information Entry</div>

                <div class="ms-auto">
                    <div class="btn-group">

                        <a href="../DoctorMaster_UI/DoctorSpecialityView.aspx" class="btn btn-sm btn-sm btn-outline-info"><i class="fa fa-backward"></i>&nbsp;Back to List</a>
                        ...
                        <div class="row">
                            ...
                            <div class="col-8">
                                <div class="form-group row">
                                    <label for="mainName" class="col-sm-3 col-form-label">Speciality:  </label>
                                      ...
                                      <div class="col-sm-7">
                                        ...
                                        <input type="text" class="form-control form-control-sm mb-3 " required="true" id="mainName" placeholder="Speciality">
    ...
    function ConfirmationClick(parameters) {
       ...
       $('#customSwitch1').on("change", function (e) {
           ...
           function FinalSave() {
               ...
               jsonData["SpecialityId"] = $('#ContentPlaceHolder1_masterId').val();
               jsonData["SpecialityName"] = $('#mainName').val();
               jsonData["IsActive"] = $('#customSwitch1').is(':checked');
               jsonData["Activedate"] = $('#acDate').val();

               $.ajax({

                   url: "DoctorSpeciality.aspx/Save_DoctorSpeaciality",
                   data: '{doctorSpeciality: ' + JSON.stringify(jsonData) + '}',
                   dataType: 'json',
                   type: "POST",
                   ...
                   success: function (result) {
                       if (result.d.isSuccess == true) {
                           ...
                           //var url = '../DoctorModule_UI/DoctorSpecialityView.aspx';
                           //window.location.href = url;

                           successalert('Operation successful!', 'Success', 'DoctorSpecialityView.aspx');
           ...
           function GetData(id) {
               ...
               $.ajax({
                   url: 'DoctorSpeciality.aspx/Get_DoctorSpecialityForEdit',
                   type: 'post',
                   contentType: 'application/json;charset=utf-8',
                   dataType: 'json',
                   data: "{id : '" + id + "'}",
                   ...
                   success: function (data) {
                       ...
                       $('#mainName').val(data.d.SpecialityName);
