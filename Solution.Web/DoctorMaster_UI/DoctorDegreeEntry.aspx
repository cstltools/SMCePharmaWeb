<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/NewMasterPage.master" AutoEventWireup="true" CodeFile="DoctorDegreeEntry.aspx.cs" Inherits="DoctorMaster_UI_DoctorDegreeEntry" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3"><i class="bx bx-customize"></i> Doctor's Degree Information Entry</div>

                <div class="ms-auto">
                    <div class="btn-group">

                        <a href="../DoctorMaster_UI/DoctorDegreeView.aspx" class="btn btn-sm btn-sm btn-outline-info"><i class="fa fa-backward"></i>&nbsp;Back to List</a>
                                ...
                                <div class="col-8">
                                     ...
                                     <div class="form-group row">
                                        <label for="mainName" class="col-sm-3 col-form-label">Doctor Type:  </label>
                                         ...
                                         <select id="DoctorTypeSelect" name="DoctorTypeSelect" class="form-select form-select-sm mb-3 mySelect2"></select>

                                        <span id="v-DoctorTypeSelect" class="invalid-tooltip fade hide" data-delay="2000">
                                        </span>
                                    ...
                                    <div class="form-group row">
                                        <label for="mainName" class="col-sm-3 col-form-label">Degree name:  </label>

                                     

                                           <div class="col-sm-7">
                                          <div class="input-group">
                                        <input type="text" class="form-control form-control-sm mb-3 " required="true" id="mainName" placeholder="Degree name">
   ...
   <script type="text/javascript">
       function GetDoctorTypeInfo(id) {
           _GetDoctorType_Active_New($('#DoctorTypeSelect'), 'DoctorTypeId', 'DoctorTypeName', id);
       }
    ...
    $(function () {
       ...
       function ConfirmationClick(parameters) {
        ...
        function Validation() {
            $('#DoctorTypeSelect').removeClass('is-invalid');
            ...
            if ($('#DoctorTypeSelect').val() == "" || $('#DoctorTypeSelect').val() == null || $('#DoctorTypeSelect').val() == "0") {

                $('#DoctorTypeSelect').addClass("is-invalid");
                ValidationTooltip("#v-DoctorTypeSelect", "Please fill out of this field!");
                isValid = false;
            }
        ...
        function FinalSave() {
            ...
            jsonData["DegreeId"] = $('#ContentPlaceHolder1_masterId').val();            
            jsonData["DegreeName"] = $('#mainName').val();
            var groupId = $('#DoctorTypeSelect').val();
            jsonData["DoctorTypeId"] = groupId;
            ...
            $.ajax({
                ...
                url: "DoctorDegreeEntry.aspx/Save_DoctorDegree",
                data: '{doctorDegree: ' + JSON.stringify(jsonData) + '}',
                dataType: 'json',
                type: "POST",
                ...
                success: function (result) {                
                    ...
                    if (result.d.isSuccess == true) {
                        successalert('Operation successful!', 'Success', 'DoctorDegreeView.aspx');
    ...
    function GetData(id) {
        /*    var urlpath = '@Url.Action("GetDoctorDegreeEditData", "Setup")';*/
            $.ajax({  
                url: 'DoctorDegreeEntry.aspx/GetDoctorDegreeEditData',
                type: 'post',
                contentType: 'application/json;charset=utf-8',
                dataType: 'json',
                data: "{id : '" + id + "'}",
                ...
                success: function (data) {
                    ...
                    $("#btnSave").html(" <i class='fa fa-check'></i>&nbsp;Update");
                        $('#mainName').val(data.d[i].DegreeName);

                        GetDoctorTypeInfo(data.d[i].DoctorTypeId);
                        //var Todate = formatDate(new Date(parseInt(data.d[i].Activedate.substr(6))));
                        //$('#acDate').val(Todate);
                        $('#acDate').val(ToJavaScriptDate_Formater(data.d[i].Activedate));
