<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/NewMasterPage.master" AutoEventWireup="true" CodeFile="PatientType.aspx.cs" Inherits="DoctorMaster_UI_PatientType" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    .form-check {
        ...
        <div class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3"><i class="bx bx-customize"></i> Patient Type Entry</div>

                <div class="ms-auto">
                    <div class="btn-group">

                        <a href="../DoctorMaster_UI/PatientTypeView.aspx" class="btn btn-sm btn-sm btn-outline-info"><i class="fa fa-backward"></i>&nbsp;Back to List</a>
                        ...
                        <div class="row">
                            ...
                            <div class="col-8">
                                <div class="form-group row">
                                    <label for="mainName" class="col-sm-3 col-form-label">Patient Type:  </label>
                                       ...
                                       <div class="col-sm-7">
                                        ...
                                        <input type="text" class="form-control form-control-sm mb-3 " required="true" id="mainName" placeholder="Patient Type">
    ...
    function FinalSave() {
        var jsonData = {};
        jsonData["PatientTypeId"] = $('#ContentPlaceHolder1_masterId').val();
        jsonData["PatientType"] = $('#mainName').val();
        jsonData["IsActive"] = $('#customSwitch1').is(':checked');
        jsonData["Activedate"] = $('#acDate').val();
        $.ajax({
            url: 'PatientType.aspx/Save_PatientTypeDay',
            data: '{aPatientTypeDao: ' + JSON.stringify(jsonData) + '}',
            dataType: 'json',
            type: "POST",
            ...
            success: function (result) {
                ...
                if (result.d.isSuccess == true) {
                    successalert('Operation successful!', 'Success', 'PatientTypeView.aspx');
                } else {
       ...
       function GetPatientTypeData(id) {      
            $.ajax({
                url: 'PatientType.aspx/GetDoctorSpecialDayForEdit',
                type: 'post',
                contentType: 'application/json;charset=utf-8',
                dataType: 'json',
                data: "{id : '" + id + "'}",
                ...
                success: function (data) {
                    $('#mainName').val(data.d.PatientType);
