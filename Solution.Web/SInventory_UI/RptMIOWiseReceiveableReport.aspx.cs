...
public partial class SInventory_UI_RptMIOWiseReceiveableReport : System.Web.UI.Page
{
    ...
    private void LoadInfo()
    {
        ...
        if (fromDateTextBox.Text != "" && toDateTextBox.Text != "")
        {
            ...
            aDataTable = aSummaryBll.RptMIOWiseReceiveableReport(Convert.ToDateTime(fromDateTextBox.Text.Trim()), Convert.ToDateTime(toDateTextBox.Text.Trim()), Type, ZonId, Area, Terr );
