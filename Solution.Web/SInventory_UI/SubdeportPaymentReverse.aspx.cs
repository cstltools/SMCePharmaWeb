...
public partial class SInventory_UI_SubdeportPaymentReverse : System.Web.UI.Page
{
    ...
    protected void submitButton_Click1(object sender, EventArgs e)
    {
        ...
        {
            DataTable aTable = aDal.subdepoGetOrderInformationByOrderNo(orderNoTextBox.Text.Trim());
    ...
    {
        DataTable aTable = aDal.subdGetPaymentInfoByInvoiceId(inoiceId);
    ...
    {
        return aDal.subResetInvoicePaymentStatus(inoiceId);
    }
