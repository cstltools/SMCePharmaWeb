<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PackSizeEdit.aspx.cs" Inherits="SInventory_UI_PackSizeEdit" %>
                ...
                <table width="100%" class="TableWorkArea">
                    ...
                    <tr>
                        ...
                        <td class="TDLeft" width="13%">
                            Pack Size</td>
                        <td class="TDRight" width="20%">
                            <asp:TextBox ID="packsizeNameTextBox" runat="server" CssClass="TextBox"></asp:TextBox>
                        </td>
                        <td class="TDLeft" width="13%">
                        </td>
                        <td class="TDRight" width="20%">
