...
public partial class SInventory_UI_ProductWiseSalesReport : System.Web.UI.Page
{
    ...
    private void LoadInfo()
    {
        ...
        if (fromDateTextBox.Text != "" && toDateTextBox.Text != "")
        {
            ...
            aDataTable = aSummaryBll.ProductWiseSalesReportDAL(Convert.ToDateTime(fromDateTextBox.Text.Trim()), Convert.ToDateTime(toDateTextBox.Text.Trim()), Type, ZonId, Area, Terr);
