...
public partial class SInventory_UI_SalesComparisoneReport : System.Web.UI.Page
{
    ...
    {
        string url = "../SInventory_RPTVIEW/SalesComparisoneReportViewer.aspx?fromDate=" + fromDate + "&toDate=" + toDate + "&rptType=" + reportType; ;
