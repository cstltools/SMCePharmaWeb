...
public partial class SInventory_UI_CustomerList : System.Web.UI.Page
{
    ...
    private ExcelUpForCustTagChangeBLL aExcelUpForMIGOBLL = new ExcelUpForCustTagChangeBLL();
    ...
    {
        string url = "../SInventory_RPTVIEW/CustVerUnverExcelViewer.aspx?status=" + 3 + "&id=" + id;
        string fullURL = "var Mleft = (screen.width/2)-(950/2);var Mtop = (screen.height/2)-(700/2);window.open( '" + url + "', null, 'height=700,width=950,status=yes,toolbar=no,addressbar=no, scrollbars=yes,menubar=no,location=no,top=\'+Mtop+\', left=\'+Mleft+\'' );";
        ScriptManager.RegisterStartupScript(this, typeof(string), "OPEN_WINDOW", fullURL, true);  
    }
    public void ExportToExcelUnVerified(string id)
    {
        string url = "../SInventory_RPTVIEW/CustVerUnverExcelViewer.aspx?status=" + 4 + "&id=" + id;
        string fullURL = "var Mleft = (screen.width/2)-(950/2);var Mtop = (screen.height/2)-(700/2);window.open( '" + url + "', null, 'height=700,width=950,status=yes,toolbar=no,addressbar=no, scrollbars=yes,menubar=no,location=no,top=\'+Mtop+\', left=\'+Mleft+\'' );";
        ScriptManager.RegisterStartupScript(this, typeof(string), "OPEN_WINDOW", fullURL, true);  
    }
    ...
    public string Parameter()
    {
        ...
        {
            paramter = " tblCustomerMasterTagChangeExcelFileMaster.ManufacId='" + manufacturerDropDownList.SelectedValue + "";
        }
