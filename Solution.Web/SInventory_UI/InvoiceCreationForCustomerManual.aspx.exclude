<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MainMasterPage.master" AutoEventWireup="True" CodeFile="InvoiceCreationForCustomerManual.aspx.cs" Inherits="SInventory_UI_InvoiceCreationForCustomer" %>
                ...
                <table width="100%" class="TableWorkArea">
                    ...
                    <tr>
                        <td class="TDLeft" width="13%">
                            Invoice No</td>
                        <td class="TDRight" width="20%">
                            <asp:TextBox ID="invoiceNoSearchTextBox" runat="server" AutoPostBack="True" 
                    ...
                    <tr>
                        <td class="TDLeft" width="13%" colspan="6">
                            <asp:GridView ID="gridLineItemGridView" runat="server" 
                                AutoGenerateColumns="False" CssClass="gridview" DataKeyNames="ISGiftProduct" >
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="SD">
                                        <ItemTemplate>
                                            <asp:TextBox ID="sdTextBox" runat="server" CssClass="TextBoxMicroMini" 
                                                Text= <%# Eval("IsCampaignProduct")%> ></asp:TextBox>
                                    ...
                                    <asp:TemplateField HeaderText="NP">
                                        <ItemTemplate>
                                            <asp:TextBox ID="npTextBox" runat="server" CssClass="TextBoxMicroMini" 
                                                Text= <%# Eval("NetPrice")%> ></asp:TextBox>
                                    ...
                                    <asp:TemplateField HeaderText="BQty">
                                        <ItemTemplate>
                                            <asp:TextBox ID="bQtyTextBox" runat="server" CssClass="TextBoxMicroMini" 
                                                ...
                                                ontextchanged="bQtyTextBox_TextChanged" ></asp:TextBox>
                                    ...
                                    <asp:TemplateField HeaderText="TQty">
                                        <ItemTemplate>
                                            <asp:TextBox ID="tQtyTextBox" runat="server" CssClass="TextBoxMicroMini" 
                                                Text= <%# Eval("TotalQty")%> ></asp:TextBox>
                                       ...
                                       <asp:TemplateField HeaderText="add" runat="server" >
                                        <ItemTemplate>
                                            <asp:ImageButton ID="addImageButton2" runat="server" 
                                                ImageUrl="~/images/lineAdd.png" onclick="addImageButton_Click" />
                                            <asp:ImageButton ID="removButton" runat="server" 
                                                ImageUrl="~/images/lineDelete.png" onclick="removeImageButton_Click" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
                    ...
                    <tr>
                        ...
                        <td class="TDRight" width="20%">
                            ...
                            <asp:HiddenField ID="invIdHiddenField" runat="server" />
                        </td>
                        <td class="TDLeft" width="13%">
                            &nbsp;</td>
                        <td class="TDRight" width="20%">
