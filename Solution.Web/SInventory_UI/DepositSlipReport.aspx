                         ...
                         <div class="col-4">
                             <div class="form-group row" runat="server">
                                 ...
                                 <div class="col-sm-7">
                                     ...
                                     <asp:DropDownList ID="territoryDropDownList" runat="server" Visible="false"></asp:DropDownList>
                                     <asp:DropDownList ID="zoneDropDownList" runat="server" Visible="false"></asp:DropDownList>
                                 </div>
                             </div>
                         </div>
                  ...
                  <asp:TextBox ID="toDateTextBox" runat="server"  class="form-control form-control-sm mb-3 datepicker" autocomplete="off" placeholder="Select To Date"></asp:TextBox>
                     ...
                     <div class="col-3" >
                          ...
                          <div class="form-group row  pull-right">
                                 ...
                                 <asp:LinkButton ID="btnProcessOpeningBalance"
    runat="server" Visible="false"
    CssClass="btn btn-warning btn-sm"
    OnClick="btnProcessOpeningBalance_Click"
    OnClientClick="return confirm('Are you sure? This will reprocess Opening Balance for the selected date.');">
    <i class="fa fa-cogs" aria-hidden="true"></i>&nbsp; Process Opening Balance
</asp:LinkButton>
                                    ...
                                    <asp:BoundField DataField="ShortName" HeaderText="Sales Center"  />
                                     ...
                                     <asp:BoundField DataField="CashinHand" HeaderText="Cash in Hand"  />
                                      ...
                                      <asp:BoundField DataField="JustSalesVat" HeaderText="Vat"  />
                                       <asp:BoundField DataField="JustSalesTotal" HeaderText="Total Sales"  />
                                       
                                       
                                       
                                            
                                        <asp:BoundField DataField="CurrentPeriodSales" HeaderText="Current Period "  />
                                        <asp:BoundField DataField="PriorPeriodSales" HeaderText="Prior Period"  />
