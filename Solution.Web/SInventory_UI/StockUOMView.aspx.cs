...
public partial class SInventory_UI_StockUOMView : System.Web.UI.Page
{
    ...
    private void StockUOMLoad()
    {
        aDataTable = aStockUOMBll.LoadStockUOM();
    ...
    {
        string url = "StockUOMEdit.aspx?ID=" + Id;
    ...
    protected void loadGridView_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName == "EditData")
        {
            ...
            string url = "StockUOMEntry.aspx?ID=" + CetegoryId;
