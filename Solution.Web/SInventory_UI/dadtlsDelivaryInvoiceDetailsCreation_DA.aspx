<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/NewMasterPage.master" AutoEventWireup="true" CodeFile="dadtlsDelivaryInvoiceDetailsCreation_DA.aspx.cs" Inherits="dadtlsSInventory_UI_DelivaryInvoiceDetailsCreation_DA" %>
      ...
      <asp:UpdatePanel ID="UpdatePanel4" runat="server">
        ...
        <div class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3"><i class="bx bx-customize"></i> Delivery confirmation Partial </div>
                ...
                <asp:GridView ID="gridLineItemGridView" runat="server" 
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="DQty">
                                        <ItemTemplate>
                                          <%--   AutoPostBack="True"
            ontextchanged="dQtyTextBox_TextChanged" --%>
                                            <asp:TextBox ID="dQtyTextBox" runat="server" AutoPostBack="True"
            ontextchanged="dQtyTextBox_TextChanged"    CssClass="form-control form-control-sm "  Text= <%# Eval("TotalQty")%> ></asp:TextBox>
...
<div class="row">
 ...
 <asp:LinkButton ID="submitButton" CssClass="btn btnMyDesignSearch   btn-sm" runat="server" OnClick="saveButton_Click"
                               OnClientClick="return submitButton_ClientClick(this);"> <i class="fa fa-check"></i>&nbsp; Approve (Partial)</asp:LinkButton>

                           <asp:LinkButton ID="btnPartialReject" CssClass="btn btn-danger btn-sm" runat="server" OnClick="btnPartialReject_Click"
                        ...
                        <script type="text/javascript">
                            ...
                            function disableSubmitButtons() {
                                ...
                                var btnReject = document.getElementById('<%= btnPartialReject.ClientID %>');
                ...
                <table width="100%" class="TableWorkArea">
                    <tr>
                     ...
                     <tr>
                        <td class="TDLeft" width="13%">
                            <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="LoadingSummary_DA.aspx">Back to List</asp:HyperLink>                          
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="TDRight" width="20%">
                            ...
                            <asp:HiddenField ID="hfSalesConfirmationAppLogId" runat="server" />
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="TDLeft" width="13%">
                            <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                                <ContentTemplate>
                                    <asp:Button ID="Button1" runat="server" Text="dadtlsInvoice Generate" OnClick="saveButton_Click" OnClientClick="return confirm('Are you sure you want to Save Delivery dadtlsInvoice ?');" />
                                </ContentTemplate>
                            </asp:UpdatePanel>
