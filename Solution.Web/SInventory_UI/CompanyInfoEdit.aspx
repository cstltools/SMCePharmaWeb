<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CompanyInfoEdit.aspx.cs" Inherits="SInventory_UI_CompanyInfoEdit" %>
                ...
                <table width="100%" class="TableWorkArea">
                    <tr>
                        <td colspan="6" class="TableHeading">
                            Company Information Edit</td>
                    </tr>
                    <tr>
                        <td class="TDLeft" width="13%">
                            &nbsp;
                            <asp:HiddenField ID="companyInfoIdHiddenField" runat="server" />
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="TDLeft" width="13%">
                            Address</td>
                        <td class="TDRight" width="20%">
                            <asp:TextBox ID="addressNameTextBox" runat="server" CssClass="TextBox"></asp:TextBox>
                        </td>
                        <td class="TDLeft" width="13%">
                            &nbsp;
                        </td>
                    ...
                    <tr>
                        ...
                        <td width="13%" class="TDLeft">
                            Remarks</td>
                        <td width="20%" class="TDRight">
                            <asp:TextBox ID="remarksTextBox" runat="server" CssClass="TextBox" 
