<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MainMasterPage.master" AutoEventWireup="true" CodeFile="CustomerList.aspx.cs" Inherits="SInventory_UI_CustomerList" %>
                        ...
                        <td width="20%" class="TDRight" colspan="4">
                            <div id ="gridContainer1" style ="height:400px;overflow:auto;width:auto ">
                             <asp:GridView ID="loadGridView" runat="server" AutoGenerateColumns="False"
                                CssClass="gridview" DataKeyNames="CustomerMasterExcelFileMasterID" 
                                ...
                                <ItemTemplate>
                                    ...
                                    <asp:BoundField DataField="CustomerMasterExcelFileDocumentDate" HeaderText="Document Upload Date" DataFormatString="{0:dd-MMM-yyyy}"/>
                                  ...
                                  <%--   <asp:TemplateField HeaderText="View Detail">
                                    ...
                                    <asp:TemplateField HeaderText="Unverified">
                                     ...
                                     <asp:TemplateField HeaderText="Transfer to Customer Master">
                                        <ItemTemplate>
