...
public partial class SInventory_UI_TotalSummaryNew2 : System.Web.UI.Page
{
    ...
    private void LoadInfo()
    {
        ...
        if (fromDateTextBox.Text != "" && toDateTextBox.Text != "")
        {
            ...
            aDataTable = aSummaryBll.LoadSummaryProductcodewiseGyash(Convert.ToDateTime(fromDateTextBox.Text.Trim()), Convert.ToDateTime(toDateTextBox.Text.Trim()), Type, Area, Terr, ZoneId);
            if (RoleTypeName == "DZSM")
            {
