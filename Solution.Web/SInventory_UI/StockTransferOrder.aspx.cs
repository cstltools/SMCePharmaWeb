...
public partial class SInventory_UI_StockTransferOrder : System.Web.UI.Page
{
    ...
    private void SaveAllData()
    {
        ...
        if (hiddenField.Value=="")
        {
            ...
            for (int i = 0; i < chalanGridView.Rows.Count; i++)
            {
                ...
                TextBox productCodeTextBox = (TextBox)chalanGridView.Rows[i].Cells[1].FindControl("productCodeTextBox");
                TextBox productNameTextBox = (TextBox)chalanGridView.Rows[i].Cells[2].FindControl("productNameTextBox");
                TextBox packSizeTextBox = (TextBox)chalanGridView.Rows[i].Cells[3].FindControl("packSizeTextBox");
                TextBox quantityTextBox = (TextBox)chalanGridView.Rows[i].Cells[4].FindControl("reqQtyTextBox");

                TextBox txtBatchNo = (TextBox)chalanGridView.Rows[i].Cells[4].FindControl("txtBatchNo");
                ...
                aRequsitionChild.BatchNo = txtBatchNo.Text.Trim();
    ...
    public bool Validation()
    {
        ...
        if (chalanGridView.Rows.Count > 0)
        {
            for (int i = 0; i < chalanGridView.Rows.Count; i++)
            {
                if (((TextBox)chalanGridView.Rows[i].FindControl("reqQtyTextBox")).Text == "")
                {
                    ((TextBox)chalanGridView.Rows[i].FindControl("reqQtyTextBox")).Focus();
        ...
        if (chalanGridView.Rows.Count > 0)
        {
            for (int i = 0; i < chalanGridView.Rows.Count; i++)
            {
                if (((TextBox)chalanGridView.Rows[i].FindControl("productCodeTextBox")).Text == "")
                {
                    ((TextBox)chalanGridView.Rows[i].FindControl("productCodeTextBox")).Focus();
        ...
        if (chalanGridView.Rows.Count > 0)
        {
            for (int i = 0; i < chalanGridView.Rows.Count; i++)
            {
                if (((TextBox)chalanGridView.Rows[i].FindControl("productNameTextBox")).Text == "")
                {
                    ((TextBox)chalanGridView.Rows[i].FindControl("productNameTextBox")).Focus();
...

   {
    ...
    protected void dQtyTextBox_TextChanged(object sender, EventArgs e)
    {
        for (int i = 0; i < productGridView.Rows.Count; i++)
        {
            ...
            //if (cbReject.Checked)
            {
                ...
                mainqty = string.IsNullOrEmpty(productGridView.Rows[i].Cells[4].Text)
                    ? 0
                    : Convert.ToDecimal(productGridView.Rows[i].Cells[4].Text);
                ...
                {
                    showMessageBox("STO Qty. cantbe more then Stock Quantity");
                    ((TextBox)productGridView.Rows[rowindex].Cells[3].FindControl("transferQtyTextBox")).Text = string.Empty;
                }
            }
        }
    }
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        if (prodctCodeTextBox.Text.Trim() != "")
        {
            DataTable dtdata = aChalanBll.GetProductWhStore(prodctCodeTextBox.Text.Trim());
    ...
    protected void addButton_Click(object sender, EventArgs e)
    {
        ...
        for (int i = 0; i < productGridView.Rows.Count; i++)
        {
            ...
            if (ChkBoxRows.Checked && ((TextBox)productGridView.Rows[i].Cells[6].FindControl("transferQtyTextBox")).Text.Trim() != "")
            {
                if (HasDCStoreId(Convert.ToInt32(productGridView.DataKeys[i][0].ToString())))
                {
                    ...
                    dataRow["PackSize"] = productGridView.Rows[i].Cells[3].Text;
                    dataRow["BatchNo"] = productGridView.Rows[i].Cells[5].Text;
                    dataRow["Quantity"] = ((TextBox)productGridView.Rows[i].Cells[6].FindControl("transferQtyTextBox")).Text.Trim();
        ...
        for (int i = 0; i < chalanGridView.Rows.Count; i++)
        {
            ...
            dataRow["ProductCode"] = ((TextBox)chalanGridView.Rows[i].Cells[6].FindControl("productCodeTextBox")).Text.Trim();
            dataRow["ProductName"] = ((TextBox)chalanGridView.Rows[i].Cells[6].FindControl("productNameTextBox")).Text;
            dataRow["PackSize"] = ((TextBox)chalanGridView.Rows[i].Cells[6].FindControl("packSizeTextBox")).Text;

            dataRow["BatchNo"] = ((TextBox)chalanGridView.Rows[i].Cells[6].FindControl("txtBatchNo")).Text;

            dataRow["Quantity"] = ((TextBox)chalanGridView.Rows[i].Cells[6].FindControl("reqQtyTextBox")).Text.Trim(); 
