<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProUnitPriceEdit.aspx.cs" Inherits="SInventory_UI_ProUnitPriceEdit" %>
                ...
                <table width="100%" class="TableWorkArea">
                    ...
                    <tr>
                        ...
                        <td class="TDRight" width="20%">
                            <asp:TextBox ID="productCodeTextBox" runat="server" CssClass="TextBox" 
                                ontextchanged="productCodeTextBox_TextChanged" ReadOnly="True"></asp:TextBox>
                        </td>
                        <td class="TDLeft" width="13%">
                            &nbsp;</td>
                        <td class="TDRight" width="20%">
                    ...
                    <tr runat="server" Visible="False">
                        ...
                        <td class="TDLeft" width="13%">
                            Cost Price</td>
                        <td class="TDRight" width="20%">
                            <asp:TextBox ID="costPriceTextBox" runat="server" CssClass="TextBox"></asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td width="13%" class="TDLeft">
                            Unit Price</td>
                        <td width="20%" class="TDRight">
                            <asp:TextBox ID="unitPriceTextBox" runat="server" CssClass="TextBox"></asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td width="13%" class="TDLeft">
                            Vat Percent %</td>
                        <td width="20%" class="TDRight">
                            <asp:TextBox ID="vatperTextBox" runat="server" CssClass="TextBox"></asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td width="13%" class="TDLeft">
                            Vat Amount</td>
                        <td width="20%" class="TDRight">
                            <asp:TextBox ID="vatAmountTextBox" runat="server" CssClass="TextBox"></asp:TextBox>
