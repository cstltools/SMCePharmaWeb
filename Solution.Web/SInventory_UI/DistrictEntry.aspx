<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MainMasterPage.master" AutoEventWireup="true" CodeFile="DistrictEntry.aspx.cs" Inherits="SInventory_UI_DistrictEntry" %>
                    ...
                    <tr>
                        ...
                        <td width="20%" class="TDRight">
                            <asp:ImageButton ID="departmentListImageButton" runat="server" 
                                ImageUrl="~/images/viewList.png" 
                                onclick="DistrictInfoListImageButton_Click" />
                        </td>
                        <td width="13%" class="TDLeft">
                        </td>
                        <td width="20%" class="TDRight">
