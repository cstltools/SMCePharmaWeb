<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MainMasterPage.master" AutoEventWireup="true" CodeFile="DeliveryReturnReport.aspx.cs" Inherits="SInventory_UI_DeliveryReturnReport" %>
             ...
             <tr>
                ...
                <td class="TDRight" width="20%">
                    ...
                    <tr>
                        ...
                        <td width="20%" class="TDRight">
                      <%--      <asp:Button ID="reportButton" runat="server" CssClass="button-padding-right" OnClick="viewRptButton_Click" 
                                Text="View Report" />
--%>
