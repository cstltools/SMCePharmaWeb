<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MainMasterPage.master"
    AutoEventWireup="true" CodeFile="SubdeportMonthlyInventoryReport.aspx.cs" Inherits="SInventory_UI_SubdeportMonthlyInventoryReport" %>
                ...
                <table width="100%" class="TableWorkArea">
                    <tr>
                        <td colspan="6" class="TableHeading">
                            Subdepot Monthly Inventory Report
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr runat="server" id="branch" Visible="False">
                        <td class="TDLeft" width="13%">
                        </td>
                        <td class="TDRight" width="20%">
                        </td>
                        ...
                        <td class="TDRight" width="20%">
                            <asp:DropDownList ID="branchDropDownList" runat="server" CssClass="DropDown">
                            </asp:DropDownList>
                        </td>
                        <td class="TDLeft" width="13%">
                            &nbsp;
                    ...
                    <tr>
                        ...
                        <td class="TDRight" width="20%">
                            ...
                            <cc1:CalendarExtender ID="CalendarExtender1" runat="server" Format="dd-MMM-yyyy"
                                TargetControlID="todateTextBox" PopupButtonID="imgDatsea">
                            </cc1:CalendarExtender>
                        </td>
                        <td class="TDLeft" width="13%">
                            &nbsp;
