...
public partial class SInventory_UI_ProformaReport : System.Web.UI.Page
{
    ...
    protected void loadGridView_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        if (e.CommandName == "reportData")
        {
            ...
            string param = "";
            param = " AND INV.InvoiceId IN (" + I + ")";

            Session["InvoiceIds"] = "";
            Session["InvoiceIds"] = param;

            string url = "../SInventory_RPTVIEW/MoneyReceiptViewer2.aspx";
            // string fullURL = "window.open('" + url + "', '_blank', 'height=600,width=900,status=yes,toolbar=no,menubar=no,location=no,scrollbars=yes,resizable=no,titlebar=no' );";
    ...
    protected void btnPrint_Click(object sender, EventArgs e)
    {
        ...
        Session["InvoiceIds"] = "";
        Session["InvoiceIds"] = GenerateParameter();
    ...
    {
        string param = " AND INV.InvoiceId IN (";
