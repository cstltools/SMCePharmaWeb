<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/NewMasterPage.master" AutoEventWireup="true" CodeFile="PackSizeView.aspx.cs" Inherits="SInventory_UI_PackSizeView" %>
    ...
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3"><i class="bx bx-customize"></i> Pack Size  List</div>
                    ...
                    <div class="card border-top border-0 border-4 border-success">
                        <div class="card-body">
                            <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                              ...
                              DataKeyNames="PackSizeId"  CssClass="table table-striped table-bordered" OnPreRender="gv_DocumentUpload_PreRender"
                                onrowcommand="loadGridView_RowCommand" >
                                <Columns>
                                    <asp:BoundField DataField="PackSizeName" HeaderText="Pack Size Name" />
