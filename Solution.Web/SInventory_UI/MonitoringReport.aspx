<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/NewMasterPage.master" EnableEventValidation="false"
    AutoEventWireup="true" CodeFile="MonitoringReport.aspx.cs" Inherits="SInventory_UI_MonitoringReport" %>
    ...
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3"><i class="bx bx-customize"></i>Invoice, Sales & Deposit Statement Report (Monitoring Report)</div>
                                    ...
                                    <div class="row">
                                                    ...
                                                    <asp:RadioButtonList runat="server" ID="rbReportTypeName" CssClass="radioChoice2" AutoPostBack="True" OnSelectedIndexChanged="rbReportTypeName_SelectedIndexChanged"   RepeatDirection="Horizontal" RepeatColumns="1" RepeatLayout="Flow">
                                                     <%--   <asp:ListItem Value="1">User Wise</asp:ListItem>--%>
                                                        ...
                                                        <asp:ListItem Value="1">Distribution Center</asp:ListItem>
                                                        <asp:ListItem Selected="True"  Value="2">Zone</asp:ListItem> 
                                    ...
                                    <div class="table-responsive" id="MainGradeDiv" style="height: 600px">
                                        ...
                                        <ItemTemplate>
                                            <asp:Label ID="LabelSL" Text='<%# Container.DataItemIndex + 1 %>' runat="server"></asp:Label>
                                                ...
                                                <asp:BoundField DataField="ShortName" HeaderText="Distribution Center" />
                                    ...
                                    <ItemStyle HorizontalAlign="Right" Width="60px" />
                                         ...
                                         <asp:GridView ID="gv_Zone" runat="server" CssClass="table table-striped table-bordered" AutoGenerateColumns="False" OnPageIndexChanging="OnPageIndexChanging" OnRowCreated="gv_Zone_OnRowCreated"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="ShortName" HeaderText="Zone" />

                                          

                                              <%--  Invoice--%>
                                                    <asp:BoundField DataField="Invoice_PreviousPeriodOpening" HeaderText="Previous Period (Opening)" />
                                                 
                                                <asp:BoundField DataField="Invoice_CurrentPeriod" HeaderText="Current Period" />

                                            
                                                   <asp:BoundField DataField="Invoice_Period_Total" HeaderText="Total" />
                                             


                                                  <%--  Sales--%>
                                                     <asp:BoundField DataField="Sales_PreviousPeriod" HeaderText="Previous Period" />
                                                <asp:BoundField DataField="Sales_CurrentPeriod" HeaderText="Current Period" />



                                            
                                                   <asp:BoundField DataField="Sales_Period_Total" HeaderText="Total" />
                                             

                                                  <%--  Discount--%>

                                                <asp:BoundField DataField="Discount_PreviousPeriod" HeaderText=" Previous Period" />



                                                
                                                 <asp:BoundField DataField="Discount_CurrentPeriod" HeaderText="Current Period" />
                                                   <asp:BoundField DataField="Discount_Period_Total" HeaderText="Total" />
                                             


                                                     <%--  Return--%>
                                                 <asp:BoundField DataField="Return_PreviousPeriod" HeaderText="Previous Period" />

                                                <asp:BoundField DataField="Return_CurrentPeriod" HeaderText="Current Period" />



                                                

                                                   <asp:BoundField DataField="Return_Period_Total" HeaderText="Total" />


                                                  <%--  Blank--%>

                                                <asp:BoundField DataField="BankDeposit" HeaderText="Bank Deposit" />
...
--%>
                                                ...
                                                <asp:BoundField DataField="ClosingInvoice_PreviousPeriod" HeaderText="Previous Period" />



                                                
                                                 <asp:BoundField DataField="ClosingInvoice_CurrentPeriod" HeaderText="Current Period" />


                                                     
                                                 <asp:BoundField DataField="ClosingInvoice__Period_Total" HeaderText="Total" />
                                        ...
                                        <ItemTemplate>
                                            <asp:Label ID="LabelSL" Text='<%# Container.DataItemIndex + 1 %>' runat="server"></asp:Label>
                                                ...
                                                <asp:BoundField DataField="RegionName" HeaderText="Zone" />
                                                       ...
                                                       <asp:BoundField DataField="ShortName" HeaderText="Area" />
...
<%--                                                <asp:BoundField DataField="NumberofInvoiceSold" HeaderText="Number of Invoices Sold" DataFormatString="{0:D}" Visible="false" />--%>
                                        ...
                                        <ItemTemplate>
                                            <asp:Label ID="LabelSL" Text='<%# Container.DataItemIndex + 1 %>' runat="server"></asp:Label>
                                                ...
                                                <asp:BoundField DataField="ComUnitCode" HeaderText="Sales Center" Visible="false" />
                                                <asp:BoundField DataField="RegionName" HeaderText="Zone" /> <asp:BoundField DataField="AreaName" HeaderText="Area" />

                                                       <asp:BoundField DataField="ShortName" HeaderText="Territory" />
