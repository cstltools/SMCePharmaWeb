<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MainMasterPage.master" AutoEventWireup="true" CodeFile="ActiveCustomerMasterList.aspx.cs" Inherits="SInventory_UI_ActiveCustomerMasterList" %>
                        ...
                        <td class="TDLeft" colspan="6">
                            <div id="gridContainer1" style="height: 500px; overflow: auto; width: auto">
                                <asp:GridView ID="loadGridView" runat="server" AutoGenerateColumns="False" CssClass="gridview"
                                    DataKeyNames="" OnRowCommand="loadGridView_RowCommand">
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="CustomerStation" HeaderText="Customer Station" /> 
                                        <asp:BoundField DataField="ComUnitName" HeaderText="ComUnitName" />
