<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MainMasterPage.master" AutoEventWireup="true" CodeFile="DeleteOrderReport.aspx.cs" Inherits="SInventory_UI_DeleteOrderReport" %>
                ...
                <table width="100%" class="TableWorkArea">
                    ...
                    <tr>
                      ...
                      <tr runat="server" visible="True" id="Tr1">
                        ...
                        <td class="TDRight" width="20%">
                            <asp:CheckBox ID="nationalCheckBox" runat="server" AutoPostBack="True"
