...
public partial class SInventory_UI_SalesRejectionReport : System.Web.UI.Page
{
    ...
    {
        Response.Redirect("SalesRejectionReport.aspx");
    }
    ...
    private void LoadData()
    {
        ...
        comUnitDetailDataTable = _DAL.GetSalesRejectionReportDAL(Parm(), Parm2());
    ...
    private string Parm()
    {
        ...
        {
            param = param + " AND CONVERT(date,I.RejectionDate)  BETWEEN '" + InvoiceDateTextBox.Text + "' AND '" + todateTextBox.Text + "' ";
        }
        if (InvoiceDateTextBox.Text != "" && todateTextBox.Text == "")
        {
            param = param + " AND CONVERT(date,I.RejectionDate)  BETWEEN '" + InvoiceDateTextBox.Text + "' AND '" + DateTime.Now + "' ";
        }
    ...
    protected void btnExport_Click(object sender, EventArgs e)
    {
        ...
        if (loadGridView.Rows.Count > 0)
        {
            ...
            Response.AddHeader("content-disposition", "attachment;filename=Sales_Rejection_Report_" + DateTime.Now.ToString("dd_MMM_yyyy_hh_mm_tt") + ".csv");
            Response.Charset = "";
        ...
        System.Diagnostics.Debug.WriteLine(executionTimeMessage);
        //if (loadGridView.Rows.Count > 0)
        //{
