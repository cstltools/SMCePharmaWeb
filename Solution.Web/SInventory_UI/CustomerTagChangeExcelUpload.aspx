<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MainMasterPage.master"
    AutoEventWireup="true" CodeFile="CustomerTagChangeExcelUpload.aspx.cs" Inherits="SInventory_UI_CustomerTagChangeExcelUpload" %>
        ...
        <table width="100%" class="TableWorkArea">
                    ...
                    <div id="gridContainer1" style="height: 1000px; overflow: auto; width: 960px">
                        <asp:GridView ID="loadGridView" runat="server" CssClass="gridview" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="CustomerCode" HeaderText="Customer Code" HtmlEncode="False"
                                ...
                                <asp:BoundField DataField="CONTACTPERSON" HeaderText="CONTACT PERSON" HtmlEncode="False"
                                    HtmlEncodeFormatString="False" />
                                <asp:BoundField DataField="CONTACTNUMBER" HeaderText="CONTACT NUMBER" HtmlEncode="False"
                                    HtmlEncodeFormatString="False" />
                                ...
                                <asp:BoundField DataField="TerritoryCode" HeaderText="Territory Code" HtmlEncode="False"
                                    HtmlEncodeFormatString="False" />
                                ...
                                <asp:BoundField DataField="SHIPPINGCOND" HeaderText="SHIPPING COND." HtmlEncode="False"
                                    HtmlEncodeFormatString="False" />
                                <asp:BoundField DataField="SHIPPINGPOINT" HeaderText="SHIPPING POINT" HtmlEncode="False"
                                    HtmlEncodeFormatString="False" />
                                <asp:BoundField DataField="MarketName" HeaderText="Market Name" HtmlEncode="False"
                                    HtmlEncodeFormatString="False" />
                                <asp:BoundField DataField="TERMOFPAYMENT" HeaderText="TERM OF PAYMENT" HtmlEncode="False"
                                    HtmlEncodeFormatString="False" />
                            </Columns>
                        </asp:GridView>
                    </div>
            ...
            <tr>
                ...
                <td width="20%" class="TDRight">
                    ...
                    <asp:Button ID="cancelUploadListButton" runat="server" OnClick="cancelUploadListButton_Click"
                        Text="Cancel Upload" OnClientClick="return confirm('Are you sure you want to Re-Upload ?');" />
