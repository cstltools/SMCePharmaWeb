<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MainMasterPage.master" AutoEventWireup="true" CodeFile="DCUserPermission.aspx.cs" Inherits="SInventory_UI_DCUserPermission" %>
                ...
                <table width="100%" class="TableWorkArea">
                    ...
                    <tr>
                        ...
                        <td class="TDRight" width="26%">
                            <asp:CheckBoxList ID="dcCheckBoxList" CssClass="checkboxlist_nowrap" RepeatDirection="Vertical" runat="server"></asp:CheckBoxList>
                        <td class="TDLeft" width="10%">
                            &nbsp;</td>
                        <td class="TDRight" width="17%"></td>
                    </tr>
