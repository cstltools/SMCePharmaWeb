<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/NewMasterPage.master" AutoEventWireup="true" CodeFile="StockUOMEntry.aspx.cs" Inherits="SInventory_UI_StockUOMEntry" %>
    ...
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3"> <i class="bx bx-customize"></i> Stock UOM Entry</div>
                    ...
                    <div class="card border-top border-0 border-4 border-success">
                        <div class="card-body">
                            <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                <ContentTemplate>
                                     <asp:HiddenField ID="stockUOMIdHiddenField" runat="server" />
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-10">
                                                    ...
                                                    <div class="form-group row">
                                                        <label for="mainName" class="col-sm-3 col-form-label">UOM Name:  </label>

                                                        <div class="col-sm-5">
                                                            <div class="input-group">
                                                             
                                                                 <asp:TextBox ID="stockUOMNameTextBox" runat="server" CssClass="form-control form-control-sm mb-3"></asp:TextBox>
