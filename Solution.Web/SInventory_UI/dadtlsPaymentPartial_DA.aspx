<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/NewMasterPage.master" AutoEventWireup="true" CodeFile="dadtlsPaymentPartial_DA.aspx.cs" Inherits="dadtlsSInventory_UI_PaymentPartial_DA" %>
     ...
     <ProgressTemplate>
        ...
        <div class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3"><i class="bx bx-customize"></i>  Return Partial </div>
 ...
 <asp:LinkButton ID="viewLinkButton"    class="btn btn-sm btn-sm btn-outline-info" 
                ...
                <div class="col">
                    ...
                    <div class="card-body">
                        <br/>  
                          ...
                          <div class="form-group row">
                                    <label for="mainName" class="col-sm-2 col-form-label">    dadtlsInvoice Date:</label>
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Code">
                                        <ItemTemplate>
                                            ...
                                            <asp:HiddenField ID="hfDelTotalQty" runat="server" Value=<%# Eval("DelTotalQty")%> />    
                                            <asp:HiddenField ID="hfCampaignType" runat="server" Value=<%# Eval("CampaignType")%> />  
                                              <asp:HiddenField ID="hfCampaignName" runat="server" Value=<%# Eval("CampaignName")%> />    
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="DQty">
                                        <ItemTemplate>
                                            <asp:TextBox ID="dQtyTextBox" runat="server"    CssClass="form-control form-control-sm "   AutoPostBack="True"
                                                ontextchanged="dQtyTextBox_TextChanged" Text= <%# Eval("DelTotalQty")%> ></asp:TextBox>
    ...
    <div class="col text-center">
        <asp:LinkButton 
            ...
            runat="server" 
            Text="Calculate" 
            CssClass="btn btn-sm btn-warning btn-animate-underline" 
            OnClick="lnkCalculate_Click" />
    </div>
</div>

                        <style>
                         .btn-animate-underline {
    position: relative;
    display: inline-block;
    color: black; /* Text color, adjust if needed */
}

.btn-animate-underline::after {
    content: "";
    position: absolute;
    left: 0;
    bottom: 0;
...
<div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <asp:LinkButton ID="submitButton" CssClass="btn btn-success btn-sm" runat="server" OnClick="saveButton_Click"
                                               OnClientClick="return submitButton_ClientClick(this);"> <i class="fa fa-check"></i>&nbsp; Approve</asp:LinkButton>
                                        &nbsp;
                                        <asp:LinkButton ID="btnPartialRejectTop" CssClass="btn btn-danger btn-sm" runat="server" OnClick="btnPartialReject_Click"
                                               OnClientClick="return btnPartialReject_ClientClick(this);"> <i class="fa fa-times"></i>&nbsp; Reject</asp:LinkButton>
                                    </div>
                                </div>
                        ...
                        <script type="text/javascript">
                            // Prevent double-click / repeated submits on either button: once the user
                            // confirms and one of them is actually posting back, disable BOTH until the
                            // async postback ends (they act on the same invoice, so either one in flight
                            // must block the other).
                            function disableSubmitButtons() {
                                var btnSave = document.getElementById('<%= submitButton.ClientID %>');
                                var btnReject = document.getElementById('<%= btnPartialRejectTop.ClientID %>');
                                [btnSave, btnReject].forEach(function (btn) {
                                    if (btn) {
                            ...
                            function btnPartialReject_ClientClick(btnReject) {
                                if (btnReject.dataset.submitting === "true") {
                                    return false;
                                }
                                var result = confirm('Are you sure you want to reject this invoice?');
                                if (result === true) {
                                    disableSubmitButtons();
                                }
                                return result;
                ...
                <table width="100%" class="TableWorkArea">
                    <tr>
                     ...
                     <tr>
                        <td class="TDLeft" width="13%">
                            <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="DelivaryInvoiceCreationAfterSalesConfirm_DA.aspx">Back to List</asp:HyperLink>                          
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="TDLeft" width="13%">
                            <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                                <ContentTemplate>
                                    <asp:Button ID="Button1" runat="server" Text="Approve (Partial)" CssClass="btn btn-success" OnClick="saveButton_Click" OnClientClick="return confirm('Are you sure you want to Approve this Return?');" />
                                    <asp:Button ID="btnPartialReject" runat="server" Text="Reject" CssClass="btn btn-danger" style="margin-left:10px;" OnClick="btnPartialReject_Click" OnClientClick="return confirm('Are you sure you want to Reject this Return?');" />
                                </ContentTemplate>
                            </asp:UpdatePanel>
                    ...
                    <tr>
                        <td class="TDLeft" width="13%">
                             ...
                             <asp:HiddenField ID="hfSalesReturnAppLogId" runat="server" />
