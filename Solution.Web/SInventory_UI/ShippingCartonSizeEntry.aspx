<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/NewMasterPage.master" AutoEventWireup="true" CodeFile="ShippingCartonSizeEntry.aspx.cs" Inherits="SInventory_UI_ShippingCartonSizeEntry" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
   ...
   <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3"> <i class="bx bx-customize"></i>  Shipping Carton Information</div>
                    ...
                    <div class="card border-top border-0 border-4 border-success">
                        <div class="card-body">
                            <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                <ContentTemplate>
                                    <asp:HiddenField runat="server"  ID="shippingcartoonIdHiddenField"/>
 ...
 <div class="form-group row">
                                                        <label for="mainName" class="col-sm-3 col-form-label">Shipping Carton Qty:  </label>

                                                        <div class="col-sm-5">
                                                            <div class="input-group">
                                                             
  <asp:TextBox ID="caseQtyTextBox" runat="server" CssClass="form-control form-control-sm mb-3"></asp:TextBox>
                              <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtenderconvRate" runat="server"
                                                    Enabled="True" TargetControlID="caseQtyTextBox" FilterType="Custom" ValidChars="0123456789">
                                                    ...
                                                    <div class="form-group row">
                                                        <label for="mainName" class="col-sm-3 col-form-label">Pcs Per Carton:  </label>

                                                        <div class="col-sm-5">
                                                            <div class="input-group">
                                                             
   <asp:TextBox ID="pcsPerCaseTextBox" runat="server" CssClass="form-control form-control-sm mb-3"></asp:TextBox>
                             <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender1" runat="server"
                                                    Enabled="True" TargetControlID="pcsPerCaseTextBox" FilterType="Custom" ValidChars="0123456789">
                                                </cc1:FilteredTextBoxExtender>
