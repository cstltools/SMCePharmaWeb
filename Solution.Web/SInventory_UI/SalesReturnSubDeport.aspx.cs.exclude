...
public partial class SInventory_UI_SalesReturnSubDeport : System.Web.UI.Page
{
    ...
    protected void productCodeTextBox_TextChanged(object sender, EventArgs e)
    {
      ...
      //  if (ProformaCheckBox.Checked)
        {
            bool chk = aInvoiceReturnBll.cHasProformaOtherSubdeport(ddlInvoice.Text.Trim());
            if (chk)
            {
            }
            else
    ...
    private int SaveInvoiceNew()
    {
        ...
        aInvoice.DpMob = ddlInvoice.Text.Trim();
    ...
    protected void addButton_Click(object sender, EventArgs e)
    {
       ...
       // InitialGrid();
        ...
        //for (int i = 0; i < gridLineItemGridView.Rows.Count; i++)
        //{
        //    if (((TextBox)gridLineItemGridView.Rows[i].Cells[3].FindControl("codeTextBox")).Text.Trim() == "")
        //    {
        //        DeleteImageButton_Click(null,null);
        //    }
