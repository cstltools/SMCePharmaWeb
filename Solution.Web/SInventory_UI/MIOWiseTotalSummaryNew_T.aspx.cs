...
public partial class SInventory_UI_MIOWiseTotalSummaryNew_T : System.Web.UI.Page
{
    MIOTotalSummaryBLL aSummaryBll = new MIOTotalSummaryBLL();
    ...
    private void LoadInfo()
    {
        if (fromDateTextBox.Text != "" && toDateTextBox.Text != "")
        {
            DataTable aDataTable = new DataTable();
             ...
             aDataTable = aSummaryBll.LoadSummaryProductcodewiseGyash(salesCenterDropDownList.SelectedValue, Convert.ToDateTime(fromDateTextBox.Text.Trim()), Convert.ToDateTime(toDateTextBox.Text.Trim()));
   ...
   <h3>Business Summary Report	</h3>
    ...
    {
        Response.Redirect("MIOWiseTotalSummaryNew.aspx");
    }
}