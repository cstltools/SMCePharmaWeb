<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/NewMasterPage.master" AutoEventWireup="true" CodeFile="ShippingCartonSizeView.aspx.cs" Inherits="SInventory_UI_ShippingCartonSizeView" %>
    ...
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3"><i class="bx bx-customize"></i> Shipping Carton Information  List</div>
                            ...
                            <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                ...
                                <Columns>
                                  <%--  <asp:BoundField DataField="ProductCode" HeaderText="Product Code" />
                                    ...
                                    <asp:BoundField DataField="CaseQty" HeaderText="Shipping Carton Qty" />
                                    <asp:BoundField DataField="PcsPerCase" HeaderText="Pcs Per Carton" />
            ...
            <div>
                <table width="100%" class="TableWorkArea">
                    ...
                    <tr>
                        ...
                        <td width="13%" class="TDLeft" colspan="4">
