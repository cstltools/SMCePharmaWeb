<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DistrictEdit.aspx.cs" Inherits="SInventory_UI_DistrictEdit" %>
                ...
                <table width="100%" class="TableWorkArea">
                    ...
                    <tr>
                        <td class="TDLeft" width="13%">
                            &nbsp;
                            <asp:HiddenField ID="districtIdHiddenField" runat="server" />
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="TDLeft" width="13%">
                            Region Name</td>
                        <td class="TDRight" width="20%">
                            <asp:DropDownList ID="regionDropDownList" runat="server" AutoPostBack="True" 
                                CssClass="DropDown" 
                    ...
                    <tr>
                        ...
                        <td class="TDLeft" width="13%">
                            FE Name</td>
                        <td class="TDRight" width="20%">
                            <asp:TextBox ID="districtNameTextBox" runat="server" CssClass="TextBox"></asp:TextBox>
                        </td>
                        <td class="TDLeft" width="13%">
                            &nbsp;</td>
                        <td class="TDRight" width="20%">
                    ...
                    <tr>
                        ...
                        <td class="TDLeft" width="13%">
                            FE Code</td>
                        <td class="TDRight" width="20%">
                            <asp:TextBox ID="districtCodeTextBox" runat="server" CssClass="TextBox"></asp:TextBox>
                        </td>
                        <td class="TDLeft" width="13%">
                            &nbsp;</td>
                        <td class="TDRight" width="20%">
