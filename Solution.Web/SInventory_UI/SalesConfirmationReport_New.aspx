<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/NewMasterPage.master" AutoEventWireup="true" CodeFile="SalesConfirmationReport_New.aspx.cs" Inherits="SInventory_UI_SalesConfirmationReport_New" %>
                  ...
                  <asp:TextBox ID="todateTextBox" runat="server"  class="form-control form-control-sm mb-3 datepicker" autocomplete="off" placeholder="Select Invoice To Date"></asp:TextBox>
                       ...
                       <div class="row" >
                            ...
                            <div class="col-1">
                                        ...
                                        <div class="col-1">
                                              <asp:Label ID="lblTP" runat="server" CssClass="ssss btn bg-info pull-right" Text="Total TP : 0"></asp:Label>
                                            </div>  
                           
                           <div class="col-1">
                                              <asp:Label ID="lblVat" runat="server" CssClass="ssss btn bg-info pull-right" Text="Total VAT : 0"></asp:Label>
                                            </div>      <div class="col-2">
                                              <asp:Label ID="lblDiscount" runat="server" CssClass="ssss btn bg-info pull-right" Text="Total Discount : 0"></asp:Label>
                                            </div> 
             ...
             <div class="table-responsive" id="MainGradeDiv"  style="height:600px">
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="InvoiceDate" HeaderText="Invoice Date" />
                                              ...
                                              <asp:BoundField DataField="DelivaryInvoiceNo" HeaderText="Confirmation Number" />
                                    <asp:BoundField DataField="UpdateDate" HeaderText="Confirmation Date" />
