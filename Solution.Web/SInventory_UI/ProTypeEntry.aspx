<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/NewMasterPage.master" AutoEventWireup="true" CodeFile="ProTypeEntry.aspx.cs" Inherits="SInventory_UI_ProTypeEntry" %>
    ...
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3"> <i class="bx bx-customize"></i> Product Type Entry</div>
                        ...
                        <div class="card-body">
                            <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                <ContentTemplate>
                                    ...
                                    <asp:HiddenField ID="typeIdHiddenField" runat="server" />
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-10">
                                                    ...
                                                    <div class="form-group row">
                                                        <label for="mainName" class="col-sm-3 col-form-label">Type:  </label>

                                                        <div class="col-sm-5">
                                                            <div class="input-group">
                                                              <asp:TextBox ID="proTypeNameTextBox" runat="server" CssClass="form-control form-control-sm mb-3"></asp:TextBox>
