...
public partial class SInventory_UI_OrderMonitor : System.Web.UI.Page
{
    ...
    protected void btnExport_Click(object sender, EventArgs e)
    {
        if (loadGridView.Rows.Count > 0)
        {
            ...
            Response.AddHeader("content-disposition", "attachment;filename=Order_Monitoring_Report_" + DateTime.Now.ToString("dd_MMM_yyyy_hh_mm_tt") + ".csv");
            Response.Charset = "";
    ...
    {
        Response.Redirect("OrderMonitor.aspx");
    }
}