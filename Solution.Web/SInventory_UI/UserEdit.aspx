<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UserEdit.aspx.cs" Inherits="SInventory_UI_UserEdit" %>
                ...
                <table width="100%" class="TableWorkArea">
                    ...
                    <tr runat="server" Visible="False">
                        ...
                        <td class="TDLeft" width="13%">
                            User Type</td>
                        <td class="TDRight" width="20%">
                            <asp:TextBox ID="userTypeTextBox" runat="server" CssClass="TextBox"></asp:TextBox>
                        </td>
                        <td class="TDLeft" width="13%">
                            &nbsp;
                        </td>
                    ...
                    <tr>
                        ...
                        <td width="13%" class="TDLeft">
                            Login Name </td>
                        <td width="20%" class="TDRight">
                            <asp:TextBox ID="loginNameTextBox" runat="server" CssClass="TextBox"></asp:TextBox>
                        </td>
                        <td width="13%" class="TDLeft">
                            &nbsp;
                        </td>
                    ...
                    <tr runat="server" Visible="False">
                        ...
                        <td class="TDLeft" width="13%">
                            User Status </td>
                        <td class="TDRight" width="20%">
                            <asp:TextBox ID="userStatusTextBox" runat="server" CssClass="TextBox"></asp:TextBox>
                        </td>
                        <td class="TDLeft" width="13%">
                            &nbsp;</td>
                        <td class="TDRight" width="20%">
                    ...
                    <tr>
                        ...
                        <td class="TDLeft" width="13%">
                            &nbsp;</td>
                        <td class="TDRight" width="20%">
                            <asp:Button ID="closeButton2" runat="server" onclick="closeButton_Click" 
                                Text="Close" />
