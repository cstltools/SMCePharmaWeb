<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/NewMasterPage.master" AutoEventWireup="true" CodeFile="SalesRejecionReport.aspx.cs" Inherits="SInventory_UI_SalesRejecionReport" %>
                         ...
                         <div class="col-4">
                              <div class="form-group row">
                                                ...
                                                <div class="col-sm-7">
                                                     ...
                                                     <asp:CheckBox ID="CheckBox1"  Text="National Report"  CssClass="SelectchkChoice"    runat="server" AutoPostBack="True"
                                        ...
                                        <div class="col-8">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                      ...
                                                      <asp:LinkButton  OnClick="SearchButton_Click" Visible="false"  runat="server" id="SearchButton" class="btn btnMyDesignSearch   btn-sm"   >
                                            <i class="fa fa-print" aria-hidden="true"></i>&nbsp; View Report
                                        </asp:LinkButton>


                                                     <asp:LinkButton  OnClick="excelButton_OnClick"   runat="server" id="excelButton" class="btn btnMyDesignSearch   btn-sm"   >
