...
public partial class SInventory_UI_BranchTotalSummary : System.Web.UI.Page
{
    ...
    protected void viewRptButton_Click(object sender, EventArgs e)
    {
        if (fromDateTextBox.Text != "" && toDateTextBox.Text != "")
        {
            ...
            aDataTable = aSummaryBll.BranchwiseLoadSummaryBLL(Convert.ToDateTime(fromDateTextBox.Text.Trim()), Convert.ToDateTime(toDateTextBox.Text.Trim()), salesCenterDropDownList.SelectedValue);
    ...
    protected void excelButton1_Click2(object sender, EventArgs e)
    {
        if (fromDateTextBox.Text != "" && toDateTextBox.Text != "")
        {
            ...
            string url = "../SInventory_RPTVIEW/BusinessSummaryViewer3.aspx?fromDate=" + fromDate + "&toDate=" + toDate + "&Branch=" + salesCenterDropDownList.SelectedValue;
    ...
    protected void excelButton_Click3(object sender, EventArgs e)
    {
        if (fromDateTextBox.Text != "" && toDateTextBox.Text != "")
        {
            string fromDate = fromDateTextBox.Text;
            ...
            string url = "../SInventory_RPTVIEW/BusinessSummaryViewer4.aspx?fromDate=" + fromDate + "&toDate=" + toDate + "&Branch=" + salesCenterDropDownList.SelectedValue;
            // string fullURL = "window.open('" + url + "', '_blank', 'height=600,width=900,status=yes,toolbar=no,menubar=no,location=no,scrollbars=yes,resizable=no,titlebar=no' );";
            string fullURL = "var Mleft = (screen.width/2)-(950/2);var Mtop = (screen.height/2)-(700/2);window.open( '" + url + "', null, 'height=700,width=950,status=yes,toolbar=no,addressbar=no, scrollbars=yes,menubar=no,location=no,top=\'+Mtop+\', left=\'+Mleft+\'' );";
            ScriptManager.RegisterStartupScript(this, typeof(string), "OPEN_WINDOW", fullURL, true);
        }
    ...
    protected void excelButton_Click4(object sender, EventArgs e)
    {
        if (fromDateTextBox.Text != "" && toDateTextBox.Text != "")
        {
            string fromDate = fromDateTextBox.Text;
            ...
            string url = "../SInventory_RPTVIEW/BusinessSummaryViewer5.aspx?fromDate=" + fromDate + "&toDate=" + toDate + "&Branch=" + salesCenterDropDownList.SelectedValue;
            // string fullURL = "window.open('" + url + "', '_blank', 'height=600,width=900,status=yes,toolbar=no,menubar=no,location=no,scrollbars=yes,resizable=no,titlebar=no' );";
            string fullURL = "var Mleft = (screen.width/2)-(950/2);var Mtop = (screen.height/2)-(700/2);window.open( '" + url + "', null, 'height=700,width=950,status=yes,toolbar=no,addressbar=no, scrollbars=yes,menubar=no,location=no,top=\'+Mtop+\', left=\'+Mleft+\'' );";
            ScriptManager.RegisterStartupScript(this, typeof(string), "OPEN_WINDOW", fullURL, true);
        }
    ...
    protected void excelButton1_Click(object sender, EventArgs e)
    {
        ...
        string url = "../SInventory_RPTVIEW/BusinessSummaryViewer2.aspx?fromDate=" + fromDate + "&toDate=" + toDate + "&Branch=" + salesCenterDropDownList.SelectedValue;
        // string fullURL = "window.open('" + url + "', '_blank', 'height=600,width=900,status=yes,toolbar=no,menubar=no,location=no,scrollbars=yes,resizable=no,titlebar=no' );";
        string fullURL = "var Mleft = (screen.width/2)-(950/2);var Mtop = (screen.height/2)-(700/2);window.open( '" + url + "', null, 'height=700,width=950,status=yes,toolbar=no,addressbar=no, scrollbars=yes,menubar=no,location=no,top=\'+Mtop+\', left=\'+Mleft+\'' );";
        ScriptManager.RegisterStartupScript(this, typeof(string), "OPEN_WINDOW", fullURL, true);
        }
