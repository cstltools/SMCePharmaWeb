<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/NewMasterPage.master" AutoEventWireup="true" CodeFile="ReplaceNoteReport.aspx.cs" Inherits="SInventory_UI_ReplaceNoteReport" %>
    ...
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3"><i class="bx bx-customize"></i> Replacement Note Report</div>
            ...
            <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                    ...
                    <div class="row">
                         ...
                         <div class="col-4">
                                ...
                                >
                                              ...
                                              <div class="form-group row" runat="server">
                                                <label   class="col-sm-5 col-form-label"> To Date:  <span style="color:red">*</span></label>
             ...
             <div class="table-responsive" id="MainGradeDiv"  style="height:600px">
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="ReturnInvoiceDate" HeaderText="Issue Date" />
                                    ...
                                    <asp:BoundField DataField="ReplacementReason" HeaderText="Replacement Reason" />
