<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/NewMasterPage.master" EnableEventValidation="false"
    AutoEventWireup="true" CodeFile="MIOWiseBusinessSummary.aspx.cs" Inherits="SInventory_UI_MIOWiseBusinessSummary" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <label for="mainName" class="col-sm-5 col-form-label">Depot Name:  </label>
                                    ...
                                    <div class="table-responsive" id="MainGradeDiv" style="height: 600px">
                                        ...
                                        <ItemTemplate>
                                            <asp:Label ID="LabelSL" Text='<%# Container.DataItemIndex + 1 %>' runat="server"></asp:Label>
                                                ...
                                                <asp:BoundField DataField="TerritoryName" HeaderText="Territory" Visible="false" />
                                    ...
                                    <ItemStyle HorizontalAlign="Right" Width="60px" />
                                            ...
                                            <%--    <asp:BoundField DataField="Outstanding1" HeaderText="Amount (TP)" />
                                                <asp:BoundField DataField="Outstanding2" HeaderText="VAT" />--%>
                                                  <asp:BoundField DataField="SumofRCVTP" HeaderText="Amount (TP)" />
  <asp:BoundField DataField="SumofRCVVat" HeaderText="VAT" />
                                                <asp:BoundField DataField="SumofRCVAmount" HeaderText="Gross Outstanding Amt." />
