 <%@ Page Language="C#" AutoEventWireup="true" CodeFile="CustomerLedgerReportApps.aspx.cs" Inherits="SInventory_UI_CustomerLedgerReportApps" %>
            ...
            <div class="row">
                <div class="col">
                    ...
                    <div class="card border-top border-0 border-4 border-success">
                      ...
                      <label for="mainName" class="col-sm-4 col-form-label">Customer Code:  <span style="color:red">*</span></label>
 ...
 <asp:HiddenField ID="hfCustomerId" runat="server" />
           ...
           <div class="col-8">
               ...
               <div class="form-group row">
                   ...
                   <asp:Label ID="lblCount" runat="server" style ="font-weight:bold" CssClass="ssss btn bg-info" Text="Total : 0"></asp:Label>
           ...
           <div class="col-2">
                                    ...
                                    <div class="table-responsive" id="MainGradeDiv" style="max-height: 600px;overflow-y: auto;margin-top:10px; " >
...
<asp:BoundField DataField="ComUnitCode" HeaderText="Sales Center" />
        ...
        <asp:BoundField DataField="TpGrandTotal" HeaderText="Net Proforma" />
        <asp:BoundField DataField="DelivaryInvoiceNo" HeaderText="Invoice Number" />
        <asp:BoundField DataField="UpdateDate" HeaderText="Invoice Date" />
        <asp:BoundField DataField="DeliveryTpGrandTotal" HeaderText="Net Sales" />
        ...
        <asp:BoundField DataField="OrderDate" HeaderText="C.Type" />
        <asp:BoundField DataField="DistrictCode" HeaderText="Campaign" />
