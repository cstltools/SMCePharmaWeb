<%@ Page Language="C#" AutoEventWireup="true" CodeFile="StockUOMEdit.aspx.cs" Inherits="SInventory_UI_StockUOMEdit" %>
                ...
                <table width="100%" class="TableWorkArea">
                    ...
                    <tr>
                        ...
                        <td class="TDLeft" width="13%">
                            UOM</td>
                        <td class="TDRight" width="20%">
                            <asp:TextBox ID="stockUOMNameTextBox" runat="server" CssClass="TextBox"></asp:TextBox>
                        </td>
                        <td class="TDLeft" width="13%">
                        </td>
                        <td class="TDRight" width="20%">
