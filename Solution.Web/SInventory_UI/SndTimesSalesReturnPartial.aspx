<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/NewMasterPage.master" AutoEventWireup="true" CodeFile="SndTimesSalesReturnPartial.aspx.cs" Inherits="SInventory_UI_SndTimesSalesReturnPartial" %>
                ...
                <asp:GridView ID="gridLineItemGridView" runat="server" 
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="DQty">
                                        <ItemTemplate>
                                            <asp:TextBox ID="dQtyTextBox" runat="server" AutoPostBack="true" OnTextChanged="dQtyTextBox_TextChanged"   CssClass="form-control form-control-sm "   Text= <%# Eval("DelTotalQty")%> ></asp:TextBox>
...
<div class="row">
 ...
 <asp:LinkButton ID="submitButton" CssClass="btn btnMyDesignSearch   btn-sm" runat="server" OnClick="saveButton_Click"
                               OnClientClick="return submitButton_ClientClick(this);"> <i class="fa fa-check"></i>&nbsp; Generate Invoice</asp:LinkButton>
