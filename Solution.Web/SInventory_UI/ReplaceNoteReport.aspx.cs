...
public partial class SInventory_UI_ReplaceNoteReport : System.Web.UI.Page
{
    ...
    private void LoadData()
    {
        ...
        comUnitDetailDataTable = _DAL.GetReplaceNoteReportListDAL(Parm());
        ...
        if (comUnitDetailDataTable.Rows.Count > 0)
        {
            ...
            decimal total2 = comUnitDetailDataTable.AsEnumerable().Sum(row => row.Field<decimal?>("Amount") == null ? 0 : row.Field<decimal>("Amount"));
    ...
    private string Parm()
    {
        ...
        {
            param = param + " AND CONVERT(date,I.ReturnInvoiceDate)  BETWEEN '" + InvoiceDateTextBox.Text + "' AND '" + todateTextBox.Text + "' ";
        }
        if (InvoiceDateTextBox.Text != "" && todateTextBox.Text == "")
        {
            param = param + " AND CONVERT(date,I.ReturnInvoiceDate)  BETWEEN '" + InvoiceDateTextBox.Text + "' AND '" + DateTime.Now + "' ";
        }
    ...
    protected void btnExport_Click(object sender, EventArgs e)
    {
        ...
        if (loadGridView.Rows.Count > 0)
        {
            ...
            Response.AddHeader("content-disposition", "attachment;filename=Replacement Note Report_List_" + DateTime.Now.ToString("dd_MMM_yyyy_hh_mm_tt") + ".csv");
            Response.Charset = "";
