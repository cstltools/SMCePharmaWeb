<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/NewMasterPage.master" AutoEventWireup="true" CodeFile="GpSalesReport.aspx.cs" Inherits="SInventory_UI_GpSalesReport" %>
    ...
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3"><i class="bx bx-customize"></i>GP Sales Report</div>
                                ...
                                <ContentTemplate>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-4">
                                            ...
                                            <div class="form-group row d-none" runat="server">
                                    ...
                                    <div class="table-responsive" id="MainGradeDiv" style="height: 600px">
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="RegionName_Ord" HeaderText="Zone" />
                                                <asp:BoundField DataField="AreaName_Ord" HeaderText="Area" />
                                                   <asp:BoundField DataField="TerritoryCode_Ord" HeaderText="Territory Code" />
   <asp:BoundField DataField="TerritoryName_Ord" HeaderText="Territory Name" />
                                                <asp:BoundField DataField="OrderSenderCode" HeaderText="MIO Code" />
                ...
                HtmlEncode="false" />
                                                ...
                                                <asp:BoundField DataField="GPSales" HeaderText="GP Sales" />
    ...
    <script>
        ...
        function exportToExcel() {
            ...
            var a = $("<a />", {
                href: url,
                download: "Territory Wise Sales Report.xls"
