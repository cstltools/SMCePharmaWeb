<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MainMasterPage.master" AutoEventWireup="true" CodeFile="CompanyInfoView.aspx.cs" Inherits="SInventory_UI_CompanyInfoView" %>
                    ...
                    <tr>
                        ...
                        <td width="20%" class="TDRight" colspan="4">
                            <asp:GridView ID="loadGridView" runat="server" AutoGenerateColumns="False" 
                                CssClass="gridview" DataKeyNames="CompanyId" 
