...
public partial class SInventory_UI_PendingSalesConfirmationReport : System.Web.UI.Page
{
    ...
    private string Parm()
    {
        string param = "";
            ...
            {
                param = param + " AND tblOrder.ComUnitId='" + dcDropDownList1.SelectedValue + "' ";
            }
        ...
        {
            param = param + " AND CONVERT(date,tblInvoice.InvoiceDate)  BETWEEN '" + InvoiceDateTextBox.Text + "' AND '" + todateTextBox.Text + "' ";
        }
        if (InvoiceDateTextBox.Text != "" && todateTextBox.Text == "")
        {
            param = param + " AND CONVERT(date,tblInvoice.InvoiceDate)  BETWEEN '" + InvoiceDateTextBox.Text + "' AND '" + DateTime.Now + "' ";
        }
    ...
    private void LoadData()
    {
        DataTable aDataTable = new DataTable();
            ...
            aDataTable = aInvoiceDal.GetPendingSalesConfirmationReportDAl(Parm(), null, null);
        ...
        //{
        //    decimal NetAmount = aDataTable.AsEnumerable().Sum(row => row.Field<decimal?>("TpGrandTotal") == null ? 0 : row.Field<decimal>("TpGrandTotal"));
        ...
        //    loadGridView.FooterRow.Cells[11].Text = "Total: ";
        //    loadGridView.FooterRow.Cells[12].Text = NetAmount.ToString();
