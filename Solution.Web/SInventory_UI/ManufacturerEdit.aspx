<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ManufacturerEdit.aspx.cs" Inherits=" SInventory_UI_ManufacurerEdit" %>
                ...
                <table width="100%" class="TableWorkArea">
                    <tr>
                        <td colspan="6" class="TableHeading">
                            Manufacturer Information Edit</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="TDRight" width="20%">
                            <asp:TextBox ID="manufacturerNameTextBox" runat="server" CssClass="TextBox"></asp:TextBox>
                        </td>
                        <td class="TDLeft" width="13%">
                            &nbsp;
                        </td>
                    ...
                    <tr>
                        ...
                        <td width="20%" class="TDRight">
                            <asp:TextBox ID="manufacturerAddressTextBox" runat="server" CssClass="TextBox" 
