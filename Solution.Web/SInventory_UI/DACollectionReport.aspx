<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/NewMasterPage.master" AutoEventWireup="true" CodeFile="DACollectionReport.aspx.cs" Inherits="SInventory_UI_DACollectionReport" %>
    ...
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3"><i class="bx bx-customize"></i>DA Collection Report</div>
                    ...
                    <div class="row">
                         ...
                         <div class="col-4">
                                ...
                                >
                                              ...
                                              <div class="form-group row"  runat="server">
                                                <label for="mainName" class="col-sm-5 col-form-label">Collection By :  <span style="color:red">*</span></label>
