<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/NewMasterPage.master" AutoEventWireup="true" CodeFile="DHB_DeliveryPaymentReport.aspx.cs" Inherits="SInventory_UI_DHB_DeliveryPaymentReport" %>
    ...
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3"><i class="bx bx-customize"></i> Today's Collection Report</div>
                ...
                <ContentTemplate>--%>
                  ...
                  <asp:TextBox ID="todateTextBox" runat="server"  class="form-control form-control-sm mb-3 datepicker" autocomplete="off" placeholder="Select Invoice To Date"></asp:TextBox>
                       ...
                       <div class="row">
                            ...
                            <div class="col-4"> <%--<span style="text-align:left; color:silver" class="  pull-right">Note: Market structure filtering will be  workable from 1st april's data.</span>--%></div>
                                        <div class="col-3">
