<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MiaTargetEdit.aspx.cs" Inherits="SInventory_UI_MiaTargetEdit" %>
                ...
                <table width="100%" class="TableWorkArea">
                    ...
                    <tr>
                        <td class="TDLeft" width="13%">
                            &nbsp;
                            <asp:HiddenField ID="miaTargetInfoIdHiddenField" runat="server" />
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="TDLeft" width="13%">
                            Mia Code</td>
                        <td class="TDRight" width="20%">
                            <asp:TextBox ID="miaCodeTextBox" runat="server" CssClass="TextBox"></asp:TextBox>
                        </td>
                        <td class="TDLeft" width="13%">
                        </td>
                        <td class="TDRight" width="20%">
                    ...
                    <tr>
                        ...
                        <td class="TDLeft" width="13%">
                            Mia Name</td>
                        <td class="TDRight" width="20%">
                            <asp:TextBox ID="miaNameTextBox" runat="server" CssClass="TextBox"></asp:TextBox>
                        </td>
                        <td class="TDLeft" width="13%">
                            &nbsp;
                        </td>
