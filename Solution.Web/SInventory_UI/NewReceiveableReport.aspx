<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/NewMasterPage.master" AutoEventWireup="true" CodeFile="NewReceiveableReport.aspx.cs" Inherits="SInventory_UI_NewReceiveableReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="page-wrapper">
        ...
        <asp:BoundField DataField="ComUnitCode" HeaderText="Distribution Center Code" />
                                                ...
                                                <asp:BoundField DataField="CellNo" HeaderText="Customer Mobile No." /> <asp:BoundField DataField="SpecialAmount" HeaderText="Provider Type" />
                                              ...
                                              <%--       <asp:BoundField DataField="paymenttype" HeaderText="Payment Type" />--%>
                                                ...
                                                <asp:BoundField DataField="Territory" HeaderText="Territory " />
                                                  <asp:BoundField DataField="AMCode" HeaderText="Area Code" />
                                                <asp:BoundField DataField="DZSMCode" HeaderText="Zone Code" />
                                                ...
                                                <asp:BoundField DataField="MainMIONAME" HeaderText="MIO Emp Name" />
                                                 ...
                                                 <asp:BoundField DataField="paymenttype" HeaderText="Payment Type" />
                                                <asp:BoundField DataField="OrderCreatedByEmpCodeName" HeaderText="Order created by" />
                                                <asp:BoundField DataField="OrderCreatedDateTime" HeaderText="Order created date &amp; time" />
                                                <asp:BoundField DataField="RespectiveAMEmpCode" HeaderText="AM Emp Code" />
                                                <asp:BoundField DataField="RespectiveDSMEmpCode" HeaderText="DSM Emp Code" />
