...
public partial class SInventory_UI_CustomerPaymentSnd : System.Web.UI.Page
{
    ...
    protected void salesCenterDropDownList_SelectedIndexChanged(object sender, EventArgs e)
    {
        try
        {
            ...
            try
            {
                using (DataTable dt = _seedRepo.GetRouteInfoforCustPaymentSnd(Convert.ToInt32(salesCenterDropDownList.SelectedValue)))
                {
    ...
    private void LoadGridView()
    {
        ...
        lblCount.Text = "Total Pay Amount: 0";
        DataTable aTable = aDal.SndTimeReturnLoadPaymentInvSP(GenerateParam());
