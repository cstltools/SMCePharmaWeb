<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/NewMasterPage.master"
    AutoEventWireup="true" CodeFile="DAClaim_DICApprovalListByRoute.aspx.cs" Inherits="SInventory_UI_DAClaim_DICApprovalListByRoute" %>
    ...
    <div class="page-wrapper">
        <div class="page-content">
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3"><i class="bx bx-customize"></i> Sales Assistant Tourplan List</div>
            </div>
                                        ...
                                        <div class="table-responsive" id="MainGradeDiv">
                                            <asp:GridView ID="daClaimGridView" runat="server" AutoGenerateColumns="False"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="DICApprovalDate" HeaderText="DIC Approval Date" />
                                                </Columns>
                                            </asp:GridView>
                                        </div>
                                    </div>
