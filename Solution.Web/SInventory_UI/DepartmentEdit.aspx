<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DepartmentEdit.aspx.cs" Inherits="HRM_UI_DepartmentEdit" %>
                ...
                <table width="100%" class="TableWorkArea">
                    ...
                    <tr>
                        ...
                        <td class="TDLeft" width="13%">
                            Department Name</td>
                        <td class="TDRight" width="20%">
                            <asp:TextBox ID="departmentNameTextBox" runat="server" CssClass="TextBox"></asp:TextBox>
                        </td>
                        <td class="TDLeft" width="13%">
                        </td>
                        <td class="TDRight" width="20%">
