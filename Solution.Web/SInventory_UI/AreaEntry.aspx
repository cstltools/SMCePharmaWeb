<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MainMasterPage.master" AutoEventWireup="true" CodeFile="AreaEntry.aspx.cs" Inherits="SInventory_UI_AreaEntry" %>
                ...
                <table width="100%" class="TableWorkArea">
                    ...
                    <tr>
                        ...
                        <td width="20%" class="TDRight">
                            <asp:ImageButton ID="areaListImageButton" runat="server" 
                    ...
                    <div id="otherinfo" runat="server" Visible="False">
                    <tr>
                        <td class="TDLeft" width="13%">
                            &nbsp;</td>
                        <td class="TDRight" width="20%">
                    ...
                    <tr>
                        ...
                        <td width="13%" class="TDLeft">
                            District Name</td>
                        <td width="20%" class="TDRight">
                            <asp:DropDownList ID="districtDropDownList" runat="server" CssClass="DropDown">
                            </asp:DropDownList>
                        </td>
                        <td width="13%" class="TDLeft">
                        </td>
