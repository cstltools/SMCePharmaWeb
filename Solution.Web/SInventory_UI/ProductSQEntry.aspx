<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/NewMasterPage.master" AutoEventWireup="true" CodeFile="ProductSQEntry.aspx.cs" Inherits="SInventory_UI_ProductSQEntry" %>
    ...
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3"> <i class="bx bx-customize"></i>  Product Brand Information </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-10">
                                                    ...
                                                    <div class="form-group row">
                                                        <label for="mainName" class="col-sm-3 col-form-label"> Product Brand Name:  </label>

                                                        <div class="col-sm-5">
                                                            <div class="input-group">
                                                                
<asp:TextBox ID="productSQTextBox" runat="server" CssClass="form-control form-control-sm mb-3"></asp:TextBox>
                                                          ...
                                                          <asp:HiddenField ID="productSQIdHiddenField" runat="server" />
                                                            <br />
                ...
                <table width="100%" class="TableWorkArea">
                    ...
                    <tr runat="server" Visible="False">
                        ...
                        <td class="TDLeft" width="13%">
                            Ingridents</td>
                        <td class="TDRight" width="20%">
                            <asp:DropDownList ID="ingridentDropDownList" runat="server" CssClass="DropDown">
                            </asp:DropDownList>
                        </td>
                        <td class="TDLeft" width="13%">
                            &nbsp;</td>
