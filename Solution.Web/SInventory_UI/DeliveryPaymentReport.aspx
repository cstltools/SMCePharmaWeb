<%@ Page Title="Full Payment  Report" Language="C#" MasterPageFile="~/MasterPages/NewMasterPage.master" AutoEventWireup="true" CodeFile="DeliveryPaymentReport.aspx.cs" Inherits="SInventory_UI_DeliveryPaymentReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3"><i class="bx bx-customize"></i> Full Payment  Report</div>
    ...
    <label for="mainName" class="col-sm-5 col-form-label">Select Option: <span style="color:red">*</span></label>
    <div class="col-sm-7">
        <asp:RadioButtonList ID="rbDateType" runat="server" 
            RepeatDirection="Vertical" 
            AutoPostBack="true" 
            OnSelectedIndexChanged="rbDateType_SelectedIndexChanged">
            <asp:ListItem Text="Order Date Wise" Value="Order"></asp:ListItem>
            <asp:ListItem Selected="True" Text="Payment Date Wise" Value="Payment"></asp:ListItem>
        </asp:RadioButtonList>
    </div>
</div>

<div class="form-group row" runat="server">
    <label id="lblFromDate" runat="server" class="col-sm-5 col-form-label">From Date: <span style="color:red">*</span></label>
    <div class="col-sm-7">
        <asp:TextBox ID="InvoiceDateTextBox" AutoPostBack="true" 
            OnTextChanged="fromDateTextBox_TextChanged" 
            runat="server" 
            class="form-control form-control-sm mb-3 datepicker" 
            autocomplete="off" placeholder="Select From Date">
        </asp:TextBox>
    </div>
</div>

<div class="form-group row" runat="server">
    <label id="lblToDate" runat="server" class="col-sm-5 col-form-label">To Date: <span style="color:red">*</span></label>
    <div class="col-sm-7">
        <asp:TextBox ID="todateTextBox" runat="server"  
            class="form-control form-control-sm mb-3 datepicker" 
            autocomplete="off" placeholder="Select To Date">
        </asp:TextBox>
    </div>
</div>
