...
public partial class SInventory_UI_CustomerMasterView : System.Web.UI.Page
{
    ...
    {
        aDataTable = aMasterInfoBll.LoadCustomerMasterM(GenerateParameter());
    ...
    private string GenerateParameter()
    {
        ...
        {
            parameter = parameter + "AreaCode = '" + areaNameDropDownList.SelectedItem.Text.Trim() + "' AND ";
        }
