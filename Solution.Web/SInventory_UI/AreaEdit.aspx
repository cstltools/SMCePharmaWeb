<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AreaEdit.aspx.cs" Inherits="SInventory_UI_AreaEdit" %>
                ...
                <table width="100%" class="TableWorkArea">
                    ...
                    <tr>
                        <td class="TDLeft" width="13%">
                            &nbsp;
                            <asp:HiddenField ID="areaInfoIdHiddenField" runat="server" />
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="TDLeft" width="13%">
                            Territory Name :</td>
                        <td class="TDRight" width="20%">
                            <asp:TextBox ID="areanameTextBox" runat="server" CssClass="TextBox"></asp:TextBox>
                        </td>
                        <td class="TDLeft" width="13%">
                            &nbsp;</td>
                        <td class="TDRight" width="20%">
