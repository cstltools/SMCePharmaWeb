...
public partial class SInventory_UI_Sales_Collection_Reports_Acc : System.Web.UI.Page
{
    ...
    protected void loadGridView_OnRowCreated(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.Header)
        {
            ...
            HeaderCell = new TableCell();
            HeaderCell.Text = "Delivery Confirmation";
    ...
    private void LoadInfo()
    {
        ...
        if (fromDateTextBox.Text != "" && toDateTextBox.Text != "")
        {
            ...
            aDataTable = aSummaryBll.Sales_Collection_Reports_AccDAL(Convert.ToDateTime(fromDateTextBox.Text.Trim()), Convert.ToDateTime(toDateTextBox.Text.Trim()), Type, ZonId, Area, Terr);
            if (aDataTable.Rows.Count > 0)
            {
                ...
                if (Type == "SC")
                {
                    ...
                    try
                    {
                        ...
                        gv_DistributionCenter.FooterRow.Cells[1].Text = Math.Round(SalesAmtTP).ToString("#,##0");



                        decimal SalesDiscount = aDataTable.AsEnumerable().Sum(row => row.Field<decimal?>("SalesDiscount") == null ? 0 : row.Field<decimal>("SalesDiscount"));
                        gv_DistributionCenter.FooterRow.Cells[2].Text = Math.Round(SalesDiscount).ToString("#,##0");


                        decimal SalesVat = aDataTable.AsEnumerable().Sum(row => row.Field<decimal?>("SalesVat") == null ? 0 : row.Field<decimal>("SalesVat"));
                        gv_DistributionCenter.FooterRow.Cells[3].Text = Math.Round(SalesVat).ToString("#,##0");
                        ...
                        gv_DistributionCenter.FooterRow.Cells[4].Text = Math.Round(SalesGrossAmt).ToString("#,##0");
                        ...
                        gv_DistributionCenter.FooterRow.Cells[5].Text = Math.Round(ReturnAmountTP).ToString("#,##0");


                        decimal ReturnAmountDiscount = aDataTable.AsEnumerable().Sum(row => row.Field<decimal?>("ReturnAmountDiscount") == null ? 0 : row.Field<decimal>("ReturnAmountDiscount"));
                        gv_DistributionCenter.FooterRow.Cells[6].Text = Math.Round(ReturnAmountDiscount).ToString("#,##0");


                        decimal ReturnAmountVat = aDataTable.AsEnumerable().Sum(row => row.Field<decimal?>("ReturnAmountVat") == null ? 0 : row.Field<decimal>("ReturnAmountVat"));
                        gv_DistributionCenter.FooterRow.Cells[7].Text = Math.Round(ReturnAmountVat).ToString("#,##0");
                        ...
                        gv_DistributionCenter.FooterRow.Cells[8].Text = Math.Round(ReturnGrossAmt).ToString("#,##0");
                        ...
                        gv_DistributionCenter.FooterRow.Cells[9].Text = Math.Round(JustSalesAmtTP).ToString("#,##0");




                        decimal JustSalesDiscount = aDataTable.AsEnumerable().Sum(row => row.Field<decimal?>("JustSalesDiscount") == null ? 0 : row.Field<decimal>("JustSalesDiscount"));
                        gv_DistributionCenter.FooterRow.Cells[10].Text = Math.Round(JustSalesDiscount).ToString("#,##0");
                        ...
                        gv_DistributionCenter.FooterRow.Cells[11].Text = Math.Round(JustSalesVat).ToString("#,##0");
                        ...
                        gv_DistributionCenter.FooterRow.Cells[12].Text = Math.Round(JustSalesGrossAmt).ToString("#,##0");





                        decimal SalesGrossAmt_ = aDataTable.AsEnumerable().Sum(row => row.Field<decimal?>("CurrentPeriodSales") == null ? 0 : row.Field<decimal>("CurrentPeriodSales"));
                        gv_DistributionCenter.FooterRow.Cells[13].Text = Math.Round(SalesGrossAmt_).ToString("#,##0");
                        ...
                        try
                        {
                            ...
                            gv_DistributionCenter.FooterRow.Cells[14].Text = Math.Round(PriorPeriodSales).ToString("#,##0");
                        }
                        catch (Exception ex)
                        {
                        ...
                        decimal CollectionGrossAmt = aDataTable.AsEnumerable().Sum(row => row.Field<decimal?>("TotalCollection") == null ? 0 : row.Field<decimal>("TotalCollection"));
                        gv_DistributionCenter.FooterRow.Cells[15].Text = Math.Round(CollectionGrossAmt).ToString("#,##0");
    ...
    protected void btnExportToExcel_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            if (rbReportTypeName.Items[0].Selected)
            {
                Type = "Sales and Collection Reports (Acc)_";
                ...
                string headerTable = @"<span  style='text-align:center'><h3> Smc Enterprise Limited</h3>  </span><span  style='text-align:center'><h4> Sales and Collection Reports (Acc)</h4> </span> <span  style='text-align:center'><h4> (Date Range : " + fromDateTextBox.Text + "- " + toDateTextBox.Text + ") </h4>  </span> <span   style='text-align:right'><h4> Print Date: " + DateTime.Now.ToString("MMMM dd, yyyy") + "</h4></span>";
