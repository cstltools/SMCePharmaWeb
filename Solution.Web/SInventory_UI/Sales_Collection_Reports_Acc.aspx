<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/NewMasterPage.master" EnableEventValidation="false"
    AutoEventWireup="true" CodeFile="Sales_Collection_Reports_Acc.aspx.cs" Inherits="SInventory_UI_Sales_Collection_Reports_Acc" %>
    ...
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3"><i class="bx bx-customize"></i> Sales and Collection Summary Report</div>
                                    ...
                                    <div class="table-responsive" id="MainGradeDiv" style="height: 600px">
                                        <asp:GridView ID="gv_DistributionCenter" runat="server" CssClass="table table-striped table-bordered" AutoGenerateColumns="False" OnPageIndexChanging="OnPageIndexChanging" OnRowCreated="loadGridView_OnRowCreated"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="ComUnitShortName" HeaderText="Distribution Center" />


 

                                               <%-- Sales Confirmation--%>
                                               <asp:BoundField DataField="SalesAmtTP" HeaderText="Sales on TP" />
  <asp:BoundField DataField="SalesDiscount" HeaderText="Discount" />
  <asp:BoundField DataField="SalesVat" HeaderText="VAT" />
  <asp:BoundField DataField="SalesGrossAmt" HeaderText="Gross Sales" />




                                                <asp:BoundField DataField="ReturnAmountTP" HeaderText="Sales on TP" />

                                           <asp:BoundField DataField="ReturnAmountDiscount" HeaderText="Discount" /> 
                                           <asp:BoundField DataField="ReturnAmountVat" HeaderText="VAT" /> 
                                                <asp:BoundField DataField="ReturnGrossAmt" HeaderText="Gross Sales" />


                                                <%--Sales--%>

                                            <asp:BoundField DataField="JustSalesAmtTP" HeaderText="Sales on TP" />
                                              <asp:BoundField DataField="JustSalesDiscount" HeaderText="Discount" /> 
                                              <asp:BoundField DataField="JustSalesVat" HeaderText="VAT" /> 
                                                <asp:BoundField DataField="JustSalesGrossAmt" HeaderText="Gross Amount" /> 


                                                <asp:BoundField DataField="CurrentPeriodSales" HeaderText="Current Period Sales" />
                                                <asp:BoundField DataField="PriorPeriodSales" HeaderText="Prior Period Sales" />
