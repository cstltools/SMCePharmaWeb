<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MainMasterPage.master" AutoEventWireup="true" CodeFile="ZoneSalesReport.aspx.cs" Inherits="SInventory_UI_ZoneSalesReport" %>
            ...
            <div>
                ...
                <td class="TDRight" width="20%">
                    ...
                    <tr>
                        ...
                        <td class="TDRight" width="20%">
                            <asp:DropDownList ID="dcDropDownList" runat="server" AutoPostBack="True" 
                                CssClass="DropDown" 
                    ...
                    <tr>
                        ...
                        <td width="13%" class="TDLeft">
                            Zone Name</td>
                        <td width="20%" class="TDRight">
                            <asp:DropDownList ID="zoneNameDropDownList" runat="server" CssClass="DropDown" 
                           AutoPostBack="True">
                            </asp:DropDownList>
                        </td>
                        <td width="13%" class="TDLeft">
