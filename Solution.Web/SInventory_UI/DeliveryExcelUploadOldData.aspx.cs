...
public partial class SInventory_UI_DeliveryExcelUploadOldData : System.Web.UI.Page
{
...

   {
    ...
    protected void submitButton_Click(object sender, EventArgs e)
    {
        ...
        for (int i = 0; i < productGridView.Rows.Count; i++)
        {
             status = aInvoiceBll.SaveFullInvoiceOldData((((TextBox)productGridView.Rows[i].Cells[0].FindControl("productCodeTextBox")).Text).Trim(),
    ...
    {
        Response.Redirect("DeliveryExcelUploadOldData.aspx");
    }
}