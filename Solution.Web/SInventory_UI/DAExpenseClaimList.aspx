<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/NewMasterPage.master"
    AutoEventWireup="true" CodeFile="DAExpenseClaimList.aspx.cs" Inherits="SInventory_UI_DAExpenseClaimList" %>
    ...
    <div class="page-wrapper">
        <div class="page-content">
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3"><i class="bx bx-customize"></i> DA Expense Claim List</div>
            </div>
                                    ...
                                    <div class="row">
                                        <div class="table-responsive" id="MainGradeDiv">
                                            <asp:GridView ID="expenseClaimGridView" runat="server" AutoGenerateColumns="False"
                                                ...
                                                OnRowDataBound="expenseClaimGridView_RowDataBound">
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Expense Details">
                                                        <ItemTemplate>
                                                            <asp:GridView ID="expenseDetailGridView" runat="server" AutoGenerateColumns="False"
                                                                CssClass="table table-sm table-bordered detail-grid">
                                                                <Columns>
                                                                    <asp:BoundField DataField="FieldName" HeaderText="Field Name" />
                                                                    <asp:BoundField DataField="ValueText" HeaderText="Value" />
                                                                    <asp:CheckBoxField DataField="IsRequied" HeaderText="Required" />
                                                                    <asp:BoundField DataField="ExpenseAmount" HeaderText="Fixed Amount" DataFormatString="{0:N2}" />
                                                                    <asp:CheckBoxField DataField="IsFixed" HeaderText="Fixed" />
                                                                </Columns>
                                                            </asp:GridView>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
