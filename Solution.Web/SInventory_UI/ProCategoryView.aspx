<%@ Page Title="Product Category  List" Language="C#" MasterPageFile="~/MasterPages/NewMasterPage.master" AutoEventWireup="true" CodeFile="ProCategoryView.aspx.cs" Inherits="SInventory_UI_ProCategoryView" %>
    ...
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3"><i class="bx bx-customize"></i> Product Category  List</div>
                                        ...
                                        <div class="row g-3 needs-validation">
                                            ...
                                            <div class="table-responsive" id="MainGradeDiv">
                                                ...
                                                <asp:GridView ID="loadGridView" runat="server" AutoGenerateColumns="False"
                                                    ...
                                                    <Columns>
                                                        <asp:BoundField DataField="CategoryName" HeaderText="Product Cetegory Name" />
