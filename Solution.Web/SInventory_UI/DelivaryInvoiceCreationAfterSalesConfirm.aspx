<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/NewMasterPage.master"
    AutoEventWireup="true" CodeFile="DelivaryInvoiceCreationAfterSalesConfirm.aspx.cs" Inherits="SInventory_UI_DelivaryInvoiceCreationAfterSalesConfirm" %>
    ...
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3"><i class="bx bx-customize"></i>Return</div>

                <div class="ms-auto">
                    <div class="btn-group">

                        <asp:LinkButton ID="EmpCetegoryAddImageButton" CssClass="btn btn-sm btn-outline-info " runat="server" OnClick="EmpCetegoryAddImageButton_Click"><i class="fa fa-pencil" aria-hidden="true"></i> Update Old Data </asp:LinkButton>
                    </div>
                </div>
            </div>
            <!--end breadcrumb-->
                                            ...
                                            <asp:GridView ID="orderGridView" runat="server" AutoGenerateColumns="False"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Status">
                                                        <ItemTemplate>
                                                            <asp:DropDownList ID="statusDropDownList" runat="server" CssClass="form-control form-control-sm mySelect2" AutoPostBack="True" Enabled="false"  OnTextChanged="statusDropDownList_OnTextChanged">
                                                             <%--   <asp:ListItem  Value="Full">Full</asp:ListItem>--%>
                                                                <%--<asp:ListItem>Full Dues</asp:ListItem>--%>
                                                                <asp:ListItem Selected="True" Value="Partial Dues">Partial</asp:ListItem>
                                                    ...
                                                    <asp:TemplateField HeaderText="Submit" >
                                                        <ItemTemplate>
                                                            ...
                                                            <contenttemplate>
                                                                <asp:LinkButton ID="gotoinvoiceButton"  runat="server" CssClass="btn btn-sm btn-info"   OnClick="gotoinvoiceButton_Click" Visible="false" OnClientClick="return sweetAlertConfirm_Submit(this);" 
                                                                    >
                                        ...
                                        <div class="col-8">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    ...
                                                    <asp:LinkButton OnClick="btnFinalSubmit_Click"   runat="server" ID="btnFinalSubmit"  class="btnMyyNew btnMyyNew-6"  OnClientClick="return sweetAlertConfirm_Submit(this);" >
