...
public partial class SInventory_UI_SubDeportTransferStockReceiveByDC : Page
{
    ...
    {
        aDataTable = aChalanBll.SubdeportChalanLoadInReceive(comUnitId);
    ...
    {
        Response.Redirect("SubDeportTransferStockReceiveByDC.aspx");
    }
}
