<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RegionEdit.aspx.cs" Inherits="SInventory_UI_RegionEdit" %>
                ...
                <table width="100%" class="TableWorkArea">
                    ...
                    <tr>
                        <td class="TDLeft" width="13%">
                            &nbsp;
                            <asp:HiddenField ID="regionInfoIdHiddenField" runat="server" />
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="TDLeft" width="13%">
                            Region Name</td>
                        <td class="TDRight" width="20%">
                            <asp:TextBox ID="regionnameTextBox" runat="server" CssClass="TextBox"></asp:TextBox>
                        </td>
                        <td class="TDLeft" width="13%">
                        </td>
                        <td class="TDRight" width="20%">
                    ...
                    <tr runat="server" Visible="False" id="com">
                        <td class="TDLeft" width="13%">
                        </td>
                        <td class="TDRight" width="20%">
                            &nbsp;
