<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/NewMasterPage.master" AutoEventWireup="true" CodeFile="DelivaryInvoiceCreationForCustomerByOrderAuto_Loading.aspx.cs" Inherits="SInventory_UI_DelivaryInvoiceCreationForCustomerByOrderAuto_Loading" %>
...
<div class="row">
 ...
 <asp:LinkButton ID="submitButton" CssClass="btn btnMyDesignSearch   btn-sm" runat="server" OnClick="saveButton_Click"
                               OnClientClick="return submitButton_ClientClick(this);"> <i class="fa fa-check"></i>&nbsp; Invoice Generate</asp:LinkButton>
