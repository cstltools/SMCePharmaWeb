<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/NewMasterPage.master" AutoEventWireup="true" CodeFile="SC_PaymentReport.aspx.cs" Inherits="SInventory_UI_SC_PaymentReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3"><i class="bx bx-customize"></i> Return  Report</div>
             ...
             <div class="table-responsive" id="MainGradeDiv"  style="height:600px">
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="UpdateDate" HeaderText="Delivary Date" />
                                            ...
                                            <asp:BoundField DataField="PaymentInvoiceNo" HeaderText="Payment Number" />
  ...
  <asp:BoundField DataField="soldQty" HeaderText="Return Qty" />
