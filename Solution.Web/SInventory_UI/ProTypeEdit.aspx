<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProTypeEdit.aspx.cs" Inherits=" SInventory_UI_ProTypeEdit" %>
                ...
                <table width="100%" class="TableWorkArea">
                    ...
                    <tr>
                        ...
                        <td class="TDLeft" width="13%">
                            Type</td>
                        <td class="TDRight" width="20%">
                            <asp:TextBox ID="typeTextBox" runat="server" CssClass="TextBox"></asp:TextBox>
                        </td>
                        <td class="TDLeft" width="13%">
                            &nbsp;
                        </td>
