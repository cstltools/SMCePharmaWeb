<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/NewMasterPage.master" AutoEventWireup="true" CodeFile="DeliveryPaymentReportNew.aspx.cs" Inherits="SInventory_UI_DeliveryPaymentReportNew" %>
    ...
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3"><i class="bx bx-customize"></i> Sales Confirmation Report (SAP)</div>
...
DataField="GrossValue" HeaderText="TP"  HtmlEncodeFormatString="true" HtmlEncode="true" />
                               ...
                               <%--     <asp:BoundField DataField="SubTerritoryName" HeaderText="Sub-Territory" />--%>
                                    ...
                                    <asp:BoundField DataField="FOCType" HeaderText="FOC Type" />
