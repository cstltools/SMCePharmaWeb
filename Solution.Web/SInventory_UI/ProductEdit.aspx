<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProductEdit.aspx.cs" Inherits="SInventory_UI_ProductEdit" %>
                ...
                <table width="100%" class="TableWorkArea">
                    ...
                    <tr>
                        ...
                        <td width="13%" class="TDLeft">
                            Pack Size</td>
                        <td width="20%" class="TDRight">
                            <asp:DropDownList ID="packSizeDropDownList" runat="server" CssClass="DropDown">
                            </asp:DropDownList>
                        </td>
                        <td width="13%" class="TDLeft">
                        </td>
                    ...
                    <tr>
                        ...
                        <td width="13%" class="TDLeft">
                             UOM</td>
                        <td width="20%" class="TDRight">
                            <asp:DropDownList ID="stockUOMDropDownList" runat="server" CssClass="DropDown">
                            </asp:DropDownList>
                        </td>
                        <td width="13%" class="TDLeft">
                            &nbsp;
                    ...
                    <tr>
                        ...
                        <td width="13%" class="TDLeft">
                            Product Type</td>
                        <td width="20%" class="TDRight">
                            <asp:DropDownList ID="typeDropDownList" runat="server" CssClass="DropDown">
                            </asp:DropDownList>
                        </td>
                        <td width="13%" class="TDLeft">
                            &nbsp;
                    ...
                    <tr>
                        ...
                        <td width="13%" class="TDLeft" >
                            Product Brand</td>
                         <td width="20%" class="TDRight">
                             <asp:DropDownList ID="productSQDropDownList" runat="server" CssClass="DropDown">
                             </asp:DropDownList>
                        </td>
                        <td width="13%" class="TDLeft">
                            &nbsp;
