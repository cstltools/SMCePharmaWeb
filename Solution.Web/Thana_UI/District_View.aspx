...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                ...
                <div class="ms-auto">
                    <div class="btn-group">
                        <a href="District_Entry.aspx"  class="btn btn-sm btn-outline-info " ><i class="fa fa-plus" aria-hidden="true"></i> New Entry</a>
    ...
    <script>
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    for (var i = 0; i < result.length; i++) {
                      ...
                      /*  row += "<td><button class='btn-outline-warning btn-xs mb-1 mb-md-0' onclick='editClick(" + result[i].DistrictId + ")'><i class='bx bxs-edit' aria-hidden='true'></i></button> </td>";*/
                        row += "</tr>";
        ...
        function editClick(id) {
            location.href = '../Thana_UI/District_Entry.aspx?id=' + id + '';
