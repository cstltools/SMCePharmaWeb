...
public partial class Reports_UI_DcrDoctoriseMonthlypt : System.Web.UI.Page
{
        ...
        private void LoadData()
    {
        ...
        if (rbReportTypeName.Items[0].Selected)
        {
            ...
            DataTable aDataTable = _DAL.GetDCRDoctorWiseDayList(mainDate, fromDateTextBox.Text, toDateTextBox.Text, aPP, ProviderType, PharmaPlatform, Zone, Area, Teritory);
