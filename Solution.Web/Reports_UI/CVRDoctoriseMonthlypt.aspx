<%@ Page Title="Customer Visit Report" Language="C#" MasterPageFile="~/MasterPages/NewMasterPage.master" AutoEventWireup="true" CodeFile="CVRDoctoriseMonthlypt.aspx.cs" Inherits="Reports_UI_CVRDoctoriseMonthlypt" %>
    ...
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3"><i class="bx bx-customize"></i> Customer Visit Report</div>
                                ...
                                <ContentTemplate>
                                    ...
                                    <div class="row">
                                                    ...
                                                    <asp:RadioButtonList runat="server" ID="rbReportTypeName" CssClass="radioChoice2" AutoPostBack="True" OnSelectedIndexChanged="rbReportTypeName_SelectedIndexChanged" RepeatDirection="Horizontal" RepeatColumns="1" RepeatLayout="Flow">
                                                       ...
                                                       <%-- <asp:ListItem Value="2">Product Brand Wise</asp:ListItem>
                                                        <asp:ListItem Value="3">Product Wise</asp:ListItem>
                                                            ...
                                                            <asp:ListItem style="display:none" Value="5">Doctor Coverage Report</asp:ListItem>
                                                              <asp:ListItem Value="6">Dynamic Visit Status Report</asp:ListItem>--%>
                                                              <%--<asp:ListItem   Value="6">Doctor Wise DCP Report</asp:ListItem>--%>
                                                    </asp:RadioButtonList>
                                                     </div>
                                     ...
                                     <div class="col-4">
                                          ...
                                          <div class="form-group row"  runat="server" id="divBrand" visible="false">
    <label for="ToDate" class="col-sm-4 col-form-label">Brand Filter:  </label>

    <div class="col-sm-8">

       <asp:DropDownList class="form-select form-select-sm mb-3 mySelect2 " runat="server" ID="ddlBrand"></asp:DropDownList>
                                             ...
                                             <div class="form-group row"  runat="server" id="divDCType" visible="false">
      <label for="mainName" class="col-sm-4 col-form-label">Doctor Type: </label>
          ...
          <div class="input-group">
              <asp:DropDownList runat="server" ID="DoctorTypeSelect" name="DoctorTypeSelect" class="form-select form-select-sm mb-3 mySelect2 "></asp:DropDownList>
                                             ...
                                             <div class="form-group row" style="display:none">
                                                <label for="ToDate" class="col-sm-4 col-form-label">Provider Type:  </label>
                                             ...
                                             <div class="form-group row"  style="display:none">
                                                <label for="ToDate" class="col-sm-4 col-form-label">Pharma Platform:  </label>
                                             ...
                                             <div class="form-group row">
                                                <label for="ToDate" class="col-sm-4 col-form-label">Approval Status:  </label>

                                                <div class="col-sm-8">

                                                    <asp:DropDownList runat="server" ID="ddlApprovalStatus" class="form-select form-select-sm mb-3 mySelect2"></asp:DropDownList>
                                     ...
                                     <div class="col-4">
                                           ...
                                           <div class="form-group row"   runat="server" id="divUser" visible="false">
                                                <label for="ToDate" class="col-sm-3 col-form-label">User:  </label>
                              ...
                              <script type="text/javascript">
                                  ...
                                  function exporttocsv() {
                                      ...
                                      if (value == "6") {
                                          txt = "Dynamic Visit Status Report ";
                                      }

                                      $("#export").tableToCSV({
                                          filename: txt +' Customer Visit Report'
                                      });
                                  }
                              </script>
