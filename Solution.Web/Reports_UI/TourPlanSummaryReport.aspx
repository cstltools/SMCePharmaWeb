<%@ Page Title="  Tour Plan Summary Report" Language="C#" MasterPageFile="~/MasterPages/NewMasterPage.master" AutoEventWireup="true" CodeFile="TourPlanSummaryReport.aspx.cs" Inherits="Reports_TourPlanSummaryReport" %>
    ...
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3"><i class="bx bx-customize"></i> Tour Plan Summary Report</div>
...
<br />        
  ...
  <asp:BoundField DataField="SL" HeaderText="SL" />
        ...
        <asp:BoundField DataField="DayOfHQ" HeaderText="Day of HQ" />
        <asp:BoundField DataField="NoOfExHQ" HeaderText="No of Ex. HQ" />
        <asp:BoundField DataField="NoOfOS" HeaderText="No of OS" />
        <asp:BoundField DataField="NoOfOSDCC" HeaderText="No of OS-DCC" />
        <asp:BoundField DataField="NoOfDaysWork" HeaderText="No of Days Work" />
        <asp:BoundField DataField="NoOfDaysLeave" HeaderText="No of Days Leave" />
        <asp:BoundField DataField="DaysWorkTeamMate" HeaderText="#Days Work Team Mate" />
