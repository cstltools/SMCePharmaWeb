<%@ Page Title="DCP Report" Language="C#" MasterPageFile="~/MasterPages/NewMasterPage.master" AutoEventWireup="true" CodeFile="DcpDoctoriseMonthlypt.aspx.cs" Inherits="Reports_UI_DcpDoctoriseMonthlypt" %>
    ...
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3"><i class="bx bx-customize"></i> DCP Report</div>
                            ...
                            <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                                    ...
                                                    <asp:RadioButtonList runat="server" ID="rbReportTypeName" CssClass="radioChoice2" AutoPostBack="True" OnSelectedIndexChanged="rbReportTypeName_SelectedIndexChanged" RepeatDirection="Horizontal" RepeatColumns="1" RepeatLayout="Flow">
                                                       ...
                                                       <%-- <asp:ListItem Value="2">Product Brand Wise</asp:ListItem>
                                                        <asp:ListItem Value="3">Product Wise</asp:ListItem>--%>
                                                            <asp:ListItem Value="2">User Wise</asp:ListItem>
                                                            <asp:ListItem Value="3">Customer Wise</asp:ListItem>
                              ...
                              <script type="text/javascript">
                                  ...
                                  function exporttocsv() {
                                      ...
                                      //}
                                      $("#export").tableToCSV({
                                          filename: txt +' Doctor DCP Report'
                                      });
                                  }
                              </script>
