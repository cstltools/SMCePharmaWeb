                                                ...
                                                <div class="col-sm-8 ">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <asp:RadioButtonList runat="server" ID="rbReportTypeName" CssClass="radioChoice2" AutoPostBack="True" OnSelectedIndexChanged="rbReportTypeName_SelectedIndexChanged" RepeatDirection="Horizontal" RepeatColumns="1" RepeatLayout="Flow">
                                                            ...
                                                            <asp:ListItem Value="5">User & Product Wise</asp:ListItem>
                                                            <asp:ListItem Value="6">Dynamic RX Status Report</asp:ListItem>
    ...
    <div class="col-sm-8">
       ...
       <asp:DropDownList class="form-select form-select-sm mb-3 mySelect2 " runat="server" ID="ddlBrand"></asp:DropDownList>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="form-group row" runat="server" visible="false" id="divPro">
                                                <label for="ToDate" class="col-sm-4 col-form-label">Product Name:  </label>
                            ...
                            <script type="text/javascript">
                                ...
                                function exporttocsv() {
                                    ...
                                    if (value == "5") {
                                        txt = "User & Product Wise ";
                                    }


                                    if (value == "6") {
                                        txt = "Dynamic RX Status Report ";
                                    }
