...
public partial class Reports_UI_DcpDoctoriseMonthlypt : System.Web.UI.Page
{
        ...
        private void LoadData()
    {
        ...
        else if (rbType.Items[2].Selected)
        {
            Type = "CDCR";
        }
        else
        ...
        if (rbReportTypeName.Items[0].Selected)
        {
            ...
            DataTable aDataTable = _DAL.GetDCPDoctorWiseDayList(mainDate, fromDateTextBox.Text, toDateTextBox.Text, aPP, ProviderType, PharmaPlatform, Zone, Area, Teritory);
        ...
        if (rbReportTypeName.Items[2].Selected)
        {
            ...
            string mainDate = dtDate.Rows[0]["mainDate"].ToString();
            DataTable aDataTable = _DAL.GetCusDCPDoctorWiseDayList(mainDate, fromDateTextBox.Text, toDateTextBox.Text, aPP, ProviderType, PharmaPlatform, Zone, Area, Teritory);
        ...
        if (rbReportTypeName.Items[1].Selected)
        {
            ...
            string mainDate = dtDate.Rows[0]["mainDate"].ToString(); DataTable aDataTable = _DAL.GetDCPUserWiseList(mainDate, fromDateTextBox.Text, toDateTextBox.Text, aPP, ProviderType, PharmaPlatform, Zone, Area, Teritory);
            StringBuilder html = new StringBuilder();
            html.Append("<table id='tblTable' style='height:200px;' class='table table-bordered text-center thead-dark table-hover table-striped tableFixHead'>");
            html.Append("<thead><tr>");
    ...
    {
        Response.Redirect("DcpDoctoriseMonthlypt.aspx");
    }
