<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DistrictSalesReportViewer.aspx.cs" Inherits="SInventory_RPTVIEW_DistrictSalesReportViewer" %>
                    ...
                    <tr>
                        <td width="13%" class="TDLeft" colspan="6">
                           <div style="overflow: scroll; height: auto;">
                               ...
                               <CR:CrystalReportViewer ID="crvDistrictSalesRpt" runat="server" 
                                   AutoDataBind="true" EnableDatabaseLogonPrompt="False" 
                                   EnableParameterPrompt="False" ReuseParameterValuesOnRefresh="True" 
                                   ToolPanelView="None" ondisposed="crvDistrictSalesRpt_Disposed" 
                                   onunload="crvDistrictSalesRpt_Unload" />
