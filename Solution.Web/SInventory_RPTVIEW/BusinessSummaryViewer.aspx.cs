...
public partial class SInventory_RPTVIEW_BusinessSummaryViewer : System.Web.UI.Page
{
    ...
    protected void Page_Init(object sender, EventArgs e)
    {
        ...
        string toDate = Request.QueryString["toDate"];
        {
            ...
            DataTable mainDataTable = aDal.BusinessSummaryReportDAl(FromDate, ToDate).Copy();

            DataSet Ds = new DataSet();

            mainDataTable.TableName = "BsummaryDataTable";
            Ds.Tables.Add(mainDataTable);
            rptdoc.Load(ReportPath("crpBusinessSummary.rpt"));
