<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CustomerSalesReportViewer.aspx.cs" Inherits="SInventory_RPTVIEW_CustomerSalesReportViewer" %>
                    ...
                    <tr>
                        <td width="13%" class="TDLeft" colspan="6">
                           <div style="overflow: scroll; height: auto;">
                               ...
                               <CR:CrystalReportViewer ID="crvCustSalesRpt" runat="server" 
                                   AutoDataBind="true" EnableDatabaseLogonPrompt="False" 
                                   EnableParameterPrompt="False" ReuseParameterValuesOnRefresh="True" 
                                   ToolPanelView="None" ondisposed="crvCustSalesRpt_Disposed" 
                                   onunload="crvCustSalesRpt_Unload" />
