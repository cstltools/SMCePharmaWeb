<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DCPickingReportViewer.aspx.cs" Inherits="SInventory_RPTVIEW_DCPickingReportViewer" %>
                    ...
                    <tr>
                        <td width="13%" class="TDLeft" colspan="6">
                           <div style="overflow: scroll; height: auto;">
                               ...
                               <CR:CrystalReportViewer ID="crvDCPicking" runat="server" 
                                   AutoDataBind="true" EnableDatabaseLogonPrompt="False" 
                                   EnableParameterPrompt="False" ReuseParameterValuesOnRefresh="True" 
                                   ToolPanelView="None" ondisposed="crvDCPicking_Disposed" 
                                   onunload="crvDCPicking_Unload" />
