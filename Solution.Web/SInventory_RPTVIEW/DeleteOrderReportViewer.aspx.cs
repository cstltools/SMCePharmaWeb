...
public partial class SInventory_RPTVIEW_CustomerPaymentViewer : System.Web.UI.Page
{
    ...
    protected void Page_Init(object sender, EventArgs e)
    {
        ...
        string comUnitCode = Convert.ToString(Session["ComUnitCode"]);
        ...
        if (rptType == "1")
        {
            ...
            DataTable mainDataTable = aOrderReportBll.LoadDeleteOrderReport(comUnitCode, fromDate, toDate).Copy();
        ...
        {
            DataTable mainDataTable = aOrderReportBll.LoadDeleteOrderNationalReport(comUnitCode, fromDate, toDate).Copy();
