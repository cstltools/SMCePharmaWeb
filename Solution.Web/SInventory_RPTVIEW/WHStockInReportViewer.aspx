<%@ Page Language="C#" AutoEventWireup="true" CodeFile="WHStockInReportViewer.aspx.cs" Inherits="SInventory_RPTVIEW_WHStockInReportViewer" %>
                    ...
                    <tr>
                        <td width="13%" class="TDLeft" colspan="6">
                           <div style="overflow: scroll; height: auto;">
                               ...
                               <CR:CrystalReportViewer ID="crvWHStockInReport" runat="server" 
                                   AutoDataBind="true" EnableDatabaseLogonPrompt="False" 
                                   EnableParameterPrompt="False" ReuseParameterValuesOnRefresh="True" 
                                   ToolPanelView="None" ondisposed="crvWHStockInReport_Disposed" 
                                   onunload="crvWHStockInReport_Unload" />
