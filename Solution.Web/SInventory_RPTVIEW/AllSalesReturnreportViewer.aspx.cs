...
public partial class SInventory_RPTVIEW_AllSalesReturnreportViewer : System.Web.UI.Page
{
    ...
    protected void Page_Init(object sender, EventArgs e)
    {
        ...
        if (NationalReport != 1 && rpt == 0)
        {
            ...
            DataTable mainDataTable = aCompanySalesReportBll.SalesReturnReportDAl(districtId, FromDate, ToDate).Copy();
        ...
        else 
        {
            ...
            DataTable mainDataTable = aCompanySalesReportBll.SalesReturnReportNationalDAl(FromDate, ToDate).Copy();
