...
public partial class SInventory_RPTVIEW_ExcelSalesReportViewer : System.Web.UI.Page
{
    ...
    protected void Page_Init(object sender, EventArgs e)
    {
        ...
        string Parameter2 = Session["Parameter2"].ToString();

        DataTable mainDataTable = aMasterInfoBll.FixedCustomerSalesReportInfo2(Parameter, Parameter2).Copy();
        ...
        rptdoc.Load(ReportPath("rptfixedcamistsalesreport.rpt"));
