...
public partial class SInventory_RPTVIEW_BusinessSummaryViewer3 : System.Web.UI.Page
{
    ...
    protected void Page_Init(object sender, EventArgs e)
    {
        ...
        if (Branch != "")
        {
            ...
            DataTable mainDataTable = aTotalSummaryDAL.BranchwiseTotalProformaBLL(FromDate, ToDate, Branch).Copy();
        ...
        else
        {
            ...
            DataTable mainDataTable = aTotalSummaryDAL.BranchwiseTotalProformaBLL(FromDate, ToDate).Copy();
