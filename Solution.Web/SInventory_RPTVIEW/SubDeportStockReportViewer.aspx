<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SubDeportStockReportViewer.aspx.cs" Inherits="SInventory_RPTVIEW_SubDeportStockReportViewer" %>
                    ...
                    <tr>
                        <td width="13%" class="TDLeft" colspan="6">
                           <div style="overflow: scroll; height: auto;">
                               ...
                               <CR:CrystalReportViewer ID="crvDCStockRpt" runat="server" 
                                   AutoDataBind="true" EnableDatabaseLogonPrompt="False" 
                                   EnableParameterPrompt="False" ReuseParameterValuesOnRefresh="True" 
                                   ToolPanelView="None" ondisposed="crvDCStockRpt_Disposed" 
                                   onunload="crvDCStockRpt_Unload" />
