...
public partial class SInventory_RPTVIEW_BusinessSummaryViewer5 : System.Web.UI.Page
{
    ...
    protected void Page_Init(object sender, EventArgs e)
    {
        ...
        if (Branch != "")
        {
            ...
            DataTable mainDataTable = aTotalSummaryDAL.saleshwiseTotalProformaBLL(FromDate, ToDate, Branch).Copy();
        ...
        else
        {
            ...
            DataTable mainDataTable = aTotalSummaryDAL.salesBranchwiseTotalProformaBLL(FromDate, ToDate).Copy();
