<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RegionSalesReportViewer.aspx.cs" Inherits="SInventory_RPTVIEW_RegionSalesReportViewer" %>
                    ...
                    <tr>
                        <td width="13%" class="TDLeft" colspan="6">
                           <div style="overflow: scroll; height: auto;">
                               ...
                               <CR:CrystalReportViewer ID="crvRegionSalesRpt" runat="server" 
                                   AutoDataBind="true" EnableDatabaseLogonPrompt="False" 
                                   EnableParameterPrompt="False" ReuseParameterValuesOnRefresh="True" 
                                   ToolPanelView="None" ondisposed="crvRegionSalesRpt_Disposed" 
                                   onunload="crvRegionSalesRpt_Unload" />
