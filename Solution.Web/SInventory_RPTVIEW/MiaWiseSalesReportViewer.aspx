<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MiaWiseSalesReportViewer.aspx.cs" Inherits="SInventory_RPTVIEW_MiaWiseSalesReportViewer" %>
                    ...
                    <tr>
                        <td width="13%" class="TDLeft" colspan="6">
                           <div style="overflow: scroll; height: auto;">
                               ...
                               <CR:CrystalReportViewer ID="crvmiaSalesRpt" runat="server" 
                                   AutoDataBind="true" EnableDatabaseLogonPrompt="False" 
                                   EnableParameterPrompt="False" ReuseParameterValuesOnRefresh="True" 
                                   ToolPanelView="None" ondisposed="crvmiaSalesRpt_Disposed" 
                                   onunload="crvmiaSalesRpt_Unload" />
