...
public partial class TransferUI_MarketInfoApprove : System.Web.UI.Page
{
    ...
    {
        aDataTable = _DAL.GetMarketInfoApprovalList("");
    ...
    protected void loadGridView_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName == "ApproveData")
        {
            ...
            ResultInfo Res = _DAL.SaveMarket_ApplogDAL(hfCustPropMasterId.Value);
