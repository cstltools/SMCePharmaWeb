...
public partial class TransferUI_DoctorUpdationApprove : System.Web.UI.Page
{
    ...
    {
        aDataTable = _DAL.GetDoctorProviderApprovalList("");
    ...
    protected void loadGridView_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName == "ApproveData")
        {
            ...
            ResultInfo Res = _DAL.SaveDoctorProvider_ApplogDAL(hfCustPropMasterId.Value);
