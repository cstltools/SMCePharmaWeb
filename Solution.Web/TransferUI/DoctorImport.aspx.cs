...
public partial class TransferUI_DoctorImport : System.Web.UI.Page
{
    ...
    private void InitialGrid()
    {
        ...
        aDataTable.Columns.Add("PharmaPlatformCode");
    ...
    protected void submitButton_Click(object sender, EventArgs e)
    {
        if (Validation())
        {
            ...
            for (int i = 0; i < productGridView.Rows.Count; i++)
            {
                ...
                Label lblPharmaPlatformCode = ((Label)productGridView.Rows[i].Cells[1].FindControl("lblPharmaPlatformCode"));
                ...
                _DAO.PharmaPlatformCode = string.IsNullOrEmpty(lblPharmaPlatformCode.Text.Trim()) ? null : lblPharmaPlatformCode.Text.Trim();
