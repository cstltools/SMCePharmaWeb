...
public partial class TransferUI_SubTerritory_Transfer : System.Web.UI.Page
{
    ...
    public bool Validation()
    {
        ...
        T_TeritorySelect.CssClass = "form-select form-select-sm mb-3 mySelect2";
        ...
        if (T_TeritorySelect.SelectedValue == "")
        {
            T_TeritorySelect.ToolTip = "please fill out this field";
            T_TeritorySelect.CssClass = "form-select form-select-sm mb-3 mySelect2 is-invalid";
            T_TeritorySelect.Focus();
            return false;
        }
        return true;
    }
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        if (Validation())
        {
            ...
            Res  = _CustomerInfoDAL.UpdateSubTerritory_Transfer(aMaster,Type, param,HttpContext.Current.Session["UserId"].ToString());
            if (Res.isSuccess == true)
            {
                ScriptManager.RegisterStartupScript(this, GetType(), "Popup", "successalert('" + "Operation successful!" + "','Success','SubTerritory_Transfer.aspx');", true);
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        if (F_TeritorySelect.SelectedValue != "")
        {
            ...
            try
            {
                DataTable dtgrade = _dataLoad.GetSubTerritory_ByTerritoryId_Active(Convert.ToInt32(F_TeritorySelect.SelectedValue));
              
        chkListMarket.DataValueField = "SubTerritoryId";
        chkListMarket.DataTextField = "SubTerritoryName";
        chkListMarket.DataSource = dtgrade;
        chkListMarket.DataBind();
            }
            catch (Exception ex) { }
        ...
        {
            showMessageBox("Please Select Sub-Territory!");
