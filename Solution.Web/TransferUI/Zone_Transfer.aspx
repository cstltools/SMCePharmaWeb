<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/NewMasterPage.master" AutoEventWireup="true" CodeFile="Zone_Transfer.aspx.cs" Inherits="TransferUI_Area_Transfer" %>


<%@ Register Src="~/TransferUI/IVMarketStructureFrom_ToZoneTranfer.ascx" TagPrefix="uc1" TagName="IVMarketStructure" %> 
<%@ Register Src="~/TransferUI/IVMarketStructureFrom_ToZoneTranfer.ascx" TagPrefix="uc1" TagName="IVMarketStructureTo" %> 
     ...
     <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3"><i class="bx bx-customize"></i>  Zone Transfer</div>
