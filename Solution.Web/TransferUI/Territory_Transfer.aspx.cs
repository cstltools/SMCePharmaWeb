...
public partial class TransferUI_Territory_Transfer : System.Web.UI.Page
{
    ...
    public bool Validation()
    {
        ...
        if (T_AreaSelect.SelectedValue == "")
        {
            T_AreaSelect.ToolTip = "please fill out this field";
            T_AreaSelect.CssClass = "form-select form-select-sm mb-3 mySelect2 is-invalid";
            T_AreaSelect.Focus();
            return false;
        }
        return true;
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        if (Validation())
        {
            ...
            Res  = _CustomerInfoDAL.UpdateTerritory_Transfer(aMaster,Type, param,HttpContext.Current.Session["UserId"].ToString());
            if (Res.isSuccess == true)
            {
                ScriptManager.RegisterStartupScript(this, GetType(), "Popup", "successalert('" + "Operation successful!" + "','Success','Territory_Transfer.aspx');", true);
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        if (F_AreaSelect.SelectedValue != "")
        {
            ...
            try
            {
                DataTable dtgrade = _dataLoad.GetTerritory_ByAreaId_Active(Convert.ToInt32(F_AreaSelect.SelectedValue));
              
        chkListMarket.DataValueField = "TerritoryId";
        chkListMarket.DataTextField = "TerritoryName";
