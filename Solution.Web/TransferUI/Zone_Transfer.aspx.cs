...
public partial class TransferUI_Area_Transfer : System.Web.UI.Page
{
    ...
    public bool Validation()
    {
       ...
       T_GroupSelect.CssClass = "form-select form-select-sm mb-3 mySelect2";
        ...
        if (T_GroupSelect.SelectedValue == "")
        {
            T_GroupSelect.ToolTip = "please fill out this field";
            T_GroupSelect.CssClass = "form-select form-select-sm mb-3 mySelect2 is-invalid";
            T_GroupSelect.Focus();
            return false;
        }
        return true;
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        if (Validation())
        {
            ...
            Res  = _CustomerInfoDAL.UpdateZone_Transfer(aMaster,Type, param,HttpContext.Current.Session["UserId"].ToString());
            if (Res.isSuccess == true)
            {
                ScriptManager.RegisterStartupScript(this, GetType(), "Popup", "successalert('" + "Operation successful!" + "','Success','Zone_Transfer.aspx');", true);
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        if (F_GroupSelect.SelectedValue != "")
        {
            ...
            try
            {
                ...
                DataTable dt = _dataLoad.GetZone_byGroupId_Active(Convert.ToInt32(F_GroupSelect.SelectedValue));
                  
              
        chkListMarket.DataValueField = "RegionId";
        chkListMarket.DataTextField = "RegionName";
