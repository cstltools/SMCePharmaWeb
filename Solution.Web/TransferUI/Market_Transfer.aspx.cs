...
public partial class TransferUI_Market_Transfer : System.Web.UI.Page
{
    ...
    public bool Validation()
    {
        ...
        T_SubTeritory.CssClass = "form-select form-select-sm mb-3 mySelect2";
        ...
        for (int i = 0; i < chkListMarket.Items.Count; i++)
        {
            ...
            if (count == 0)
            {
                showMessageBox("Please Select at least one Market !!!");
                return false;
            }
        ...
        if (T_SubTeritory.SelectedValue == "")
        {
            T_SubTeritory.ToolTip = "please fill out this field";
            T_SubTeritory.CssClass = "form-select form-select-sm mb-3 mySelect2 is-invalid";
            T_SubTeritory.Focus();
            return false;
        }
        return true;
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        if (Validation())
        {
            ...
            Res  = _CustomerInfoDAL.UpdateMArket_Transfer(aMaster,Type, param,HttpContext.Current.Session["UserId"].ToString());
            if (Res.isSuccess == true)
            {
                ScriptManager.RegisterStartupScript(this, GetType(), "Popup", "successalert('" + "Operation successful!" + "','Success','Market_Transfer.aspx');", true);
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        if (F_SubTeritory.SelectedValue != "")
        {
            ...
            try
            {
                DataTable dtgrade = _dataLoad.GetMarket_BySubTerritoryId_Active(Convert.ToInt32(F_SubTeritory.SelectedValue));
              
        chkListMarket.DataValueField = "MarketId";
        chkListMarket.DataTextField = "MarketName";
