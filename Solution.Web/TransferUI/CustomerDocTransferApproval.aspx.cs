...
public partial class TransferUI_CustomerDocTransferApproval : System.Web.UI.Page
{
    ...
    {
        aDataTable = _DAL.GetCustomer_Doctor_Transfer(HttpContext.Current.Session["UserId"].ToString(), rbType.SelectedValue);
    ...
    protected void loadGridView_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName == "ApproveData")
        {
            ...
            ResultInfo Res = _DAL.CustomerDocTransferApprovalDAL(hfCustPropMasterId.Value, rbType.SelectedValue);
