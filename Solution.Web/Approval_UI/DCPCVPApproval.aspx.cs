...
public partial class Approval_UI_DCPCVPApproval : System.Web.UI.Page
{
    ...
    protected void loadGridView_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        if (e.CommandName == "ApproveData")
        {
            ...
            aMaster.MenuId = 377;
            ResultInfo Res = _DAL.SaveVisitTourPlan_ApplogDAL(aMaster);
    ...
    private void LoadData()
    {
        ...
        DataTable aDataTable = _DAL.GetDCPCVPTourPlan_ApplogDAL(pram, Role, AppStatus, FromDt, ToDt, EmpId);
