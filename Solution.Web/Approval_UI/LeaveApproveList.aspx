                                        ...
                                        <ItemTemplate>
                                             ...
                                             <asp:Label runat="server" ID="lbMsg"   />
                                              <asp:LinkButton ID="lbEdit" Visible="false" runat="server" class="btn-warning  btn-sm mb-1 mb-md-0"
                                               ...
                                               <asp:LinkButton ID="lbApprove"  Enabled='<%#  Eval("ApprovalStatusWeb").ToString() != "Approved" %>' runat="server" CssClass="btn-info  btn-sm mb-1 mb-md-0"
                                                                     CommandArgument="<%# Container.DataItemIndex %>" CommandName="ApproveData"><i class='fa fa-check' aria-hidden='true'></i></asp:LinkButton>
                                            
                                            
                                               <asp:LinkButton ID="lbReject"  Enabled='<%#  Eval("ApprovalStatusWeb").ToString() != "Rejected" %>' runat="server" CssClass="btn-danger  btn-sm mb-1 mb-md-0"
