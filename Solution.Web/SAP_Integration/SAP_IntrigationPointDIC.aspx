<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/NewMasterPage.master" AutoEventWireup="true" CodeFile="SAP_IntrigationPointDIC.aspx.cs" Inherits="SAP_Integration_SAP_IntrigationPointDIC" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
       ...
       <div class="page-content">
           ...
           <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
               <div class="breadcrumb-title pe-3"><i class="bx bx-customize"></i> Stock Receive By SAP</div>
...
<asp:RadioButtonList runat="server" ID="rbType" CssClass="radioChoice"  AutoPostBack="true" OnSelectedIndexChanged="rbType_SelectedIndexChanged"  RepeatDirection="Horizontal" RepeatLayout="Flow">
    ...
    <asp:ListItem Value="Employee Info">Employee Info</asp:ListItem>
     <asp:ListItem Selected="True" Value="Stock Receive">Stock Receive</asp:ListItem>
</asp:RadioButtonList>
                 </div>
                 </div>
          <br />
...
<div class="table-responsive" id="MainGradeDiv">
   ...
   <asp:BoundField DataField="action" HeaderText="Action Status" />  
           ...
           <asp:GridView ID="gv_ProductInfo" runat="server" AutoGenerateColumns="False"  onrowcommand="gv_ProductInfo_RowCommand" 
      CssClass="table table-bordered  text-center thead-dark" OnPreRender="gv_DocumentUpload_PreRender">
   ...
   <asp:BoundField DataField="action" HeaderText="Action Status" />  
       ...
       <asp:GridView ID="gv_StockReceive" runat="server" AutoGenerateColumns="False" OnRowCommand="gv_StockReceive_RowCommand" OnRowDataBound="gv_StockReceive_RowDataBound"
                                                CssClass="table table-bordered  text-center thead-dark" OnPreRender="gv_StockReceive_PreRender" DataKeyNames="StockMovementMasterId">
