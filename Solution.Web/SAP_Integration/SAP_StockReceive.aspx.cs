...
public partial class SAP_Integration_SAP_StockReceive : System.Web.UI.Page
{
    ...
    protected void ApproveButton_Click(object sender, EventArgs e)
    {
        ...
        if (lblChallanNo.Text.Trim() != "")
        {
            ...
            else
            {
                ...
                if (Res.isSuccess)
                {
                        ScriptManager.RegisterStartupScript(this, GetType(), "Popup", "successalert('" + "Operation successful!" + "','Success','SAP_IntrigationPoint.aspx');", true);
