<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/NewMasterPage.master" AutoEventWireup="true" CodeFile="SAP_StockReceiveDIC.aspx.cs" Inherits="SAP_Integration_SAP_StockReceiveDIC" %>
                ...
                <div class="ms-auto">
                    <div class="btn-group">
                         <%--<asp:LinkButton runat="server" OnClick="BackToListButton_Click" class="btn btnMyDesignReset   btn-sm"><i class="fa fa-retweet" aria-hidden="true"></i>&nbsp; Back to list </asp:LinkButton>--%>
                          <a href="../SAP_Integration/SAP_IntrigationPointDIC.aspx" class="btn btn-sm btn-sm btn-outline-info"><i class="fa fa-backward"></i>&nbsp;Back to List</a>
        ...
        <ItemTemplate>
            <asp:Label ID="LabelSL" Text='<%# Container.DataItemIndex + 1 %>' runat="server"></asp:Label>
              ...
              <asp:HiddenField runat="server" ID="hfStockMovementDetailId" Value='<%#Eval("StockMovementDetailId")%>' />
                                            ...
                                            <ItemTemplate>
                                                <asp:TextBox ID="txtquantity"  type="number" ReadOnly="true"   runat="server" Text='<%#Eval("quantity") %>' CssClass="form-control form-control-sm"></asp:TextBox>
