...
public partial class DoctorModule_UI_LeaveConfigList : System.Web.UI.Page
{
    ...
    [WebMethod]
    public static string  GetLeaveConfigList()
    {
        DataTable dt = _leaveDal.GetLeaveConfigList("");
        string JSONresult;
