...
public partial class DoctorModule_UI_MileageClaimView : System.Web.UI.Page
{
    ...
    private string param()
    {
        ...
        if (FromDate.Text != "" &&  ToDate.Text != "") {
            param = param + " AND CONVERT(date,mas.MileageDate)  BETWEEN '" + FromDate.Text + "' AND '" + ToDate.Text + "' ";
        }
        if ( FromDate.Text != "" && ToDate.Text == "") {
            param = param + " AND CONVERT(date,mas.MileageDate)  BETWEEN '" + FromDate.Text + "' AND '" + DateTime.Now.ToString("dd-MMM-yyyy") + "' ";
        }
