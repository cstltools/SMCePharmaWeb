...
public partial class DoctorModule_UI_NationalSetupView : System.Web.UI.Page
{
    ...
    [WebMethod]
    public static string GetNationalSetupList()
    {
        DataTable dt = _groupSetupDal.GetNationalSetupList();
        string JSONresult;
