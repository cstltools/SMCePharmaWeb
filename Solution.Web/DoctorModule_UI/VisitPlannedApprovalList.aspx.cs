...
public partial class DoctorModule_UI_VisitPlannedApprovalList : System.Web.UI.Page
{
    ...
    private void LoadData()
    {
        ...
        DataTable aDataTable = _DoctorVisit_DAL.GetDoctorVisitList(" and mas.ApprovalStatus<>'2'");
        ...
        if (Validation())
        {
...

            {
                ...
                if (chkSelect.Checked)
                {
                    ...
                    Res = tourTypeDal.Approve_VisitPlanList(hfCustomerMasterId.Value, rbValue, HttpContext.Current.Session["UserId"].ToString());
                }
            ...
            {
                ScriptManager.RegisterStartupScript(this, GetType(), "Popup", "successalert('" + "Operation successful!" + "','Success','VisitPlannedApprovalList.aspx');", true);
    ...
    protected void loadGridView_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName == "EditData")
        {
            ...
            System.Web.UI.ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "openModal", "window.open('../DoctorVisit_UI/DoctorPlanDetailsView.aspx?id=" + unitPriceId + "' ,'_blank');", true);
