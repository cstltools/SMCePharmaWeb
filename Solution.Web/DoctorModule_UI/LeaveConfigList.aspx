<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/NewMasterPage.master" AutoEventWireup="true" CodeFile="LeaveConfigList.aspx.cs" Inherits="DoctorModule_UI_LeaveConfigList" %>
 ...
 <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3"><i class="bx bx-customize"></i>  Leave Configuration List</div>
                
                <div class="ms-auto">
                    <div class="btn-group">
                        <a href="../DoctorModule_UI/LeaveConfig.aspx"  class="btn btn-sm btn-outline-info " ><i class="fa fa-plus" aria-hidden="true"></i> New Entry</a>
...
<script type="text/javascript">
    function un(o) {
        ...
        function GetDegree() {
            var urlpath = 'LeaveConfigList.aspx/GetLeaveConfigList';
            $.ajax({
                url: urlpath,
                dataType: 'json',
                ...
                success: function(data) {
                    ...
                    for (var i = 0; i < result.length; i++) {
                        ...
                        row += "<tr>";
                        row += "<td>" + (i + 1) + "</td>";
                        row += "<td>" + un(result[i].LeaveName) + "</td>";
                       ...
                       if (result[i].IsActive) {
                        ...
                        row += "<td><button class='btn-outline-warning btn-xs mb-1 mb-md-0'   type='button'  onclick='editClick(" + result[i].LeaveConfigId + ")'><i class='bx bxs-edit' aria-hidden='true'></i></button> </td>";
        ...
        function editClick(id) {
            ...
            window.location.href = '../DoctorModule_UI/LeaveConfig.aspx?id=' + id + '';
