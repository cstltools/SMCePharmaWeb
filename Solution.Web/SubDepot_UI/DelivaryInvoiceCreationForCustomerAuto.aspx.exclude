<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MainMasterPage.master" AutoEventWireup="true" CodeFile="DelivaryInvoiceCreationForCustomerAuto.aspx.cs" Inherits="SubDepot_UI_DelivaryInvoiceCreationForCustomerAuto" %>
                    ...
                    <tr>
                        <td class="TDLeft" width="13%" colspan="6">
                            <asp:GridView ID="gridLineItemGridView" runat="server" 
                                ...
                                DataKeyNames="InvoiceDetailId,SubDCStoreId,Campaign">
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Reason">
                                        <ItemTemplate>
                                            <asp:DropDownList ID="reasonReturnDropDownList" runat="server" CssClass="TextBoxMini" Enabled="False">
                                            </asp:DropDownList>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
                      ...
                      <tr id="Tr1" runat="server" Visible="False">
                        ...
                        <td class="TDLeft" width="13%">
                            TP Total</td>
                        <td class="TDRight" width="20%">
                            <asp:TextBox ID="campaignTPTextBox1" runat="server" CssClass="TextBox" 
                                ReadOnly="True"></asp:TextBox>
                        </td>
                        <td class="TDLeft" width="13%">
                            &nbsp;</td>
