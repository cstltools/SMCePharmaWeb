...
public partial class SubDepot_UI_SubDeportStockReport : System.Web.UI.Page
{
    ...
    {
        RequisitionBLL aRequisitionBll = new RequisitionBLL();
        aRequisitionBll.SubdeportLoad(subdeportDropDownList1, dcDropDownList1.SelectedValue);
    }
    protected void viewRptButton_Click(object sender, EventArgs e)
    {
      //  if (nationalCheckBox.Checked == true)
      //  {
            Session["SalescenterID"] = "";
            Session["SubdeportID"] = "";


            Session["SalescenterID"] = dcDropDownList1.SelectedValue;
            Session["SubdeportID"] = subdeportDropDownList1.SelectedValue;


            string ComUnitId = dcDropDownList1.SelectedValue;

            string url = "../SInventory_RPTVIEW/SubDeportStockReportViewer.aspx?comUnitId=" + ComUnitId;
