...
public partial class SubDepot_UI_StockTransferDcToSubDepot : System.Web.UI.Page
{
    ...
    {
        DataTable dtdata = aChalanBll.GetProductDcStoreSubdeport(productDropDownList.SelectedValue, fromComUnitCodeTextBox.Text);
    ...
    {
        Response.Redirect("StockTransferDcToSubDepot.aspx");
    }
}