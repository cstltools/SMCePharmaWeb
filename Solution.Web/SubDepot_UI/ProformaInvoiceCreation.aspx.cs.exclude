...
public partial class SubDepot_UI_ProformaInvoiceCreation : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            if (Session["OrderId"] !=null)
            {
                ...
                SubdepotHiddenField.Value = Session["SubDepotId"].ToString();
                LoadAllDataByOrder(Session["OrderId"].ToString());
                CustomerCreditAmount();
                Session["OrderId"] = null;
                DataTable dtwar = aInvoiceBll.GetWarning(hdCustomerMasterId.Value);
    ...
    public bool OrderExists(string orderId)
    {
     //   OrderInfoBLL aOrderInfoBll = new OrderInfoBLL();
        ...
        aTable = aInvoiceBll.LoadOrderExistsBll(orderId);
    ...
    private bool Actifast()
    {
        ...
        else
        {
            for (int i = 0; i < gridLineItemGridView.Rows.Count; i++)
            {
                ...
                if (ProductCode == "AID0722" && Qty >= 37777)
                {
                    return true;
                }
            }
    ...
    private bool FlexidolFOC()
    {
        ...
        else
        {
            for (int i = 0; i < gridLineItemGridView.Rows.Count; i++)
            {
                ...
                int Qty =
                    Convert.ToInt32(((TextBox)gridLineItemGridView.Rows[i].Cells[1].FindControl("qtyTextBox")).Text);
                if (ProductCode == "AID7201" && Qty >= 47777)
                {
                    return true;
                }
            }
    ...
    private bool Prazomax()
    {
        ...
        else
        {
            for (int i = 0; i < gridLineItemGridView.Rows.Count; i++)
            {
                ...
                int Qty =
                    Convert.ToInt32(((TextBox)gridLineItemGridView.Rows[i].Cells[1].FindControl("qtyTextBox")).Text);
                if (ProductCode == "AR77D04" && Qty >= 47777)
                {
                    return true;
                }
            }
    ...
    private bool Esomium()
    {
        ...
        else
        {
            for (int i = 0; i < gridLineItemGridView.Rows.Count; i++)
            {
                ...
                int Qty =
                    Convert.ToInt32(((TextBox)gridLineItemGridView.Rows[i].Cells[1].FindControl("qtyTextBox")).Text);
                if (ProductCode == "AR2D02" && Qty >= 33333334)
                {
                    return true;
                }
            }
    ...
    private bool EzeventFOC()
    {
        ...
        else
        {
            for (int i = 0; i < gridLineItemGridView.Rows.Count; i++)
            {
                ...
                if (ProductCode == "OAD202" && Qty >= 99999910)
                {
                    return true;
                }
            }
    ...
    private bool CefimaxFOC()
    {
        ...
        else
        {
            for (int i = 0; i < gridLineItemGridView.Rows.Count; i++)
            {
                string ProductCode = ((TextBox)gridLineItemGridView.Rows[i].Cells[1].FindControl("codeTextBox")).Text;
                int Qty = Convert.ToInt32(((TextBox)gridLineItemGridView.Rows[i].Cells[1].FindControl("qtyTextBox")).Text);
                if (ProductCode == "ANB205" && Qty >= 55555554)
                {
                    return true;
                }
            }
    ...
    private bool CiprodylFOC()
    {
        ...
        else
        {
            for (int i = 0; i < gridLineItemGridView.Rows.Count; i++)
            {
                string ProductCode = ((TextBox)gridLineItemGridView.Rows[i].Cells[1].FindControl("codeTextBox")).Text;
                int Qty = Convert.ToInt32(((TextBox)gridLineItemGridView.Rows[i].Cells[1].FindControl("qtyTextBox")).Text);
                if (ProductCode == "ANB208" && Qty >= 55555554)
                {
                    return true;
                }
            }
        ...
        for (int i = 0; i < aTable.Rows.Count; i++)
        {
            ...
            ((HiddenField)gridLineItemGridView.Rows[i].Cells[10].FindControl("CampaignTypeHiddenField")).Value =
               aTable.Rows[i]["CampaignName"].ToString();
                ...
                //        if (Actifast() == true && ProductCode1 == "AID02")
                //        {
                //            totalprice -=
                //                Convert.ToDecimal(
                //                    ((TextBox)gridLineItemGridView.Rows[i].FindControl("tpTextBox")).Text);
                ...
                //        if (Prazomax() == true && ProductCode1 == "ARD04")
                //        {
                //            totalprice -=
                //                Convert.ToDecimal(
                //                    ((TextBox)gridLineItemGridView.Rows[i].FindControl("tpTextBox")).Text);
                ...
                //        if (FlexidolFOC() == true && ProductCode1 == "AID01")
                //        {
                //            totalprice -=
                //                Convert.ToDecimal(
                //                    ((TextBox)gridLineItemGridView.Rows[i].FindControl("tpTextBox")).Text);
                ...
                //        if (Ezepain() == true && ProductCode1 == "AID04")
                //        {
                //            totalprice -=
                //                Convert.ToDecimal(
                //                    ((TextBox)gridLineItemGridView.Rows[i].FindControl("tpTextBox")).Text);
                ...
                //        if (Moticare() == true && ProductCode1 == "FGD02")
                //        {
                //            totalprice -=
                //                Convert.ToDecimal(
                //                    ((TextBox)gridLineItemGridView.Rows[i].FindControl("tpTextBox")).Text);
                ...
                //        if (MaxiventFOC() == true && ProductCode1 == "OAD04")
                //        {
                //            totalprice -=
                //                Convert.ToDecimal(
                //                    ((TextBox)gridLineItemGridView.Rows[i].FindControl("tpTextBox")).Text);
                ...
                //        if (SeacoralDTablet() == true && ProductCode1 == "MNS03")
                //        {
                //            totalprice -=
                //                Convert.ToDecimal(
                //                    ((TextBox)gridLineItemGridView.Rows[i].FindControl("tpTextBox")).Text);
                ...
                //        if (CiprodylFOC() == true && ProductCode1 == "ANB08")
                //        {
                //            totalprice -=
                //                Convert.ToDecimal(
                //                    ((TextBox)gridLineItemGridView.Rows[i].FindControl("tpTextBox")).Text);
                ...
                //        if (Nervaid75mgCapsuleFOC() == true && ProductCode1 == "AEL02")
                //        {
                //            totalprice -=
                //                Convert.ToDecimal(
                //                    ((TextBox)gridLineItemGridView.Rows[i].FindControl("tpTextBox")).Text);
                ...
                //    }
                //}
                //if (ChkProductOfferPrazomax20mgcapsule() == true)
                //{
                //    for (int i = 0; i < gridLineItemGridView.Rows.Count; i++)
                //    {
                //        string ProductCode1 =
                ...
                //        if (ChkProductOfferPrazomax20mgcapsule() == true && ProductCode1 == "MNS03")
                //        {
                //            totalprice -=
                //                Convert.ToDecimal(
                //                    ((TextBox)gridLineItemGridView.Rows[i].FindControl("tpTextBox")).Text);
                ...
                //        if (EzeventFOC() == true && ProductCode1 == "OAD02")
                //        {
                //            totalprice -=
                //                Convert.ToDecimal(
                //                    ((TextBox)gridLineItemGridView.Rows[i].FindControl("tpTextBox")).Text);
                ...
                //        if (ActifastFOC() == true && ProductCode1 == "AID02")
                //        {
                //            totalprice -=
                //                Convert.ToDecimal(
                //                    ((TextBox)gridLineItemGridView.Rows[i].FindControl("tpTextBox")).Text);
                ...
                //        if (EzepainFOC() == true && ProductCode1 == "AID04")
                //        {
                //            totalprice -=
                //                Convert.ToDecimal(
                //                    ((TextBox)gridLineItemGridView.Rows[i].FindControl("tpTextBox")).Text);
                ...
                if (aTable.Rows[0]["CustomerCode"].ToString() == "158399")
                {
                    percentage = 0;
                }
                ...
                else if (aTable.Rows[0]["CustomerType"].ToString() == "NCOD")
                {
                    for (int i = 0; i < gridLineItemGridView.Rows.Count; i++)
                    {
                        if (aTable.Rows[i]["ProductCode"].ToString() == "ARD02" || aTable.Rows[i]["ProductCode"].ToString() == "MNS03")
                        {
                            percentage = 0;
                        }
                        else
        ...
        for (int i = 0; i < gridLineItemGridView.Rows.Count; i++)
        {
           // ((TextBox) gridLineItemGridView.Rows[i].Cells[10].FindControl("sdTextBox")).Text = "0.00";
            ...
            if (cstock < tqty)
            {
                ...
                //if (cstock != 0)
                {
                  //  showMessageBox("Stock Not Available");
    ...
    private void GetDiscounttotalValue()
    {
        ...
        for (int i = 0; i < gridLineItemGridView.Rows.Count; i++)
        {
            ...
            //if (((TextBox) gridLineItemGridView.Rows[i].Cells[1].FindControl("codeTextBox")).Text == "AEL02" && tqty >= 3)
            //{
            //    disTotal = 0;
    ...
    protected void addImageButton_Click(object sender, ImageClickEventArgs e)
    {
        ...
        aDataTable2 = aInvoiceBll.ProductInfo(SubdepotHiddenField.Value, "AEL02");
        ...
        dataRow["ProductName"] = "Nervaid 75mg Capsule:3 X 10s ";
        dataRow["StockQty"] = cs;
        dataRow["UnitPrice"] = "0";
        dataRow["UnitVAT"] = "0";
    ...
    protected void addImageButton_Click2(object sender, ImageClickEventArgs e)
    {
        ...
        decimal cs = 0;
        DataTable aDataTable2 = new DataTable();
        aDataTable2 = aInvoiceBll.ProductInfo(SubdepotHiddenField.Value, "FGD02");
        ...
        dataRow["ProductName"] = "Moticare 10mg :10 X 10s ";
        dataRow["StockQty"] = cs;
        dataRow["UnitPrice"] = "0";
        dataRow["UnitVAT"] = "0";
    ...
    protected void addImageButton_Click3(object sender, ImageClickEventArgs e)
    {
        ...
        decimal cs = 0;
        DataTable aDataTable2 = new DataTable();
        aDataTable2 = aInvoiceBll.ProductInfo(SubdepotHiddenField.Value, "OAD04");
    ...
    protected void addImageButton_Click4(object sender, ImageClickEventArgs e)
    {
        ...
        decimal cs = 0;
        DataTable aDataTable2 = new DataTable();
        aDataTable2 = aInvoiceBll.ProductInfo(SubdepotHiddenField.Value, "AID04");
    ...
    protected void addImageButton_Click5(object sender, ImageClickEventArgs e)
    {
        ...
        decimal cs = 0;
        DataTable aDataTable2 = new DataTable();
        aDataTable2 = aInvoiceBll.ProductInfo(SubdepotHiddenField.Value, "MNS03");
    ...
    protected void addImageButton_Click6(object sender, ImageClickEventArgs e)
    {
        ...
        decimal cs = 0;
        DataTable aDataTable2 = new DataTable();
        aDataTable2 = aInvoiceBll.ProductInfo(SubdepotHiddenField.Value, "AID02");
        ...
        dataRow["SL"] = Convert.ToString(sl + 1);
        dataRow["ProductCode"] = "AID02";
        dataRow["ProductName"] = "Actifast Tablet~10mg:3 X 10s ";
        dataRow["StockQty"] = cs;
        dataRow["UnitPrice"] = "0";
        dataRow["UnitVAT"] = "0";
    ...
    private void GetProduct(int rowindex, string productCode)
    {
        ...
        if (!string.IsNullOrEmpty(productCode))
        {
            ...
            {
                aDataTable = aInvoiceBll.ProductInfo(SubdepotHiddenField.Value, productCode);
    ...
    private bool SaveInvoiceDetail(int invoiceId)
    {
        ...
        if (gridLineItemGridView.Rows.Count>0)
        {
            ...
            aInvoiceBll.SaveInvoiceDetails(aInvoiceDetailsList, SubdepotHiddenField.Value);
        }
    ...
    private int SaveInvoice()
    {
        ...
        Invoice aInvoice = new Invoice();
                              // {
                                   ...
                                   aInvoice.TpGrandTotal=Convert.ToDecimal(rcvAmountTextBox.Text.Trim());
                                   ...
                                   aInvoice.SubDepotId = Convert.ToInt32(SubdepotHiddenField.Value);
                                   //else
                                   //{
    ...
    {
        string url = "../SInventory_RPTVIEW/SubDeportInvoiceReportViewer.aspx?InvNo=" + Server.UrlEncode(invTextBox.Text.Trim());
