...
public partial class SubDepot_UI_DelivaryInvoiceCreationForCustomerAuto : System.Web.UI.Page
{
    //Git Checking // 2nd time Checking
    private RequisitionBLL aRequisitionBll = new RequisitionBLL();
    private Sub_InvoiceBLL aInvoiceBll = new Sub_InvoiceBLL();
    ...
    public void LoadInvoice(string invoiceId)
    {
        ...
        DataTable dtinvoice = aOrderInfoBll.SubLoadInvoice(invoiceId);
    ...
    private void InitialGrid()
    {
        ...
        aDataTable.Columns.Add("TotalQty"); aDataTable.Columns.Add("Campaign");
        DataRow dataRow;
    ...
    private bool SaveInvoiceDetail(int invoiceId)
    {
        ...
        if (gridLineItemGridView.Rows.Count > 0)
        {
            for (int i = 0; i < gridLineItemGridView.Rows.Count; i++)
            {
                ...
                DataTable dtdcinfo = aInvoiceBll.DCInfoWithDCId(gridLineItemGridView.DataKeys[i]["SubDCStoreId"].ToString());
                if (dtdcinfo.Rows.Count > 0)
                {
                    DCStockNew aDcStockNew = new DCStockNew();
                    {
                        ...
                        if (!string.IsNullOrEmpty(dtdcinfo.Rows[0]["SChalanDetailsId"].ToString()))
                        {
                            aDcStockNew.ChalanDetailsId = Convert.ToInt32(dtdcinfo.Rows[0]["SChalanDetailsId"].ToString());
                        }
                    };
    ...
    {
        string url = "../SInventory_RPTVIEW/SubDeportDelivaryInvoiceReturnViewer.aspx.aspx?InvNo=" +
...

        {
            for (int i = 0; i < gridLineItemGridView.Rows.Count; i++)
            {
                ...
                if (delqty <= mainqty)
                {
                    ...
                    decimal totalprice2 = Convert.ToDecimal(campaignTPTextBox1.Text);
                    ...
                    dtcAMPAIGN = aOrderInfoBll.LoadCampaignsub(invoiceNoHiddenField.Value);
                    DataTable dtOffer = new DataTable();
                    dtOffer = aOrderInfoBll.subLoadOffer(invoiceNoHiddenField.Value);
                    ...
                    DataTable dtFixedCustomer =
                        aOrderInfoBll.SubDeportGetFixedCustomerfromInvoiceTable(invoiceHiddenField.Value);
                    if (Convert.ToBoolean(dtFixedCustomer.Rows[0]["FixedCustomer"]) == true)
                    {
                        //2
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            //1
                            DataTable dttradepolicy = aOrderInfoBll.GetTradeTerm(totalprice2.ToString());
                            if (dttradepolicy.Rows.Count > 0)
                            {
                                //if (dtcAMPAIGN.Rows[i]["Campaign"].ToString() == "Bonus Campaign" ||
                                //    dtcAMPAIGN.Rows[i]["Campaign"].ToString() == "Sales Campaign")
                                //{
                                //    percentage = 0;
                                //}
                                //else
                    ...
                    else if (gridLineItemGridView.DataKeys[i]["Campaign"].ToString() == "Bonus Campaign" ||
                        // dtcAMPAIGN.Rows[i]["Campaign"].ToString() == "Bonus Campaign" 
                      gridLineItemGridView.DataKeys[i]["Campaign"].ToString() == "Sales Campaign"
                            )
                    {
                        if (gridLineItemGridView.DataKeys[i]["Campaign"].ToString() == "Bonus Campaign" ||
                            // dtcAMPAIGN.Rows[i]["Campaign"].ToString() == "Bonus Campaign" 
                           gridLineItemGridView.DataKeys[i]["Campaign"].ToString() == "Sales Campaign"
                                 )
                        {
                            ...
                            //if (X > 0)
                            {
                                ((TextBox)gridLineItemGridView.Rows[i].Cells[1].FindControl("dpTextBox")).Text = "0";
                                ((TextBox)gridLineItemGridView.Rows[i].Cells[1].FindControl("dpAmtTextBox")).Text = "0";
                                decimal vat = 0;
                                vat = Convert.ToDecimal(dtproductvat.Rows[0]["VATPercentage"].ToString());
                                ((TextBox)gridLineItemGridView.Rows[i].Cells[10].FindControl("sdTextBox")).Text =
                                    (Convert.ToDecimal(
                    ...
                    else if (dtOffer.Rows[0]["ProductOffer"].ToString() == "Moticare10mgFOCnew")
                    {
                        if (((TextBox)gridLineItemGridView.Rows[i].Cells[1].FindControl("codeTextBox")).Text == "FGD02")
                        {
                            Decimal X = Convert.ToDecimal(((TextBox)gridLineItemGridView.Rows[i].Cells[7].FindControl("tpTextBox")).Text.Trim());
                    ...
                    else if (dtOffer.Rows[0]["ProductOffer"].ToString() == "FlexidolFOC")
                    {
                        if (((TextBox)gridLineItemGridView.Rows[i].Cells[1].FindControl("codeTextBox")).Text == "AID01")
                        {
                            Decimal X = Convert.ToDecimal(((TextBox)gridLineItemGridView.Rows[i].Cells[7].FindControl("tpTextBox")).Text.Trim());
                    ...
                    else if (dtOffer.Rows[0]["ProductOffer"].ToString() == "FOC")
                    {
                        if (((TextBox)gridLineItemGridView.Rows[i].Cells[1].FindControl("codeTextBox")).Text == "ARD01")
                        {
                            Decimal X = Convert.ToDecimal(((TextBox)gridLineItemGridView.Rows[i].Cells[7].FindControl("tpTextBox")).Text.Trim());
                            if (X > 0)
                            {
