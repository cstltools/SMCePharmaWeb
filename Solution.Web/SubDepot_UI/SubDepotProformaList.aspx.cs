...
public partial class SubDepot_UI_SubDepotProformaList : System.Web.UI.Page
{
    ...
    protected void SearchButton_Click(object sender, EventArgs e)
    {
        if (dcDropDownList1.SelectedValue != "" && manufacturerDropDownList.SelectedValue != "" && MarketDropDownList1.SelectedValue != "" && InvoiceDateTextBox.Text.Trim() != "")
        {
            ...
            dt = aStockConditionFreezeBll.LoadInvoiceSubdeport(GenerateParameterForInvoiceLoad());
    ...
    protected void gotoinvoiceButton_Click(object sender, EventArgs e)
    {
        ...
        string url = "../SInventory_RPTVIEW/SubDeportInvoicePrintReportViewer.aspx";
    ...
    {
        Response.Redirect("SubDepotProformaList.aspx");
    }
}