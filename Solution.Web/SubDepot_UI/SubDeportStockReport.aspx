<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MainMasterPage.master" AutoEventWireup="true" CodeFile="SubDeportStockReport.aspx.cs" Inherits="SubDepot_UI_SubDeportStockReport" %>
                ...
                <td class="TDRight" width="20%">
                    &nbsp;</td>
                     ...
                     <tr runat="server" Visible="False">
                        ...
                        <td class="TDRight" width="20%">
                             <asp:CheckBox ID="nationalCheckBox" runat="server" Enabled="False" AutoPostBack="True" oncheckedchanged="nationalCheckBox_CheckedChanged"
                                 />
                        </td>
                        <td class="TDLeft" width="13%">
                            &nbsp;
                    ...
                    <tr>
                        ...
                        <td width="20%" class="TDRight">
                            &nbsp;
                          <%--  <asp:Button ID="reportButton" CssClass="button-padding-right " runat="server" OnClick="reportButton_OnClick" 
                                Text="View Report" />--%>  
