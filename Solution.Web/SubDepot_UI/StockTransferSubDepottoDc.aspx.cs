...
public partial class SubDepot_UI_StockTransferSubDepottoDc : System.Web.UI.Page
{
    RequisitionBLL aRequisitionBll = new RequisitionBLL();
    SubDepotChalanReturnBLL aChalanBll = new SubDepotChalanReturnBLL();
    ...
    {
        DataTable dtdata = aChalanBll.GetProductDcStoreSubdeport(productDropDownList.SelectedValue, toComUnitNameTextBox.Text);
    ...
    protected void addButton_Click(object sender, EventArgs e)
    {
        ...
        for (int i = 0; i < chalanGridView.Rows.Count; i++)
        {
            ...
            dataRow["SubDCStoreId"] = chalanGridView.DataKeys[i][0].ToString();
