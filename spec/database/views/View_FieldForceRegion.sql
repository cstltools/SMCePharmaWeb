...
CREATE VIEW [dbo].[View_FieldForceRegion]
AS
SELECT        RGN.RegionId, RGN.RegionName, RGN.GroupId, NSM.EmpMasterCode AS NSMCode, RSM.EmpMasterCode AS RSMCode, ASM.EmpMasterCode AS ASMCode, MIO.EmpMasterCode AS MIOCode
