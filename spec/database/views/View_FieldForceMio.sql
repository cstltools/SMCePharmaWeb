...
CREATE VIEW [dbo].[View_FieldForceMio]
AS
SELECT        MIO.MIOId, MIO.TerritoryId, MIO.EmpName AS MIOName, NSM.EmpMasterCode AS NSMCode, RSM.EmpMasterCode AS RSMCode, ASM.EmpMasterCode AS ASMCode, MIO.EmpMasterCode AS MIOCode, 
