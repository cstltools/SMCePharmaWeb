CREATE VIEW dbo.View_EpharmaSales2022April
AS
...
WHERE  (dbo.tblInvoice.UpdateDate BETWEEN '1-april-2022' AND '31-dec-2022') AND (dbo.tblInvoice.DelivaryInvoiceNo IS NOT NULL) AND (dbo.tblInvoiceDetail.DeliveryStatus IN ('Full', 'Partial'))
