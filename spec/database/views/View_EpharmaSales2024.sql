CREATE VIEW dbo.View_EpharmaSales2024
AS
...
WHERE  (dbo.tblInvoice.UpdateDate BETWEEN '1-jan-2024' AND '31-dec-2024') AND (dbo.tblInvoice.DelivaryInvoiceNo IS NOT NULL) AND (dbo.tblInvoiceDetail.DeliveryStatus IN ('Full', 'Partial'))
