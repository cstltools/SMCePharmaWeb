 ...
 CREATE PROCEDURE [dbo].[sp_GET_CampaignDetailMarket_ById]
...
AS
	...
	select  dtl.*, gr.GroupName GroupName,rg.RegionName  RegionName, ar.AreaName AreaName,tr.TerritoryName TerritoryName, subtr.SubTerritoryName SubTerritoryName,mar.MarketName MarketName  from [dbo].tbl_BonusCampaignMarketDetail dtl with (nolock)
