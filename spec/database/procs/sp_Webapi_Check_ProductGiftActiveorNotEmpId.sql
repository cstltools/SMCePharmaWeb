...
create PROCEDURE [dbo].[sp_Webapi_Check_ProductGiftActiveorNotEmpId]
...
WHERE C.ProductGroupId=3 AND C.IsActive=1      AND MKT.IsActive=1  AND tr.IsActive=1  AND terry.IsActive=1  AND ar.IsActive=1    AND rg.IsActive=1    AND gp.IsActive=1  and  C.ProductId='+@ProductId
 --and DC.ComUnitId=12
