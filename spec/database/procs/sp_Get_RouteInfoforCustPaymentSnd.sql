create PROCEDURE [dbo].[sp_Get_RouteInfoforCustPaymentSnd]
...
where      PaymentInvoiceNo  IS NOT NULL  and  SndReturnInvoiceNo is  not  null and ord.DistributionRoute_Ord is not null  and ( PaymentStatus is null or PaymentStatus= 'Partial') 
