CREATE PROCEDURE [dbo].[sp_Get_ProformaInvoiceReportList]
	-- Add the parameters for the stored procedure here
	@Parm nvarchar(max)
AS
BEGIN
   
   DECLARE @Q NVARCHAR(MAX)='SELECT mas.paymenttype, mas.SMCType_Ord,  pt. ProgramTypeName as Type, ct.CustomerType   IntransitDay,  isnull(ID.AdjustmentAmount,0) AdjustmentAmount, ID.NetAmount as TotalNetPayable,
