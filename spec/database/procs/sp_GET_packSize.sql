...
CREATE PROCEDURE [dbo].[sp_GET_packSize]
...
AS
	...
	--	WHERE DeptId IS NOT NULL' + @Parameter
		...
		SET @Query = 'SELECT
		 DPT.PackSizeId,DPT.PackSizeCode,DPT.PackSizeName,DPT.IsActive, CASE  WHEN  Entryemp.EmpName Is Null  THEN  us.UserName 
		...
		WHERE DPT.PackSizeId IS NOT NULL' + @Parameter
