CREATE PROCEDURE [dbo].[sp_GET_DZSMwiseReportParam] 
...
((ISNULL(tblC.SumofNetSalesAmount,0))- ((ISNULL(tblFixed.SumofNetSalesAmount,0))+(ISNULL(tblCamp.SumofNetSalesAmount,0) )) )FinalSales,
...
-- (ISNULL(tblDelGreenCov.CustomerCoverPer,0)+ISNULL(tblDelGreenCovSub.CustomerCoverPer,0)) DelgreenCov 
  ...
  0 as CustomerCoverPer ,0 as CustomerCoverPerProforma,
  ...
  (ISNULL(tblProgrmaGrD.CustomerCoverPer,0)+ISNULL(tblDelGreenCov.CustomerCoverPer,0)+ISNULL(tblDelGreenCovSub.CustomerCoverPer,0)) AS DelgreenCov
