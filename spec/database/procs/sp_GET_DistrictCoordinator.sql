...
Create PROCEDURE [dbo].[sp_GET_DistrictCoordinator]
...
AS
	...
	DECLARE @Query NVARCHAR(MAX)
		...
		SET @Query = 'SELECT
		DPT.DistCoordinatorCode,DPT.DistCoordinatorId,DV.DivisionName,DT.DistrictName,DC.EmpName,CASE  WHEN  Entryemp.EmpName Is Null  THEN  us.UserName 
		...
		DPT.IsActive
		FROM tblDistrictCoordinator AS DPT 
		...
		WHERE DistCoordinatorId IS NOT NULL ' + @Parameter
