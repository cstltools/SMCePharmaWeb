CREATE PROCEDURE [dbo].[sp_RPT_MIS_BusinessSummary_Acc] 
...
isnull(tblOldRtnPrior.PreviousPay,0) PriorPeriodSales	,
 --isnull(tblPriorSale.SalesGrossAmt,0) + 
  ...
  -----------tttt
 ((isnull(tblSale.SalesAmtTP,0)+  isnull(tblOldRtn.ReturnAmountTP,0))-((isnull(tblRtn.ReturnAmountTP,0) +  isnull(tblOldRtn.ReturnAmountTP,0)) +(isnull(JustSalesDiscount,0))))- isnull(tbl2Rtn.TP,0) JustSalesAmtTP,
...
--Return
(isnull(tblRtn.ReturnAmountTP,0) +  isnull(tblOldRtn.ReturnAmountTP,0)) +(isnull(JustSalesDiscount,0))+isnull(tbl2Rtn.TP,0) ReturnAmountTP, 
isnull(tblRtn.ReturnAmountVat,0)+isnull(tblOldRtn.ReturnAmountVat,0)+isnull(tbl2Rtn.vat,0) ReturnAmountVat,
isnull(tblRtn.ReturnGrossAmt,0)+isnull(tblOldRtn.ReturnGrossAmt,0)+isnull(tbl2Rtn.gross,0) ReturnGrossAmt,
--Sales
