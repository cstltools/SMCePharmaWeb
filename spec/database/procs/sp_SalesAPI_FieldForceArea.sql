CREATE PROCEDURE [dbo].[sp_SalesAPI_FieldForceArea]
...
AS
    BEGIN
			...
			SET @Query = 'SELECT DISTINCT ARA.AreaId,ARA.AreaName,ARA.RegionId FROM View_FieldForceArea AS ARA WHERE ARA.AreaId IS NOT NULL ' + @Parrameter
