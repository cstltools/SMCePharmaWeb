create PROCEDURE [dbo].[sp_webapi_SaveOrderDetail_Temp]
...
AS
    BEGIN
		...
		SELECT @unitvatPercentage=VATPercentage,@vatAmtPerUnit=VATAmountPerUnit FROM dbo.tblUnitPrice WHERE ProductId=@productid AND IsActive=1
