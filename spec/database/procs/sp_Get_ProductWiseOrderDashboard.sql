...
CREATE
 ...
 PROCEDURE [dbo].[sp_Get_ProductWiseOrderDashboard]
...
BEGIN 
    ...
    DECLARE @Q NVARCHAR(MAX)='SELECT pro.ProductCode AS Criteria,floor(ISNULL(SUM(ID.TotalPrice-ID.DiscountAmount) - sum(ISNULL(ID.AdjustmentAmount,0))
