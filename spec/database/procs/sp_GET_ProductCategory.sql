...
CREATE PROCEDURE [dbo].[sp_GET_ProductCategory]
...
AS
	...
	--	WHERE DeptId IS NOT NULL' + @Parameter
		...
		SET @Query = 'SELECT PC.ProductCategoryId,PC.ProductCategory ,PC.ProductCategoryCode,CASE  WHEN  Entryemp.EmpName Is Null  THEN  us.UserName 
		...
		WHERE PC.ProductCategoryId IS NOT NULL' + @Parameter
