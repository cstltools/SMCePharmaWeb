...
AS
	...
	--	WHERE DeptId IS NOT NULL' + @Parameter
		...
		SET @Query = 'SELECT
		 DPT.ProductTypeId,DPT.ProductTypeCode,DPT.ProductTypeName,DPT.IsActive, CASE  WHEN  Entryemp.EmpName Is Null  THEN  us.UserName 
		...
		WHERE DPT.ProductTypeId IS NOT NULL' + @Parameter
