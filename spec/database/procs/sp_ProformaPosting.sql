...
-- =============================================
CREATE PROCEDURE [dbo].[sp_ProformaPosting] 
...
BEGIN
	...
	(   
	    ...
	    'Proforma Invoice ( Invoice No:' + @InvoiceNo + ' , Invoice Date:' + CONVERT(NVARCHAR(50), @InvDate, 101) + ', Stock Value:' + CONVERT(NVARCHAR(50), @CostPrice) + ')',       -- Narration - nvarchar(max)
