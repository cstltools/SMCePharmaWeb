...
-- =============================================
create PROCEDURE [dbo].[sp_Get_EmployeeMIOEditID]
...
BEGIN
   ...
   WHERE MIO.IsActive = 1 ) 
    ...
    UNION ALL SELECT DISTINCT NSM.EmployeeId EmpInfoId,emp.EmpMasterCode + ' : ' + emp.EmpName AS EmployeeName FROM tblMIOInfo AS NSM
