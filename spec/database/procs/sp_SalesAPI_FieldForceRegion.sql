CREATE PROCEDURE [dbo].[sp_SalesAPI_FieldForceRegion]
...
AS
    BEGIN
			...
			SET @Query = 'SELECT DISTINCT RGN.RegionId,RGN.RegionName,RGn.GroupId FROM View_FieldForceRegion AS RGN WHERE RGN.RegionId IS NOT NULL ' + @Parrameter
