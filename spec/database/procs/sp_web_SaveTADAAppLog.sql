...
CREATE PROCEDURE [dbo].[sp_web_SaveTADAAppLog]  --[dbo].[sp_webapi_SaveOrderMaster] 'shaon20','20245','11/25/2020 5:04:16 PM'
    @TADAApprovalId INT ,
...
AS
	...
	SELECT @Countdata=COUNT(*) FROM dbo.tblTADAApprovalLog WHERE FromEmpId=@FromEmpId AND TableId=@TableId and Status=@Status
