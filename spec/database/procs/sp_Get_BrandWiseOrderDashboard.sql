...
CREATE
 ...
 PROCEDURE [dbo].[sp_Get_BrandWiseOrderDashboard]
...
BEGIN 
    ...
    DECLARE @Q NVARCHAR(MAX)='SELECT probr.ProductSQName AS Criteria,floor(ISNULL(SUM(ID.TotalPrice-ID.DiscountAmount) - sum(ISNULL(ID.AdjustmentAmount,0))
