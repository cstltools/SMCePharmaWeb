...
BEGIN
 ...
 set @FromDate=  format(DATEADD(mm, DATEDIFF(m,0,GETDATE()),0),'dd MMMM, yyyy')
	...
	--set @FromDate=  format(DATEADD(mm, DATEDIFF(m,0,'01-Aug-2022'),0),'dd MMMM, yyyy')
 
	--set @toDate=format(cast(DATEADD(s,-1,DATEADD(mm, DATEDIFF(m,0,'01-Aug-2022')+1,0)) as date),'dd MMMM, yyyy')
