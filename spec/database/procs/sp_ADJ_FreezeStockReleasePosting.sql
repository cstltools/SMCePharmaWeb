...
-- =============================================
CREATE PROCEDURE [dbo].[sp_ADJ_FreezeStockReleasePosting] 
...
BEGIN
	...
	SELECT DFZS.DCStoreFreezeId,UNT.CompanyId,CTRS.UnitPrice,DFZS.TotalQuantity FROM dbo.tblDCStoreFreeze AS DFZS 
	...
	INTO @DCFreezeId,@CompanyId,@CostPrice,@TotalQuantity
