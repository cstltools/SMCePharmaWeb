...
CREATE
 ...
 PROCEDURE [dbo].[sp_Get_ProductWiseOrderPaymentDashboard]
...
BEGIN 
    ...
    DECLARE @Q NVARCHAR(MAX)='SELECT pro.ProductCode AS Criteria,iSNULL(SUM(ID.DeliveryTotalPrice-ID.DeliveryDiscountAmount) - sum(ISNULL(ID.AdjustmentAmount,0))
