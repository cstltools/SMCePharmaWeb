...
-- =============================================
create PROCEDURE [dbo].[sp_Get_EmployeeNSMditID]
...
BEGIN
   ...
   WHERE MIO.IsActive = 1 ) 
    ...
    UNION ALL SELECT DISTINCT NSM.EmployeeId EmpInfoId,emp.EmpMasterCode + ' : ' + emp.EmpName AS EmployeeName FROM tblNSMInfo AS NSM
