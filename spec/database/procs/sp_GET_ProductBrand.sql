CREATE PROCEDURE [dbo].[sp_GET_ProductBrand]
...
AS
	...
	--	WHERE DeptId IS NOT NULL' + @Parameter
		...
		SET @Query = 'SELECT
		 DPT.ProductBrandId,DPT.ProductBrandCode,DPT.ProductBrandName,DPT.IsActive, CASE  WHEN  Entryemp.EmpName Is Null  THEN  us.UserName 
		...
		WHERE DPT.ProductBrandId IS NOT NULL
' + @Parameter
