CREATE PROCEDURE [dbo].[sp_SInventory_DynamicMISReportTP]
...
BEGIN
    ...
    BEGIN
        ...
        (
            ...
            (
                SELECT
                    ord.TerritoryId,
                    CONVERT(DECIMAL(18,2), ISNULL(SUM(ID.DeliveryNetAmount - ID.DeliveryTotalPriceVatAmount), 0)) AS InvoiceAMT
            ...
            (
                SELECT
                    ord.TerritoryId,
                    ISNULL(SUM(cstp.TPAmount), 0) AS CollectionAMT
    ...
    BEGIN
        ...
        SELECT
            ...
            CONVERT(DECIMAL(18,2), ISNULL(SUM(ID.DeliveryNetAmount - ID.DeliveryTotalPriceVatAmount), 0)) AS InvoiceValue
        FROM dbo.tblInvoice A WITH (NOLOCK)
        INNER JOIN dbo.tblOrder ord WITH (NOLOCK)
            ON ord.OrderId = A.OrderId
        ...
        SELECT
            ...
            CONVERT(DECIMAL(18,2), ISNULL(SUM(cstp.TPAmount), 0)) AS InvoiceCollection
        FROM dbo.tblCustPayDetail cstp WITH (NOLOCK)
    ...
    BEGIN
        ...
        SELECT
            ...
            CONVERT(DECIMAL(18,2), SUM(ID.DeliveryNetAmount - ID.DeliveryTotalPriceVatAmount)) AS InvoiceAmount
        FROM dbo.tblInvoice A WITH (NOLOCK)
        INNER JOIN dbo.tblOrder ord WITH (NOLOCK)
            ON ord.OrderId = A.OrderId
        ...
        SELECT
            cg.RowId,
            ISNULL(CustT.CustomerType, '') AS CustomerType,
            CONVERT(DECIMAL(18,2), SUM(cstp.TPAmount)) AS InvoiceCollection
        FROM dbo.tblCustPayDetail cstp WITH (NOLOCK)
        INNER JOIN dbo.tblInvoice A2 WITH (NOLOCK)
            ON A2.InvoiceId = cstp.InvoiceId
        INNER JOIN dbo.tblOrder ord2 WITH (NOLOCK)
    ...
    BEGIN
        ...
        SELECT
            ...
            CONVERT(DECIMAL(18,2), ISNULL(SUM(ID.DeliveryNetAmount - ID.DeliveryTotalPriceVatAmount), 0)) AS CampaignInvoiceValue
        FROM dbo.tblInvoice A WITH (NOLOCK)
        INNER JOIN dbo.tblInvoiceDetail ID WITH (NOLOCK)
            ON A.InvoiceId = ID.InvoiceId
        INNER JOIN dbo.tblOrder ord WITH (NOLOCK)
    ...
    LEFT JOIN (
        ...
        SELECT ord.TerritoryId,
               ...
               CONVERT(DECIMAL(18,2),
                       ...
                       ISNULL(SUM(ID.DeliveryNetAmount - ID.DeliveryTotalPriceVatAmount),0)
  ...
  AND (ISNULL(@ZoneName,      '') = '' OR rgn.RegionId     = TRY_CONVERT(INT, @ZoneName))
    ...
    (
        ...
        SELECT
            ...
            ISNULL(SUM(cstp.TPAmount),0) AS InvoiceCollection
