...
-- =============================================
create PROCEDURE [dbo].[sp_Webapi_Save_ExpenseClaimMasterissue]
...
-- Manually replace month and convert

BEGIN TRY

SET @expDate = REPLACE(@expDate, 'Sept', '09')

-- Convert to proper date format
SET @expDate = CONVERT(DATE, @expDate, 103)
...
DECLARE @expDateConverted DATE = CONVERT(DATE, @expDate);
