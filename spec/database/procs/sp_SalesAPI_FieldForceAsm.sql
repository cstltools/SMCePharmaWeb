CREATE PROCEDURE [dbo].[sp_SalesAPI_FieldForceAsm]
...
AS
    BEGIN
			...
			SET @Query = 'SELECT DISTINCT ASM.ASMEmpId,ASM.AreaId,ASM.ASMId,ASM.EmpName,ASM.EmpMasterCode FROM View_FieldForceAsm AS ASM WHERE ASM.ASMId IS NOT NULL ' + @Parrameter
