...
**570 tables, 7405 columns, 3 foreign keys, 227 non-PK indexes, 6 unique constraints, 2 check constraints.**
...
**Everything above this line was extracted from `SalesDisDB_SMC_NEWDB`** — the 570-table/7405-column
